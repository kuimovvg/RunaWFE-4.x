 ...
 *         &lt;element name="processTypes" type="{http://www.w3.org/2001/XMLSchema}string" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class DeployProcessDefinition {
    ...
    protected List<String> processTypes;
     ...
     * This is why there is not a <CODE>set</CODE> method for the processTypes property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getProcessTypes().add(newItem);
     * </pre>
     * 
     * 
     * <p>
