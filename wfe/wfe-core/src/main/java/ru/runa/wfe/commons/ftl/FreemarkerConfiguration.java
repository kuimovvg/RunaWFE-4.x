...
public class FreemarkerConfiguration {
    ...
    private FreemarkerConfiguration() {
        ...
        for (Element tagElement : tagElements) {
            try {
                ...
                Class<? extends FreemarkerTag> tagClass = (Class<? extends FreemarkerTag>) Class.forName(className);
    ...
    public FreemarkerTag getTag(String name) {
        if (!tags.containsKey(name)) {
            ...
            try {
                Class<? extends FreemarkerTag> tagClass = (Class<? extends FreemarkerTag>) Class.forName(possibleTagClassName);
                addTag(name, tagClass);
            } catch (Exception e) {
