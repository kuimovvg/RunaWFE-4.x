...
/**
 * Signals that definition name differs from the name of existing definition (during redeploy). Created on 11.10.2004
 */
public class DefinitionNameMismatchException extends ApplicationException {
