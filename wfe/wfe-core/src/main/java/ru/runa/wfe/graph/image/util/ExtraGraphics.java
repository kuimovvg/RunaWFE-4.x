...
public class ExtraGraphics {
	...
	/**
	 * Draws a sequence of lines connected by ellipses inscribed into polylines angles defined by arrays of x and y coordinates. Each pair of (x, y) coordinates defines a point. The figure is not closed if the first point differs from the last point.
	 * @author Artem Mikheev
	...
	/**
	 * Function to draw arc inscribed into angle S E T that tangent lines ES and ET at distance "dist" from E.
	 * @param s - start point
	 * @param e - inflection point
	 * @param t - point to
	 * @param dist 
	 * @return Array of two Point2D.Double with coordinates of arc's start and end points
	 */
