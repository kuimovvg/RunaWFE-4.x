...
public class Resources {
    ...
    public static final String CLASS_INVISIBLE_LIST_TABLE = "invisible-list";
    ...
    public static final String CLASS_SETTINGS = "settings-link";
    public static final String CLASS_GROUPPING_HEADER_CELL_WIDTH = "grouppingCellWidth";
    public static final String CLASS_GROUPPING_HEADER = "grouppingHeader";
