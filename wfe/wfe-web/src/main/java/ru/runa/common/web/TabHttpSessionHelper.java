...
public class TabHttpSessionHelper {
    ...
    private static final String TAG_ATTRIBUTE_NAME = TabHttpSessionHelper.class.getName() + "_CURRENT_TAB_FORWARD";

    public static void setTabForwardName(String tabForwardName, HttpSession session) {
        session.setAttribute(TAG_ATTRIBUTE_NAME, tabForwardName);
    }
    ...
    public static void removeTabForwardName(HttpSession session) {
        session.removeAttribute(TAG_ATTRIBUTE_NAME);
    }
