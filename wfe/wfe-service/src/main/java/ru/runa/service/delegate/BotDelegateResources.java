...
public final class BotDelegateResources extends ResourceCommons {
    ...
    /* delegate */
    private static final String DELEGATE_INTERFACE_TYPE = "ru.runa.wfe.wfe.bot.delegate.interface.type";

    private static final String DELEGATE_REMOTE_INITIAL_CONTEXT_FACTORY = "ru.runa.wfe.wfe.bot.delegate.remote.initial.context.factory";

    private static final String DELEGATE_REMOTE_URL_PKG_PREFIXES = "ru.runa.wfe.wfe.bot.delegate.remote.url.pkg.prefixes";

    private static final String DELEGATE_REMOTE_DEFAULT_PROVIDER_URL = "ru.runa.wfe.wfe.bot.delegate.remote.provider.url.default";
