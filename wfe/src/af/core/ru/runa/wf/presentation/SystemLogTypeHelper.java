...
public final class SystemLogTypeHelper {
     ...
     */
    private static final Map<Class, String> typeValues = new HashMap<Class, String>();
    ...
    static {
        ...
        AddType(ProcessInstanceDeleteLog.class, "PIDel", "history.system.type.process_instance_delete");
    }

    /**
     * {@link Map} from enumerated value ({@link SystemLog} descriminator value) to property display name (struts property).
     */
     ...
     * {@link Map} from type to property display name (struts property).
     */
    public static Map<Class, String> getClasses() {
        return new HashMap<Class, String>(typeValues);
    }

    /**
     * Add class and it's descriminator value to maps. 
     * @param clazz Class, inherited from {@link SystemLog}.
     * @param discriminator Class descriminator value.
     * @param displayProperty Struts property, to display for this class.
     */
    private static void AddType(Class clazz, String discriminator, String displayProperty) {
