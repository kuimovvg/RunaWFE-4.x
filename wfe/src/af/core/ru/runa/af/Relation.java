...
public class Relation extends IdentifiableBaseImpl implements Serializable {
    private static final long serialVersionUID = 1L;

    /**
     * Identity of relation.
     * This field is set, then relation is stored in database.    
     */
    private Long id;
    ...
    @SequenceGenerator(name = "sequence", sequenceName = "SEQ_RELATION_GROUPS")
