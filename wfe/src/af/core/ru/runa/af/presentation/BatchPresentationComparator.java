    ...
    public int compare(Executor o1, Executor o2) {
        ...
        try {
            for (int i = 0; i < sortingFields.length; i++) {
                Comparable field1 = (Comparable) PropertyUtils.getProperty(o1, sortingFields[i].dbSources[0].getValueDBPath(null));
                Comparable field2 = (Comparable) PropertyUtils.getProperty(o2, sortingFields[i].dbSources[0].getValueDBPath(null));
