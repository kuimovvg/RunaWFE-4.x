...
/**
 * Contains functions to work with {@link QueryTranslatorImpl}, used to convert HQL 
 * query to SQL query.
 */
public class HibernateCompilerTranslator {
     ...
     * @param hqlQuery HQL query to translate.
     * @param isCountQuery Flag, equals true, if this query is for object count; false otherwise.
     */
    ...
    public String translate() {
        ...
        translator = new QueryTranslatorImpl(hqlQuery, new HashMap<String, Object>(), (SessionFactoryImplementor) ApplicationContextFactory.getSessionFactory());
     ...
     * @param alias Alias name from HQL query.
