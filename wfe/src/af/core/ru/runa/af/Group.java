...
final public class Group extends Executor {
     ...
     */
    public static final String TEMPORARY_GROUP_PREFIX = "__TmpGroup_";
    
    public static final String ESCALATION_GROUP_PREFIX = "ESCALATION";
    ...
    public boolean isTemporary() {
        return getName().startsWith(TEMPORARY_GROUP_PREFIX);
    }

    @Override
    public void update(Executor updateFrom) {
        super.update(updateFrom);
        Group other = (Group)updateFrom;
        setActiveDirectoryGroup(other.getActiveDirectoryGroup());
    }

    public static Group createTemporaryGroup(String nameSuffix) {
        return createTemporaryGroup(nameSuffix, "TmpDescription");
    }
    
    public static Group createTemporaryGroup(String nameSuffix, String description) {
        return new Group(TEMPORARY_GROUP_PREFIX + nameSuffix, description);
    }
}
