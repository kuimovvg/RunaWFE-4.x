...
/**
 * Exception, which was thrown, if {@link Relation} not found. TODO fix name
 */
public class RelationDoesNotExistsException extends Exception implements Serializable {
     ...
     */
    public RelationDoesNotExistsException(String name, Throwable exception) {
        super(exception);
        relationName = name;
     ...
     *            Name of relation, which can't be found.
     */
    public RelationDoesNotExistsException(String name) {
        relationName = name;
        relationId = UNSET_RELATION_ID;
    }
     ...
     */
    public RelationDoesNotExistsException(Long relationId) {
        relationName = null;
