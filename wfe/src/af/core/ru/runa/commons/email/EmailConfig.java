...
public class EmailConfig {
    ...
    public void checkValid() throws Exception {
        EmailHelper.checkNotNull(message, "Message is null");
    ...
    public void applySubstitutions(Map<String, Object> variables) {
        ...
        for (String propName : tmpConnectionProperties.keySet()) {
            ...
            String substitutedValue = VariablesUtil.substitute(propValue, variables);
