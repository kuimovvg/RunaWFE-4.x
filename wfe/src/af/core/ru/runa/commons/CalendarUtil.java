...
public class CalendarUtil {
    ...
    public static final DateFormat DATE_WITH_TIME_FORMAT = new SimpleDateFormat("dd.MM.yyyy HH:mm:ss");
    ...
    public static final DateFormat ALF_DATE_WITHOUT_TIME_FORMAT = new SimpleDateFormat("yyyy-MM-dd");
    public static final DateFormat ALF_DATE_WITH_TIME_FORMAT = new SimpleDateFormat("yyyy-MM-dd HH:mm:ss");
    public static final DateFormat ALF_DATE_FORMAT = new SimpleDateFormat("yyyy-MM-dd'T'HH:mm:ss.000Z");

    public static final Calendar UNLIMITED_DATE = Calendar.getInstance();
    public static final Calendar ZERO_DATE = Calendar.getInstance();
    static {
        try {
            ZERO_DATE.setTime(ALF_DATE_WITHOUT_TIME_FORMAT.parse("1900-01-01"));
            UNLIMITED_DATE.setTime(ALF_DATE_WITHOUT_TIME_FORMAT.parse("2100-01-01"));
    ...
    public static String formatDate(Calendar calendar) {
        return format(calendar, ALF_DATE_WITHOUT_TIME_FORMAT);
    }

    public static String formatDateTime(Calendar calendar) {
        return format(calendar, ALF_DATE_WITH_TIME_FORMAT);
    }
    ...
    public static synchronized Calendar convertToCalendar(String dateAsString, DateFormat dateFormat) {
        try {
            synchronized (dateFormat) {
                return dateToCalendar(dateFormat.parse(dateAsString));
            }
        } catch (ParseException e) {
