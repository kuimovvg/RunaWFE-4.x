...
public class BusinessCalendarImpl implements BusinessCalendar, Serializable {
    ...
    public static synchronized Properties getBusinessCalendarProperties() {
        if (businessCalendarProperties == null) { // TODO move settings to Spring context
            businessCalendarProperties = ClassLoaderUtil.getProperties("jbpm.business.calendar.properties");
        }
