...
public class ExecutorCacheImpl extends BaseCacheImpl implements ExecutorCache {
    ...
    /* Ehcaches names. */
    public static final String actorsByCodesName = "ru.runa.af.caches.actorsByCodes";
    public static final String executorsByIdName = "ru.runa.af.caches.executorsById";
    public static final String executorsByNameName = "ru.runa.af.caches.executorsByName";
    public static final String groupMembersName = "ru.runa.af.caches.groupMembers";
    public static final String executorParentsName = "ru.runa.af.caches.executorParents";
    public static final String allGroupActorsName = "ru.runa.af.caches.allGroupActors";
    public static final String allExecutorGroupsName = "ru.runa.af.caches.allExecutorGroups";
    public static final String allExecutorsListsName = "ru.runa.af.caches.allExecutorsLists";
    ...
    private Set<Group> fillAllParrentsCache(Cache<Long, HashSet<Group>> cache, Executor executor,
    ...
    private class BatchPresentationFieldEquals implements Serializable {
