...
public class NodeModel {
    ...
    public static final int MULTI_INSTANCE = 9;
    ...
    private final HashMap<String, TransitionModel> transitions = new HashMap<String, TransitionModel>();
    ...
    public boolean equals(Object obj) {
        return name.equals(((NodeModel) obj).name);
    }
}
