...
import ru.runa.commons.xml.ClasspathEntityResolver;
import ru.runa.commons.xml.LoggingErrorHandler;
...
public class ValidationXmlParser {
    ...
    public static List<String> readVariableNames(byte[] xmlFileBytes) {
        try {
            ...
            throw new ProcessDefinitionXMLFormatException("${form}.validation.xml", e);
        }
    }
