...
public class ProfileServiceDelegateSaveProfileTest extends ServletTestCase {
    private static final String PREFIX = ProfileServiceDelegateSaveProfileTest.class.getName();
    ...
    public static Test suite() {
        return new TestSuite(ProfileServiceDelegateSaveProfileTest.class);
    }
    ...
    public void testNullSubject() throws Exception {
        try {
            profileService.saveProfile(null, th.getDefaultProfile(th.getAuthorizedPerformerSubject()));
    ...
    public void testFakeSubject() throws Exception {
        try {
            profileService.saveProfile(th.getFakeSubject(), th.getDefaultProfile(th.getAuthorizedPerformerSubject()));
    ...
    public void testNullProfile() throws Exception {
        try {
            profileService.saveProfile(null, th.getDefaultProfile(th.getAuthorizedPerformerSubject()));
            fail("ProfileServiceDelegate.saveProfile() allows null profile");
        } catch (IllegalArgumentException e) {
        }
    }
