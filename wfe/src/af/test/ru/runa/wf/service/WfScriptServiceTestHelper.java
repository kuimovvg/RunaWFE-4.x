...
public class WfScriptServiceTestHelper extends WfServiceTestHelper {
    ...
    private AdminScriptServiceDelegateRemoteImpl wfeScriptServiceDelegate;

    public WfScriptServiceTestHelper(String testClassPrefixName) throws IOException, ExecutorOutOfDateException, ExecutorAlreadyExistsException,
    ...
    public ProcessInstanceStub startProcessInstance(String processDefinitionName, Executor performer) throws ProcessDefinitionDoesNotExistException,
        ...
        Collection<Permission> validPermissions = Lists.newArrayList(ProcessDefinitionPermission.START_PROCESS, ProcessDefinitionPermission.READ,
