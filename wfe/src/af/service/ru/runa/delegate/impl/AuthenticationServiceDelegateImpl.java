...
public class AuthenticationServiceDelegateImpl extends EJB3Delegate implements AuthenticationService {
    ...
    public Subject authenticate(NtlmPasswordAuthentication authentication) throws AuthenticationException {
        return getAuthenticationService().authenticate(authentication);
    }
}
