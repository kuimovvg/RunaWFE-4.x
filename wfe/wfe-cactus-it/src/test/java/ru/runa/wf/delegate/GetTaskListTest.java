...
public class GetTaskListTest extends ServletTestCase {
    ...
    public void testEqualsFunctionTest() throws Exception {
        ...
        tasks = th.getExecutionService().getTasks(actor3User, batchPresentation);
        ...
        th.getExecutionService().completeTask(actor3User, tasks.get(0).getId(), new HashMap<String, Object>(), null);
