...
public abstract class AbstractCreateNodeFeature extends AbstractCreateFeature {
    ...
    private final ElementTypeDefinition nodeDefinition;

    public AbstractCreateNodeFeature(DiagramFeatureProvider provider) {
        super(provider, "", "");
        this.nodeDefinition = JpdlVersionRegistry.getElementTypeDefinition("3.x", getNodeId());
    }
    ...
    public String getCreateName() {
        return nodeDefinition.getEntryLabel();
    }

    protected ElementTypeDefinition getNodeDefinition() {
    ...
    public String getCreateImageId() {
        return getNodeDefinition().getEntry().getImageName();
    }
