...
public abstract class AbstractAutoCompletionComboBoxVarTag extends AbstractActorComboBoxVarTag {
    ...
    private String createInputAndSelectHtml(String selectName, List<Actor> actors, Actor defaultSelectedActor) {
    ...
    private void displayComboboxScript(Script script, PageContext pageContext) {
        if (pageContext != null && pageContext.getAttribute(COMBOBOX_SCRIPT_RENDERED_ATTRIBUTE_NAME) == null) {
            script
                    .addElement("function handleKeyUp(selectName,actorList,codeList) {\n inputElement = document.forms["
                            + formName
                            + "].elements[selectName+'"
                            + inputNameSuffix
            ...
            script
                    .addElement("function handleSelectClick(selectName) {\n selectElement = document.forms["
                            + formName
    ...
    public String getHtml(Subject subject, String varName, Object varValue, PageContext pageContext) throws WorkflowFormProcessingException,
        ...
        try {
            ...
            Actor defaultActor = DelegateFactory.getInstance().getAuthenticationService().getActor(subject);
