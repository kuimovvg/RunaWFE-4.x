...
import ru.runa.auxiliary.NumberToString_ru;
import ru.runa.bpm.graph.def.ActionHandler;
import ru.runa.bpm.graph.exe.ExecutionContext;
import ru.runa.wf.FileVariable;

public class ExecuteFormulaActionHandler implements ActionHandler {
    private static final long serialVersionUID = 1L;

    private static final Log log = LogFactory.getLog(ExecuteFormulaActionHandler.class);

    private ExecutionContext context;
    private final ExecuteFormulaActionHandlerOperations actions = new ExecuteFormulaActionHandlerOperations();
    ...
    public void execute(ExecutionContext context) {
        ...
        idsuf = " (process id = " + context.getProcessInstance().getId() + ")";
        if (inputData == null) {
        ...
        /*
         * StringTokenizer st = new StringTokenizer(inputData, ";\n"); while (st.hasMoreTokens()) { formula = st.nextToken().toCharArray(); if
    ...
    private Object tryParseNumericalValue(String s) {
        ...
        try {
            return new SimpleDateFormat("dd.MM.yy HH:mm").parse(s);
    ...
    public ExecuteFormulaActionHandler() {
    }

    public ExecuteFormulaActionHandler(String configurationName) {
        inputData = configurationName;
    }
}
