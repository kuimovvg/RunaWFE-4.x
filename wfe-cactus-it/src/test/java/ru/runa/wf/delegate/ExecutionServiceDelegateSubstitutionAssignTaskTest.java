...
public class ExecutionServiceDelegateSubstitutionAssignTaskTest extends ServletTestCase {
    ...
    public void testAssignAssigned() throws Exception {
        ...
        testHelper.getExecutionService().assignTask(substituteUser, substituteTasks[0].getId(), substituteTasks[0].getOwner(), actor);
        {
        ...
        testHelper.getExecutionService().completeTask(substituteUser, substituteTasks[0].getId(), new HashMap<String, Object>(), null);
    ...
    private void assertExceptionThrownOnExecute(User user, WfTask task) throws InternalApplicationException {
        try {
            testHelper.getExecutionService().completeTask(user, task.getId(), new HashMap<String, Object>(), null);
