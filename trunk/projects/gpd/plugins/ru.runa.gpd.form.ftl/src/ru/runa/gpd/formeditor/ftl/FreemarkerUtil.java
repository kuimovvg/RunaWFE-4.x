...
public class FreemarkerUtil {
    ...
    public static List<Integer> findComponents(String html) throws Exception {
        ...
        for (int i = 0; i < spanElements.getLength(); i++) {
            Node domNode = spanElements.item(i);
    ...
    public static String transformFromHtml(String html, Map<String, Variable> variables, WYSIWYGHTMLEditor editor) throws Exception {
        Document document = BaseHtmlFormType.getDocument(new ByteArrayInputStream(html.getBytes("UTF-8")));
        NodeList spanElements = document.getElementsByTagName(METHOD_ELEMENT_NAME());
        ...
        for (int i = 0; i < len; i++) {
            ...
            int id = Integer.valueOf(getAttrValue(domNode, "id"));
            FtlComponent component = editor.getComponent(id);
