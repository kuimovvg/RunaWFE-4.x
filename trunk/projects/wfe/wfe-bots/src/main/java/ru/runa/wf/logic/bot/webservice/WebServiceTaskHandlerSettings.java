...
public class WebServiceTaskHandlerSettings {
    /**
     * Credentials, sends in authorization property of web request for Basic authentication. 
     */
     ...
     * (May be overridden in interactions).
     */
    public final ErrorResponseProcessingResult errorAction;

    /**
     * Creates instance of {@link WebServiceTaskHandler} settings with all parameters.
     */
    public WebServiceTaskHandlerSettings(String url, String soapAction, List<Interaction> interactions, String encoding, String authBase,
            String requestMethod, boolean isLoggingEnable, ErrorResponseProcessingResult errorAction) {
        this.url = url;
