...
/**
 * common superclass for {@link ru.runa.wfe.task.Task}s and {@link ru.runa.wfe.execution.Swimlane}s used by the {@link ru.runa.wfe.handler.assign.AssignmentHandler} interface.
 */
