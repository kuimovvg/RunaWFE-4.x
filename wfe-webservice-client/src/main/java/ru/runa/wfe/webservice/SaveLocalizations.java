 ...
 *         &lt;element name="arg1" type="{http://impl.service.wfe.runa.ru/}localization" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class SaveLocalizations {
    ...
    protected User arg0;
    protected List<Localization> arg1;
     ...
     * 
     */
    public List<Localization> getArg1() {
        if (arg1 == null) {
            arg1 = new ArrayList<Localization>();
        }
        return this.arg1;
    }
