 ...
 * 
 */
@WebServiceClient(name = "ProfileWebService", targetNamespace = "http://impl.service.wfe.runa.ru/", wsdlLocation = "http://localhost:8080/wfe-service-4.1.0/ProfileWebService/ProfileAPI?wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("http://localhost:8080/wfe-service-4.1.0/ProfileWebService/ProfileAPI?wsdl");
