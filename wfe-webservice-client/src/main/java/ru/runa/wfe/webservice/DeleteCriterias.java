 ...
 *         &lt;element name="arg1" type="{http://impl.service.wfe.runa.ru/}substitutionCriteria" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class DeleteCriterias {
    ...
    protected User arg0;
    protected List<SubstitutionCriteria> arg1;
     ...
     * 
     */
    public List<SubstitutionCriteria> getArg1() {
        if (arg1 == null) {
            arg1 = new ArrayList<SubstitutionCriteria>();
        }
        return this.arg1;
    }
