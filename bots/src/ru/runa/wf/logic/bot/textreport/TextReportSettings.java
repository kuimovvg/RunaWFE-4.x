...
public class TextReportSettings {
    ...
    private final Map<String, WebFormat> varFormats = new HashMap<String, WebFormat>();
    ...
    public void addVariableFormat(String var, WebFormat format) {
        varFormats.put(var, format);
    }

    public WebFormat getFormat(String var) {
        WebFormat format = varFormats.get(var);
        if (format == null) {
