...
public class JComMSWordReportBuilder implements MSWordReportBuilder {
    public void build(String reportTemporaryFileName, Map processVariablesMap, MSWordReportTaskSettings settings) {
        ...
        try {
            ...
            replaceBookmarksWithValues(wordDocument, processVariablesMap, settings);
    ...
    private void replaceBookmarksWithValues(IDispatch wordDocument, Map variableMap, MSWordReportTaskSettings settings) throws JComException {
        ...
        while (bookmarksCount > 0 && bookmarksIterations++ < 100) {
            ...
            String value = settings.format(bookmarkName, variableMap);
