...
public class ToolPaletteView extends ViewPart implements IPartListener2 {
    ...
    private HelpTopicProvider helpTopicProvider;
    ...
    public void init(IViewSite site) throws PartInitException {
        ...
        helpTopicProvider = new HelpTopicProvider();
    }

    @SuppressWarnings("rawtypes")
    @Override
    public Object getAdapter(Class adapter) {
        if (adapter == IHelpTopicProvider.class) {
    ...
    private static class HelpTopicProvider implements IHelpTopicProvider {
        ...
        public String getHelpTopicUrl() {
            ...
            ToolPaletteMethodTag selectedComponent = (ToolPaletteMethodTag) structuredSelection.getFirstElement();
