...
public class VariableListDialog extends Dialog {
    ...
    public VariableListDialog(java.util.List<String> variableNames, java.util.List<String> value) {
    ...
    protected void configureShell(Shell newShell) {
        ...
        newShell.setText(Messages.getString("VariableListDialog.title"));
    }
    ...
    protected Control createDialogArea(Composite parent) {
        ...
        java.util.List<String> availableList = Lists.newArrayList(variableNames);
