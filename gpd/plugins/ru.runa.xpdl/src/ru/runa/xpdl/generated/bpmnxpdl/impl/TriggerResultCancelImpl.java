...
public class TriggerResultCancelImpl
    extends ru.runa.xpdl.generated.bpmnxpdl.impl.AnyTypeImpl
    implements ru.runa.xpdl.generated.bpmnxpdl.TriggerResultCancel, com.sun.xml.bind.RIElement, com.sun.xml.bind.JAXBObject, ru.runa.xpdl.generated.bpmnxpdl.impl.runtime.UnmarshallableObject, ru.runa.xpdl.generated.bpmnxpdl.impl.runtime.XMLSerializable, ru.runa.xpdl.generated.bpmnxpdl.impl.runtime.ValidatableObject
{
    ...
    private final static java.lang.Class PRIMARY_INTERFACE_CLASS() {
        return (ru.runa.xpdl.generated.bpmnxpdl.TriggerResultCancel.class);
    }
    ...
    public ru.runa.xpdl.generated.bpmnxpdl.impl.runtime.UnmarshallingEventHandler createUnmarshaller(ru.runa.xpdl.generated.bpmnxpdl.impl.runtime.UnmarshallingContext context) {
        return new ru.runa.xpdl.generated.bpmnxpdl.impl.TriggerResultCancelImpl.Unmarshaller(context);
    }
...
+"tanceq\u0000~\u0000!sq\u0000~\u00007t\u0000\u0013TriggerResultCancelt\u0000 http://www.wfmc.org"
+"/2008/XPDL2.1sr\u0000\"com.sun.msv.grammar.ExpressionPool\u0000\u0000\u0000\u0000\u0000\u0000\u0000\u0001\u0002"
...
+"r/ExpressionPool;xp\u0000\u0000\u0000\u0005\u0001pq\u0000~\u0000\u0010q\u0000~\u0000\tq\u0000~\u0000\u000eq\u0000~\u0000\fq\u0000~\u0000\"x"));
        ...
        extends ru.runa.xpdl.generated.bpmnxpdl.impl.runtime.AbstractUnmarshallingEventHandlerImpl
    {
        ...
        public java.lang.Object owner() {
            return ru.runa.xpdl.generated.bpmnxpdl.impl.TriggerResultCancelImpl.this;
        }
            ...
            throws org.xml.sax.SAXException
        {
            ...
            while (true) {
                switch (state) {
                    case  1 :
                        if (true) {
                            spawnHandlerFromEnterElement((((ru.runa.xpdl.generated.bpmnxpdl.impl.AnyTypeImpl) ru.runa.xpdl.generated.bpmnxpdl.impl.TriggerResultCancelImpl.this).new Unmarshaller(context)), 2, ___uri, ___local, ___qname, __atts);
                            return ;
                        }
                        spawnHandlerFromEnterElement((((ru.runa.xpdl.generated.bpmnxpdl.impl.AnyTypeImpl) ru.runa.xpdl.generated.bpmnxpdl.impl.TriggerResultCancelImpl.this).new Unmarshaller(context)), 2, ___uri, ___local, ___qname, __atts);
                        return ;
            ...
            throws org.xml.sax.SAXException
        {
            ...
            while (true) {
                switch (state) {
                    case  1 :
                        spawnHandlerFromLeaveElement((((ru.runa.xpdl.generated.bpmnxpdl.impl.AnyTypeImpl) ru.runa.xpdl.generated.bpmnxpdl.impl.TriggerResultCancelImpl.this).new Unmarshaller(context)), 2, ___uri, ___local, ___qname);
                        return ;
                    case  3 :
            ...
            throws org.xml.sax.SAXException
        {
            ...
            while (true) {
                switch (state) {
                    case  1 :
                        spawnHandlerFromEnterAttribute((((ru.runa.xpdl.generated.bpmnxpdl.impl.AnyTypeImpl) ru.runa.xpdl.generated.bpmnxpdl.impl.TriggerResultCancelImpl.this).new Unmarshaller(context)), 2, ___uri, ___local, ___qname);
                        return ;
                    case  3 :
            ...
            throws org.xml.sax.SAXException
        {
            ...
            while (true) {
                switch (state) {
                    case  1 :
                        spawnHandlerFromLeaveAttribute((((ru.runa.xpdl.generated.bpmnxpdl.impl.AnyTypeImpl) ru.runa.xpdl.generated.bpmnxpdl.impl.TriggerResultCancelImpl.this).new Unmarshaller(context)), 2, ___uri, ___local, ___qname);
                        return ;
                    case  3 :
            ...
            throws org.xml.sax.SAXException
        {
            ...
            while (true) {
                try {
                    switch (state) {
                        case  1 :
                            spawnHandlerFromText((((ru.runa.xpdl.generated.bpmnxpdl.impl.AnyTypeImpl) ru.runa.xpdl.generated.bpmnxpdl.impl.TriggerResultCancelImpl.this).new Unmarshaller(context)), 2, value);
                            return ;
                        case  3 :
