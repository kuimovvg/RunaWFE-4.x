...
public class ActualParametersTypeImpl implements ru.runa.xpdl.generated.bpmnxpdl.ActualParametersType, com.sun.xml.bind.JAXBObject, ru.runa.xpdl.generated.bpmnxpdl.impl.runtime.UnmarshallableObject, ru.runa.xpdl.generated.bpmnxpdl.impl.runtime.XMLSerializable, ru.runa.xpdl.generated.bpmnxpdl.impl.runtime.ValidatableObject
{

    protected com.sun.xml.bind.util.ListImpl _Any;
    protected com.sun.xml.bind.util.ListImpl _ActualParameter;
    ...
    private final static java.lang.Class PRIMARY_INTERFACE_CLASS() {
        return (ru.runa.xpdl.generated.bpmnxpdl.ActualParametersType.class);
    }
    ...
    protected com.sun.xml.bind.util.ListImpl _getActualParameter() {
        if (_ActualParameter == null) {
            _ActualParameter = new com.sun.xml.bind.util.ListImpl(new java.util.ArrayList());
        }
        return _ActualParameter;
    }

    public java.util.List getActualParameter() {
        return _getActualParameter();
    }
    ...
    public ru.runa.xpdl.generated.bpmnxpdl.impl.runtime.UnmarshallingEventHandler createUnmarshaller(ru.runa.xpdl.generated.bpmnxpdl.impl.runtime.UnmarshallingContext context) {
        return new ru.runa.xpdl.generated.bpmnxpdl.impl.ActualParametersTypeImpl.Unmarshaller(context);
    }
        ...
        throws org.xml.sax.SAXException
    {
        ...
        int idx2 = 0;
        final int len2 = ((_ActualParameter == null)? 0 :_ActualParameter.size());
        while (idx2 != len2) {
            context.startElement("http://www.wfmc.org/2008/XPDL2.1", "ActualParameter");
            int idx_0 = idx2;
            context.childAsURIs(((com.sun.xml.bind.JAXBObject) _ActualParameter.get(idx_0 ++)), "ActualParameter");
            context.endNamespaceDecls();
            int idx_1 = idx2;
            context.childAsAttributes(((com.sun.xml.bind.JAXBObject) _ActualParameter.get(idx_1 ++)), "ActualParameter");
            context.endAttributes();
            context.childAsBody(((com.sun.xml.bind.JAXBObject) _ActualParameter.get(idx2 ++)), "ActualParameter");
            context.endElement();
        }
        while (idx1 != len1) {
...
+"p://java.sun.com/jaxb/xjc/dummy-elementssq\u0000~\u0000\u0006ppsq\u0000~\u0000\u0015q\u0000~\u0000\fp"
...
+"$NullSetExpression\u0000\u0000\u0000\u0000\u0000\u0000\u0000\u0001\u0002\u0000\u0000xq\u0000~\u0000\u0003q\u0000~\u0000\fpsr\u0000\u001bcom.sun.msv.uti"
+"l.StringPair\u00d0t\u001ejB\u008f\u008d\u00a0\u0002\u0000\u0002L\u0000\tlocalNameq\u0000~\u0000 L\u0000\fnamespaceURIq\u0000~\u0000 "
+"xpq\u0000~\u00001q\u0000~\u00000sq\u0000~\u0000\u001ft\u0000\u0004typet\u0000)http://www.w3.org/2001/XMLSchema"
+"-instanceq\u0000~\u0000\u001esq\u0000~\u0000\u001ft\u0000\u000fActualParametert\u0000 http://www.wfmc.org"
+"/2008/XPDL2.1q\u0000~\u0000\u001esq\u0000~\u0000\u0006ppsq\u0000~\u0000\bq\u0000~\u0000\fpsq\u0000~\u0000\rq\u0000~\u0000\fp\u0000sq\u0000~\u0000\u0015ppq"
+"\u0000~\u0000\u0018sr\u0000\'com.sun.msv.grammar.DifferenceNameClass\u0000\u0000\u0000\u0000\u0000\u0000\u0000\u0001\u0002\u0000\u0002L\u0000"
+"\u0003nc1q\u0000~\u0000\u000eL\u0000\u0003nc2q\u0000~\u0000\u000exq\u0000~\u0000\u001bq\u0000~\u0000\u001csr\u0000#com.sun.msv.grammar.Choic"
+"eNameClass\u0000\u0000\u0000\u0000\u0000\u0000\u0000\u0001\u0002\u0000\u0002L\u0000\u0003nc1q\u0000~\u0000\u000eL\u0000\u0003nc2q\u0000~\u0000\u000exq\u0000~\u0000\u001bsr\u0000&com.sun"
+".msv.grammar.NamespaceNameClass\u0000\u0000\u0000\u0000\u0000\u0000\u0000\u0001\u0002\u0000\u0001L\u0000\fnamespaceURIq\u0000~"
+"\u0000 xq\u0000~\u0000\u001bt\u0000\u0000sq\u0000~\u0000Gq\u0000~\u0000>sq\u0000~\u0000Gq\u0000~\u0000#q\u0000~\u0000\u001esr\u0000\"com.sun.msv.gramma"
...
+"q\u0000~\u0000?q\u0000~\u0000\u0013q\u0000~\u0000\u0011q\u0000~\u0000$q\u0000~\u0000\u0007q\u0000~\u0000@q\u0000~\u0000\u0005x"));
        ...
        extends ru.runa.xpdl.generated.bpmnxpdl.impl.runtime.AbstractUnmarshallingEventHandlerImpl
    {
        ...
        public java.lang.Object owner() {
            return ru.runa.xpdl.generated.bpmnxpdl.impl.ActualParametersTypeImpl.this;
        }
            ...
            while (true) {
                switch (state) {
                    ...
                    case  1 :
                        ...
                        if (true) {
                            _getActualParameter().add(((ru.runa.xpdl.generated.bpmnxpdl.impl.ExpressionTypeImpl) spawnChildFromEnterElement((ru.runa.xpdl.generated.bpmnxpdl.impl.ExpressionTypeImpl.class), 2, ___uri, ___local, ___qname, __atts)));
                            return ;
                        }
                        _getActualParameter().add(((ru.runa.xpdl.generated.bpmnxpdl.impl.ExpressionTypeImpl) spawnChildFromEnterElement((ru.runa.xpdl.generated.bpmnxpdl.impl.ExpressionTypeImpl.class), 2, ___uri, ___local, ___qname, __atts)));
                        return ;
            ...
            while (true) {
                switch (state) {
                    ...
                    case  1 :
                        ...
                        _getActualParameter().add(((ru.runa.xpdl.generated.bpmnxpdl.impl.ExpressionTypeImpl) spawnChildFromLeaveElement((ru.runa.xpdl.generated.bpmnxpdl.impl.ExpressionTypeImpl.class), 2, ___uri, ___local, ___qname)));
                        return ;
                    case  0 :
                        state = 3;
                        continue outer;
                ...
                switch (state) {
                    ...
                    case  1 :
                        if (("ScriptGrammar" == ___local)&&("" == ___uri)) {
                            _getActualParameter().add(((ru.runa.xpdl.generated.bpmnxpdl.impl.ExpressionTypeImpl) spawnChildFromEnterAttribute((ru.runa.xpdl.generated.bpmnxpdl.impl.ExpressionTypeImpl.class), 2, ___uri, ___local, ___qname)));
                            return ;
                        }
            ...
            while (true) {
                switch (state) {
                    ...
                    case  1 :
                        ...
                        _getActualParameter().add(((ru.runa.xpdl.generated.bpmnxpdl.impl.ExpressionTypeImpl) spawnChildFromLeaveAttribute((ru.runa.xpdl.generated.bpmnxpdl.impl.ExpressionTypeImpl.class), 2, ___uri, ___local, ___qname)));
                        return ;
                    case  0 :
                        state = 3;
                        continue outer;
                ...
                try {
                    switch (state) {
                        ...
                        case  1 :
                            ...
                            _getActualParameter().add(((ru.runa.xpdl.generated.bpmnxpdl.impl.ExpressionTypeImpl) spawnChildFromText((ru.runa.xpdl.generated.bpmnxpdl.impl.ExpressionTypeImpl.class), 2, value)));
                            return ;
                        case  0 :
                            state = 3;
                            continue outer;
