...
public class IORulesTypeImpl implements ru.runa.xpdl.generated.bpmnxpdl.IORulesType, com.sun.xml.bind.JAXBObject, ru.runa.xpdl.generated.bpmnxpdl.impl.runtime.UnmarshallableObject, ru.runa.xpdl.generated.bpmnxpdl.impl.runtime.XMLSerializable, ru.runa.xpdl.generated.bpmnxpdl.impl.runtime.ValidatableObject
{

    protected com.sun.xml.bind.util.ListImpl _Any;
    protected com.sun.xml.bind.util.ListImpl _Expression;
    ...
    private final static java.lang.Class PRIMARY_INTERFACE_CLASS() {
        return (ru.runa.xpdl.generated.bpmnxpdl.IORulesType.class);
    }
    ...
    protected com.sun.xml.bind.util.ListImpl _getExpression() {
        if (_Expression == null) {
            _Expression = new com.sun.xml.bind.util.ListImpl(new java.util.ArrayList());
        }
        return _Expression;
    }
    ...
    public ru.runa.xpdl.generated.bpmnxpdl.impl.runtime.UnmarshallingEventHandler createUnmarshaller(ru.runa.xpdl.generated.bpmnxpdl.impl.runtime.UnmarshallingContext context) {
        return new ru.runa.xpdl.generated.bpmnxpdl.impl.IORulesTypeImpl.Unmarshaller(context);
    }
        ...
        throws org.xml.sax.SAXException
    {
        ...
        int idx2 = 0;
        final int len2 = ((_Expression == null)? 0 :_Expression.size());
        while (idx2 != len2) {
            context.startElement("http://www.wfmc.org/2008/XPDL2.1", "Expression");
            int idx_0 = idx2;
            context.childAsURIs(((com.sun.xml.bind.JAXBObject) _Expression.get(idx_0 ++)), "Expression");
            context.endNamespaceDecls();
            int idx_1 = idx2;
            context.childAsAttributes(((com.sun.xml.bind.JAXBObject) _Expression.get(idx_1 ++)), "Expression");
            context.endAttributes();
            context.childAsBody(((com.sun.xml.bind.JAXBObject) _Expression.get(idx2 ++)), "Expression");
            context.endElement();
        }
        while (idx1 != len1) {
...
+"\u0000\u001at\u0000!ru.runa.xpdl.generated.bpmnxpdl.ExpressionTypet\u0000+http://java.sun.com"
...
+"\u0000~\u0000\u001et\u0000\nExpressiont\u0000 http://www.wfmc.org/2008/XPDL2.1sq\u0000~\u0000\u000fpp"
+"sq\u0000~\u0000\u0006q\u0000~\u0000\u0013psq\u0000~\u0000\tq\u0000~\u0000\u0013p\u0000sq\u0000~\u0000\u0014ppq\u0000~\u0000\u0017sr\u0000\'com.sun.msv.gramma"
+"r.DifferenceNameClass\u0000\u0000\u0000\u0000\u0000\u0000\u0000\u0001\u0002\u0000\u0002L\u0000\u0003nc1q\u0000~\u0000\nL\u0000\u0003nc2q\u0000~\u0000\nxq\u0000~\u0000\u001a"
+"q\u0000~\u0000\u001bsr\u0000#com.sun.msv.grammar.ChoiceNameClass\u0000\u0000\u0000\u0000\u0000\u0000\u0000\u0001\u0002\u0000\u0002L\u0000\u0003nc"
+"1q\u0000~\u0000\nL\u0000\u0003nc2q\u0000~\u0000\nxq\u0000~\u0000\u001asr\u0000&com.sun.msv.grammar.NamespaceName"
+"Class\u0000\u0000\u0000\u0000\u0000\u0000\u0000\u0001\u0002\u0000\u0001L\u0000\fnamespaceURIq\u0000~\u0000\u001fxq\u0000~\u0000\u001at\u0000\u0000sq\u0000~\u0000Fq\u0000~\u0000=sq\u0000~"
+"\u0000Fq\u0000~\u0000\"q\u0000~\u0000\u001dsr\u0000\"com.sun.msv.grammar.ExpressionPool\u0000\u0000\u0000\u0000\u0000\u0000\u0000\u0001\u0002\u0000"
...
+"/ExpressionPool;xp\u0000\u0000\u0000\b\u0001pq\u0000~\u0000\u0011q\u0000~\u0000\bq\u0000~\u0000\u0010q\u0000~\u0000>q\u0000~\u0000\rq\u0000~\u0000?q\u0000~\u0000#q"
+"\u0000~\u0000\u0005x"));
        }
        ...
        extends ru.runa.xpdl.generated.bpmnxpdl.impl.runtime.AbstractUnmarshallingEventHandlerImpl
    {
        ...
        public java.lang.Object owner() {
            return ru.runa.xpdl.generated.bpmnxpdl.impl.IORulesTypeImpl.this;
        }
            ...
            while (true) {
                switch (state) {
                    ...
                    case  1 :
                        ...
                        if (true) {
                            _getExpression().add(((ru.runa.xpdl.generated.bpmnxpdl.impl.ExpressionTypeImpl) spawnChildFromEnterElement((ru.runa.xpdl.generated.bpmnxpdl.impl.ExpressionTypeImpl.class), 2, ___uri, ___local, ___qname, __atts)));
                            return ;
                        }
                        _getExpression().add(((ru.runa.xpdl.generated.bpmnxpdl.impl.ExpressionTypeImpl) spawnChildFromEnterElement((ru.runa.xpdl.generated.bpmnxpdl.impl.ExpressionTypeImpl.class), 2, ___uri, ___local, ___qname, __atts)));
                        return ;
            ...
            while (true) {
                switch (state) {
                    ...
                    case  1 :
                        ...
                        _getExpression().add(((ru.runa.xpdl.generated.bpmnxpdl.impl.ExpressionTypeImpl) spawnChildFromLeaveElement((ru.runa.xpdl.generated.bpmnxpdl.impl.ExpressionTypeImpl.class), 2, ___uri, ___local, ___qname)));
                        return ;
                    case  4 :
                ...
                switch (state) {
                    ...
                    case  1 :
                        if (("ScriptGrammar" == ___local)&&("" == ___uri)) {
                            _getExpression().add(((ru.runa.xpdl.generated.bpmnxpdl.impl.ExpressionTypeImpl) spawnChildFromEnterAttribute((ru.runa.xpdl.generated.bpmnxpdl.impl.ExpressionTypeImpl.class), 2, ___uri, ___local, ___qname)));
                            return ;
                        }
            ...
            while (true) {
                switch (state) {
                    ...
                    case  1 :
                        ...
                        _getExpression().add(((ru.runa.xpdl.generated.bpmnxpdl.impl.ExpressionTypeImpl) spawnChildFromLeaveAttribute((ru.runa.xpdl.generated.bpmnxpdl.impl.ExpressionTypeImpl.class), 2, ___uri, ___local, ___qname)));
                        return ;
                    case  4 :
                ...
                try {
                    switch (state) {
                        ...
                        case  1 :
                            ...
                            _getExpression().add(((ru.runa.xpdl.generated.bpmnxpdl.impl.ExpressionTypeImpl) spawnChildFromText((ru.runa.xpdl.generated.bpmnxpdl.impl.ExpressionTypeImpl.class), 2, value)));
                            return ;
                        case  4 :
