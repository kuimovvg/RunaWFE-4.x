...
public class ActivitySetsTypeImpl implements ru.runa.xpdl.generated.bpmnxpdl.ActivitySetsType, com.sun.xml.bind.JAXBObject, ru.runa.xpdl.generated.bpmnxpdl.impl.runtime.UnmarshallableObject, ru.runa.xpdl.generated.bpmnxpdl.impl.runtime.XMLSerializable, ru.runa.xpdl.generated.bpmnxpdl.impl.runtime.ValidatableObject
{
    ...
    private final static java.lang.Class PRIMARY_INTERFACE_CLASS() {
        return (ru.runa.xpdl.generated.bpmnxpdl.ActivitySetsType.class);
    }
    ...
    protected com.sun.xml.bind.util.ListImpl _getActivitySet() {
        if (_ActivitySet == null) {
            _ActivitySet = new com.sun.xml.bind.util.ListImpl(new java.util.ArrayList());
        }
        return _ActivitySet;
    }

    public java.util.List getActivitySet() {
        return _getActivitySet();
    }
    ...
    public ru.runa.xpdl.generated.bpmnxpdl.impl.runtime.UnmarshallingEventHandler createUnmarshaller(ru.runa.xpdl.generated.bpmnxpdl.impl.runtime.UnmarshallingContext context) {
        return new ru.runa.xpdl.generated.bpmnxpdl.impl.ActivitySetsTypeImpl.Unmarshaller(context);
    }
        ...
        throws org.xml.sax.SAXException
    {
        ...
        int idx2 = 0;
        final int len2 = ((_ActivitySet == null)? 0 :_ActivitySet.size());
        while (idx2 != len2) {
            if (_ActivitySet.get(idx2) instanceof javax.xml.bind.Element) {
                context.childAsBody(((com.sun.xml.bind.JAXBObject) _ActivitySet.get(idx2 ++)), "ActivitySet");
            } else {
                context.startElement("http://www.wfmc.org/2008/XPDL2.1", "ActivitySet");
                int idx_0 = idx2;
                context.childAsURIs(((com.sun.xml.bind.JAXBObject) _ActivitySet.get(idx_0 ++)), "ActivitySet");
                context.endNamespaceDecls();
                int idx_1 = idx2;
                context.childAsAttributes(((com.sun.xml.bind.JAXBObject) _ActivitySet.get(idx_1 ++)), "ActivitySet");
        ...
        throws org.xml.sax.SAXException
    {
        ...
        while (idx2 != len2) {
            if (_ActivitySet.get(idx2) instanceof javax.xml.bind.Element) {
                context.childAsAttributes(((com.sun.xml.bind.JAXBObject) _ActivitySet.get(idx2 ++)), "ActivitySet");
            } else {
                idx2 += 1;
            }
        }
        ...
        throws org.xml.sax.SAXException
    {
        ...
        while (idx2 != len2) {
            if (_ActivitySet.get(idx2) instanceof javax.xml.bind.Element) {
                context.childAsURIs(((com.sun.xml.bind.JAXBObject) _ActivitySet.get(idx2 ++)), "ActivitySet");
            } else {
                idx2 += 1;
            }
        }
...
+"RIq\u0000~\u0000\u001fxq\u0000~\u0000\u001at\u0000\u001egenerated.bpmnxpdl.ActivitySett\u0000+http://java"
+".sun.com/jaxb/xjc/dummy-elementssq\u0000~\u0000\u000eq\u0000~\u0000\fp\u0000sq\u0000~\u0000\u0000ppsq\u0000~\u0000\u000ep"
+"p\u0000sq\u0000~\u0000\u0006ppsq\u0000~\u0000\bq\u0000~\u0000\fpsq\u0000~\u0000\u0014q\u0000~\u0000\fpq\u0000~\u0000\u0017q\u0000~\u0000\u001bq\u0000~\u0000\u001dsq\u0000~\u0000\u001et\u0000\"ge"
+"nerated.bpmnxpdl.ActivitySetTypeq\u0000~\u0000\"sq\u0000~\u0000\u0006ppsq\u0000~\u0000\u0014q\u0000~\u0000\fpsr\u0000"
...
+"stanceq\u0000~\u0000\u001dsq\u0000~\u0000\u001et\u0000\u000bActivitySett\u0000 http://www.wfmc.org/2008/X"
...
+"~\u0000\u0007q\u0000~\u0000\u0012q\u0000~\u0000&q\u0000~\u0000$q\u0000~\u0000Fq\u0000~\u0000+q\u0000~\u0000\rq\u0000~\u0000Gq\u0000~\u0000\nx"));
        ...
        extends ru.runa.xpdl.generated.bpmnxpdl.impl.runtime.AbstractUnmarshallingEventHandlerImpl
    {
        ...
        public java.lang.Object owner() {
            return ru.runa.xpdl.generated.bpmnxpdl.impl.ActivitySetsTypeImpl.this;
        }
                ...
                switch (state) {
                    ...
                    case  0 :
                        if (("ActivitySet" == ___local)&&("http://www.wfmc.org/2008/XPDL2.1" == ___uri)) {
                            _getActivitySet().add(((ru.runa.xpdl.generated.bpmnxpdl.impl.ActivitySetImpl) spawnChildFromEnterElement((ru.runa.xpdl.generated.bpmnxpdl.impl.ActivitySetImpl.class), 3, ___uri, ___local, ___qname, __atts)));
                            return ;
                        }
                        if (("ActivitySet" == ___local)&&("http://www.wfmc.org/2008/XPDL2.1" == ___uri)) {
                ...
                switch (state) {
                    case  1 :
                        if (("AdHoc" == ___local)&&("" == ___uri)) {
                            _getActivitySet().add(((ru.runa.xpdl.generated.bpmnxpdl.impl.ActivitySetTypeImpl) spawnChildFromEnterAttribute((ru.runa.xpdl.generated.bpmnxpdl.impl.ActivitySetTypeImpl.class), 2, ___uri, ___local, ___qname)));
                            return ;
                        }
