...
public class TransitionRefsTypeImpl implements ru.runa.xpdl.generated.bpmnxpdl.TransitionRefsType, com.sun.xml.bind.JAXBObject, ru.runa.xpdl.generated.bpmnxpdl.impl.runtime.UnmarshallableObject, ru.runa.xpdl.generated.bpmnxpdl.impl.runtime.XMLSerializable, ru.runa.xpdl.generated.bpmnxpdl.impl.runtime.ValidatableObject
{
    ...
    private final static java.lang.Class PRIMARY_INTERFACE_CLASS() {
        return (ru.runa.xpdl.generated.bpmnxpdl.TransitionRefsType.class);
    }
    ...
    protected com.sun.xml.bind.util.ListImpl _getTransitionRef() {
        if (_TransitionRef == null) {
            _TransitionRef = new com.sun.xml.bind.util.ListImpl(new java.util.ArrayList());
        }
        return _TransitionRef;
    }

    public java.util.List getTransitionRef() {
        return _getTransitionRef();
    }
    ...
    public ru.runa.xpdl.generated.bpmnxpdl.impl.runtime.UnmarshallingEventHandler createUnmarshaller(ru.runa.xpdl.generated.bpmnxpdl.impl.runtime.UnmarshallingContext context) {
        return new ru.runa.xpdl.generated.bpmnxpdl.impl.TransitionRefsTypeImpl.Unmarshaller(context);
    }
        ...
        throws org.xml.sax.SAXException
    {
        ...
        int idx2 = 0;
        final int len2 = ((_TransitionRef == null)? 0 :_TransitionRef.size());
        while (idx2 != len2) {
            if (_TransitionRef.get(idx2) instanceof javax.xml.bind.Element) {
                context.childAsBody(((com.sun.xml.bind.JAXBObject) _TransitionRef.get(idx2 ++)), "TransitionRef");
            } else {
                context.startElement("http://www.wfmc.org/2008/XPDL2.1", "TransitionRef");
                int idx_0 = idx2;
                context.childAsURIs(((com.sun.xml.bind.JAXBObject) _TransitionRef.get(idx_0 ++)), "TransitionRef");
                context.endNamespaceDecls();
                int idx_1 = idx2;
                context.childAsAttributes(((com.sun.xml.bind.JAXBObject) _TransitionRef.get(idx_1 ++)), "TransitionRef");
        ...
        throws org.xml.sax.SAXException
    {
        ...
        while (idx2 != len2) {
            if (_TransitionRef.get(idx2) instanceof javax.xml.bind.Element) {
                context.childAsAttributes(((com.sun.xml.bind.JAXBObject) _TransitionRef.get(idx2 ++)), "TransitionRef");
            } else {
                idx2 += 1;
            }
        }
        ...
        throws org.xml.sax.SAXException
    {
        ...
        while (idx2 != len2) {
            if (_TransitionRef.get(idx2) instanceof javax.xml.bind.Element) {
                context.childAsURIs(((com.sun.xml.bind.JAXBObject) _TransitionRef.get(idx2 ++)), "TransitionRef");
            } else {
                idx2 += 1;
            }
        }
...
+"RIq\u0000~\u0000\u001fxq\u0000~\u0000\u001at\u0000 ru.runa.xpdl.generated.bpmnxpdl.TransitionReft\u0000+http://ja"
+"va.sun.com/jaxb/xjc/dummy-elementssq\u0000~\u0000\u000eq\u0000~\u0000\fp\u0000sq\u0000~\u0000\u0000ppsq\u0000~\u0000"
+"\u000epp\u0000sq\u0000~\u0000\u0006ppsq\u0000~\u0000\bq\u0000~\u0000\fpsq\u0000~\u0000\u0014q\u0000~\u0000\fpq\u0000~\u0000\u0017q\u0000~\u0000\u001bq\u0000~\u0000\u001dsq\u0000~\u0000\u001et\u0000$"
+"ru.runa.xpdl.generated.bpmnxpdl.TransitionRefTypeq\u0000~\u0000\"sq\u0000~\u0000\u0006ppsq\u0000~\u0000\u0014q\u0000~\u0000\f"
...
+"a-instanceq\u0000~\u0000\u001dsq\u0000~\u0000\u001et\u0000\rTransitionReft\u0000 http://www.wfmc.org/"
+"2008/XPDL2.1q\u0000~\u0000\u001dsq\u0000~\u0000\u0006ppsq\u0000~\u0000\bq\u0000~\u0000\fpsq\u0000~\u0000\u000eq\u0000~\u0000\fp\u0000sq\u0000~\u0000\u0014ppq\u0000"
...
+"\u001fxq\u0000~\u0000\u001at\u0000\u0000sq\u0000~\u0000Nq\u0000~\u0000Esq\u0000~\u0000Nq\u0000~\u0000\"q\u0000~\u0000\u001dsr\u0000\"com.sun.msv.grammar"
...
+"ntt\u0000$Lcom/sun/msv/grammar/ExpressionPool;xp\u0000\u0000\u0000\f\u0001pq\u0000~\u0000\u0013q\u0000~\u0000\'q"
+"\u0000~\u0000Gq\u0000~\u0000\u0005q\u0000~\u0000\u0007q\u0000~\u0000\u0012q\u0000~\u0000&q\u0000~\u0000$q\u0000~\u0000Fq\u0000~\u0000+q\u0000~\u0000\rq\u0000~\u0000\nx"));
        }
        ...
        extends ru.runa.xpdl.generated.bpmnxpdl.impl.runtime.AbstractUnmarshallingEventHandlerImpl
    {
        ...
        public java.lang.Object owner() {
            return ru.runa.xpdl.generated.bpmnxpdl.impl.TransitionRefsTypeImpl.this;
        }
                ...
                switch (state) {
                    case  0 :
                        if (("TransitionRef" == ___local)&&("http://www.wfmc.org/2008/XPDL2.1" == ___uri)) {
                            _getTransitionRef().add(((ru.runa.xpdl.generated.bpmnxpdl.impl.TransitionRefImpl) spawnChildFromEnterElement((ru.runa.xpdl.generated.bpmnxpdl.impl.TransitionRefImpl.class), 1, ___uri, ___local, ___qname, __atts)));
                            return ;
                        }
                        if (("TransitionRef" == ___local)&&("http://www.wfmc.org/2008/XPDL2.1" == ___uri)) {
                ...
                switch (state) {
                    ...
                    case  3 :
                        if (("Id" == ___local)&&("" == ___uri)) {
                            _getTransitionRef().add(((ru.runa.xpdl.generated.bpmnxpdl.impl.TransitionRefTypeImpl) spawnChildFromEnterAttribute((ru.runa.xpdl.generated.bpmnxpdl.impl.TransitionRefTypeImpl.class), 4, ___uri, ___local, ___qname)));
                            return ;
                        }
                        break;
                }
