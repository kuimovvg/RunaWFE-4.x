...
public class ResponsiblesTypeImpl implements ru.runa.xpdl.generated.bpmnxpdl.ResponsiblesType, com.sun.xml.bind.JAXBObject, ru.runa.xpdl.generated.bpmnxpdl.impl.runtime.UnmarshallableObject, ru.runa.xpdl.generated.bpmnxpdl.impl.runtime.XMLSerializable, ru.runa.xpdl.generated.bpmnxpdl.impl.runtime.ValidatableObject
{

    protected com.sun.xml.bind.util.ListImpl _Responsible;
    ...
    private final static java.lang.Class PRIMARY_INTERFACE_CLASS() {
        return (ru.runa.xpdl.generated.bpmnxpdl.ResponsiblesType.class);
    }

    protected com.sun.xml.bind.util.ListImpl _getResponsible() {
        if (_Responsible == null) {
            _Responsible = new com.sun.xml.bind.util.ListImpl(new java.util.ArrayList());
        }
        return _Responsible;
    }

    public java.util.List getResponsible() {
        return _getResponsible();
    }
    ...
    public ru.runa.xpdl.generated.bpmnxpdl.impl.runtime.UnmarshallingEventHandler createUnmarshaller(ru.runa.xpdl.generated.bpmnxpdl.impl.runtime.UnmarshallingContext context) {
        return new ru.runa.xpdl.generated.bpmnxpdl.impl.ResponsiblesTypeImpl.Unmarshaller(context);
    }
    ...
    {
        int idx1 = 0;
        final int len1 = ((_Responsible == null)? 0 :_Responsible.size());
        int idx2 = 0;
        final int len2 = ((_Any == null)? 0 :_Any.size());
        while (idx1 != len1) {
            if (_Responsible.get(idx1) instanceof javax.xml.bind.Element) {
                context.childAsBody(((com.sun.xml.bind.JAXBObject) _Responsible.get(idx1 ++)), "Responsible");
            } else {
                context.startElement("http://www.wfmc.org/2008/XPDL2.1", "Responsible");
                int idx_0 = idx1;
                context.childAsURIs(((com.sun.xml.bind.JAXBObject) _Responsible.get(idx_0 ++)), "Responsible");
                context.endNamespaceDecls();
                int idx_1 = idx1;
                context.childAsAttributes(((com.sun.xml.bind.JAXBObject) _Responsible.get(idx_1 ++)), "Responsible");
        ...
        throws org.xml.sax.SAXException
    {
        ...
        while (idx1 != len1) {
            if (_Responsible.get(idx1) instanceof javax.xml.bind.Element) {
                context.childAsAttributes(((com.sun.xml.bind.JAXBObject) _Responsible.get(idx1 ++)), "Responsible");
            } else {
                idx1 += 1;
            }
        }
        ...
        throws org.xml.sax.SAXException
    {
        ...
        while (idx1 != len1) {
            if (_Responsible.get(idx1) instanceof javax.xml.bind.Element) {
                context.childAsURIs(((com.sun.xml.bind.JAXBObject) _Responsible.get(idx1 ++)), "Responsible");
            } else {
                idx1 += 1;
            }
        }
...
+"RIq\u0000~\u0000\u001fxq\u0000~\u0000\u001at\u0000\u001egenerated.bpmnxpdl.Responsiblet\u0000+http://java"
+".sun.com/jaxb/xjc/dummy-elementssq\u0000~\u0000\u000eq\u0000~\u0000\fp\u0000sq\u0000~\u0000\u0000ppsq\u0000~\u0000\u000ep"
+"p\u0000sq\u0000~\u0000\u0006ppsq\u0000~\u0000\bq\u0000~\u0000\fpsq\u0000~\u0000\u0014q\u0000~\u0000\fpq\u0000~\u0000\u0017q\u0000~\u0000\u001bq\u0000~\u0000\u001dsq\u0000~\u0000\u001et\u0000\"ge"
+"nerated.bpmnxpdl.ResponsibleTypeq\u0000~\u0000\"sq\u0000~\u0000\u0006ppsq\u0000~\u0000\u0014q\u0000~\u0000\fpsr\u0000"
...
+"stanceq\u0000~\u0000\u001dsq\u0000~\u0000\u001et\u0000\u000bResponsiblet\u0000 http://www.wfmc.org/2008/X"
...
+"~\u0000\u0012q\u0000~\u0000&q\u0000~\u0000$q\u0000~\u0000\u0005q\u0000~\u0000Gq\u0000~\u0000+q\u0000~\u0000Fq\u0000~\u0000\rq\u0000~\u0000\nx"));
        ...
        extends ru.runa.xpdl.generated.bpmnxpdl.impl.runtime.AbstractUnmarshallingEventHandlerImpl
    {
        ...
        public java.lang.Object owner() {
            return ru.runa.xpdl.generated.bpmnxpdl.impl.ResponsiblesTypeImpl.this;
        }
                ...
                switch (state) {
                    case  1 :
                        if (("Responsible" == ___local)&&("http://www.wfmc.org/2008/XPDL2.1" == ___uri)) {
                            _getResponsible().add(((ru.runa.xpdl.generated.bpmnxpdl.impl.ResponsibleImpl) spawnChildFromEnterElement((ru.runa.xpdl.generated.bpmnxpdl.impl.ResponsibleImpl.class), 1, ___uri, ___local, ___qname, __atts)));
                            return ;
                        }
                        if (("Responsible" == ___local)&&("http://www.wfmc.org/2008/XPDL2.1" == ___uri)) {
            ...
            throws org.xml.sax.SAXException
        {
            ...
            while (true) {
                try {
                    switch (state) {
                        case  2 :
                            _getResponsible().add(((ru.runa.xpdl.generated.bpmnxpdl.impl.ResponsibleTypeImpl) spawnChildFromText((ru.runa.xpdl.generated.bpmnxpdl.impl.ResponsibleTypeImpl.class), 3, value)));
                            return ;
                        case  1 :
                            state = 4;
                            continue outer;
