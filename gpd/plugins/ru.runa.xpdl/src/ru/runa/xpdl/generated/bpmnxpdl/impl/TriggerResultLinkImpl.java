...
public class TriggerResultLinkImpl
    extends ru.runa.xpdl.generated.bpmnxpdl.impl.TriggerResultLinkTypeImpl
    implements ru.runa.xpdl.generated.bpmnxpdl.TriggerResultLink, com.sun.xml.bind.RIElement, com.sun.xml.bind.JAXBObject, ru.runa.xpdl.generated.bpmnxpdl.impl.runtime.UnmarshallableObject, ru.runa.xpdl.generated.bpmnxpdl.impl.runtime.XMLSerializable, ru.runa.xpdl.generated.bpmnxpdl.impl.runtime.ValidatableObject
{
    ...
    private final static java.lang.Class PRIMARY_INTERFACE_CLASS() {
        return (ru.runa.xpdl.generated.bpmnxpdl.TriggerResultLink.class);
    }
    ...
    public ru.runa.xpdl.generated.bpmnxpdl.impl.runtime.UnmarshallingEventHandler createUnmarshaller(ru.runa.xpdl.generated.bpmnxpdl.impl.runtime.UnmarshallingContext context) {
        return new ru.runa.xpdl.generated.bpmnxpdl.impl.TriggerResultLinkImpl.Unmarshaller(context);
    }
...
+"ashSet\u00baD\u0085\u0095\u0096\u00b8\u00b74\u0003\u0000\u0000xpw\f\u0000\u0000\u0000\u0010?@\u0000\u0000\u0000\u0000\u0000\u0002t\u0000\u0005CATCHt\u0000\u0005THROWxsr\u00000com.su"
+"n.msv.grammar.Expression$NullSetExpression\u0000\u0000\u0000\u0000\u0000\u0000\u0000\u0001\u0002\u0000\u0000xq\u0000~\u0000\u0004q"
+"\u0000~\u0000\u0012psr\u0000\u001bcom.sun.msv.util.StringPair\u00d0t\u001ejB\u008f\u008d\u00a0\u0002\u0000\u0002L\u0000\tlocalNameq"
+"\u0000~\u0000!L\u0000\fnamespaceURIq\u0000~\u0000!xpt\u0000\u000fNMTOKEN-derivedq\u0000~\u0000%sr\u0000#com.sun"
+".msv.grammar.SimpleNameClass\u0000\u0000\u0000\u0000\u0000\u0000\u0000\u0001\u0002\u0000\u0002L\u0000\tlocalNameq\u0000~\u0000!L\u0000\fn"
+"amespaceURIq\u0000~\u0000!xq\u0000~\u0000\u001at\u0000\nCatchThrowq\u0000~\u0000#q\u0000~\u0000)sq\u0000~\u0000\fppsq\u0000~\u0000\u0014q"
+"\u0000~\u0000\u0012psq\u0000~\u0000,ppq\u0000~\u0000Aq\u0000~\u0000Jsq\u0000~\u0000Kq\u0000~\u0000Cq\u0000~\u0000Bsq\u0000~\u0000Nt\u0000\u0004Nameq\u0000~\u0000#q\u0000~"
+"\u0000)sq\u0000~\u0000\fppsq\u0000~\u0000\u0014q\u0000~\u0000\u0012psq\u0000~\u0000,ppsr\u0000\"com.sun.msv.datatype.xsd.Q"
+"nameType\u0000\u0000\u0000\u0000\u0000\u0000\u0000\u0001\u0002\u0000\u0000xq\u0000~\u0000?q\u0000~\u0000Bt\u0000\u0005QNameq\u0000~\u0000;q\u0000~\u0000Jsq\u0000~\u0000Kq\u0000~\u0000\\q"
+"\u0000~\u0000Bsq\u0000~\u0000Nt\u0000\u0004typet\u0000)http://www.w3.org/2001/XMLSchema-instanc"
+"eq\u0000~\u0000)sq\u0000~\u0000Nt\u0000\u0011TriggerResultLinkq\u0000~\u0000%sr\u0000\"com.sun.msv.grammar"
...
+"\u0000~\u0000Qq\u0000~\u0000\nq\u0000~\u0000\u000bq\u0000~\u0000Wq\u0000~\u0000\tq\u0000~\u0000\u0010x"));
        ...
        extends ru.runa.xpdl.generated.bpmnxpdl.impl.runtime.AbstractUnmarshallingEventHandlerImpl
    {
        ...
        public java.lang.Object owner() {
            return ru.runa.xpdl.generated.bpmnxpdl.impl.TriggerResultLinkImpl.this;
        }
                ...
                switch (state) {
                    case  1 :
                        ...
                        if (!(("" == ___uri)||("http://www.wfmc.org/2008/XPDL2.1" == ___uri))) {
                            spawnHandlerFromEnterElement((((ru.runa.xpdl.generated.bpmnxpdl.impl.TriggerResultLinkTypeImpl) ru.runa.xpdl.generated.bpmnxpdl.impl.TriggerResultLinkImpl.this).new Unmarshaller(context)), 2, ___uri, ___local, ___qname, __atts);
                            return ;
                        }
                        spawnHandlerFromEnterElement((((ru.runa.xpdl.generated.bpmnxpdl.impl.TriggerResultLinkTypeImpl) ru.runa.xpdl.generated.bpmnxpdl.impl.TriggerResultLinkImpl.this).new Unmarshaller(context)), 2, ___uri, ___local, ___qname, __atts);
                        return ;
            ...
            while (true) {
                switch (state) {
                    ...
                    case  1 :
                        ...
                        spawnHandlerFromLeaveElement((((ru.runa.xpdl.generated.bpmnxpdl.impl.TriggerResultLinkTypeImpl) ru.runa.xpdl.generated.bpmnxpdl.impl.TriggerResultLinkImpl.this).new Unmarshaller(context)), 2, ___uri, ___local, ___qname);
                        return ;
                    case  3 :
                ...
                switch (state) {
                    case  1 :
                        if (("CatchThrow" == ___local)&&("" == ___uri)) {
                            spawnHandlerFromEnterAttribute((((ru.runa.xpdl.generated.bpmnxpdl.impl.TriggerResultLinkTypeImpl) ru.runa.xpdl.generated.bpmnxpdl.impl.TriggerResultLinkImpl.this).new Unmarshaller(context)), 2, ___uri, ___local, ___qname);
                            return ;
                        }
            ...
            while (true) {
                switch (state) {
                    case  1 :
                        ...
                        spawnHandlerFromLeaveAttribute((((ru.runa.xpdl.generated.bpmnxpdl.impl.TriggerResultLinkTypeImpl) ru.runa.xpdl.generated.bpmnxpdl.impl.TriggerResultLinkImpl.this).new Unmarshaller(context)), 2, ___uri, ___local, ___qname);
                        return ;
                    case  3 :
                ...
                try {
                    switch (state) {
                        case  1 :
                            ...
                            spawnHandlerFromText((((ru.runa.xpdl.generated.bpmnxpdl.impl.TriggerResultLinkTypeImpl) ru.runa.xpdl.generated.bpmnxpdl.impl.TriggerResultLinkImpl.this).new Unmarshaller(context)), 2, value);
                            return ;
                        case  3 :
