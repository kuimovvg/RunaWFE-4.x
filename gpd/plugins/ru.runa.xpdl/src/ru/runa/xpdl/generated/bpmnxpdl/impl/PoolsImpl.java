...
public class PoolsImpl
    extends ru.runa.xpdl.generated.bpmnxpdl.impl.PoolsTypeImpl
    implements ru.runa.xpdl.generated.bpmnxpdl.Pools, com.sun.xml.bind.RIElement, com.sun.xml.bind.JAXBObject, ru.runa.xpdl.generated.bpmnxpdl.impl.runtime.UnmarshallableObject, ru.runa.xpdl.generated.bpmnxpdl.impl.runtime.XMLSerializable, ru.runa.xpdl.generated.bpmnxpdl.impl.runtime.ValidatableObject
{
    ...
    private final static java.lang.Class PRIMARY_INTERFACE_CLASS() {
        return (ru.runa.xpdl.generated.bpmnxpdl.Pools.class);
    }
    ...
    public ru.runa.xpdl.generated.bpmnxpdl.impl.runtime.UnmarshallingEventHandler createUnmarshaller(ru.runa.xpdl.generated.bpmnxpdl.impl.runtime.UnmarshallingContext context) {
        return new ru.runa.xpdl.generated.bpmnxpdl.impl.PoolsImpl.Unmarshaller(context);
    }
...
+"ing;L\u0000\fnamespaceURIq\u0000~\u0000!xq\u0000~\u0000\u001ct\u0000\u0017generated.bpmnxpdl.Poolt\u0000+h"
+"ttp://java.sun.com/jaxb/xjc/dummy-elementssq\u0000~\u0000\u0000q\u0000~\u0000\u0011p\u0000sq\u0000~\u0000"
+"\u0007ppsq\u0000~\u0000\u0000pp\u0000sq\u0000~\u0000\u000bppsq\u0000~\u0000\rq\u0000~\u0000\u0011psq\u0000~\u0000\u0016q\u0000~\u0000\u0011pq\u0000~\u0000\u0019q\u0000~\u0000\u001dq\u0000~\u0000\u001fs"
+"q\u0000~\u0000 t\u0000\u001bgenerated.bpmnxpdl.PoolTypeq\u0000~\u0000$sq\u0000~\u0000\u000bppsq\u0000~\u0000\u0016q\u0000~\u0000\u0011p"
...
+"-instanceq\u0000~\u0000\u001fsq\u0000~\u0000 t\u0000\u0004Poolt\u0000 http://www.wfmc.org/2008/XPDL2"
...
+"sq\u0000~\u0000Pq\u0000~\u0000Gsq\u0000~\u0000Pq\u0000~\u0000$q\u0000~\u0000\u001fsq\u0000~\u0000\u000bppsq\u0000~\u0000\u0016q\u0000~\u0000\u0011pq\u0000~\u00002q\u0000~\u0000Bq\u0000~"
+"\u0000\u001fsq\u0000~\u0000 t\u0000\u0005Poolsq\u0000~\u0000Gsr\u0000\"com.sun.msv.grammar.ExpressionPool\u0000"
...
+"v/grammar/ExpressionPool;xp\u0000\u0000\u0000\u000e\u0001pq\u0000~\u0000\u0015q\u0000~\u0000)q\u0000~\u0000\tq\u0000~\u0000\fq\u0000~\u0000\u0014q\u0000"
+"~\u0000(q\u0000~\u0000&q\u0000~\u0000-q\u0000~\u0000Uq\u0000~\u0000\u0012q\u0000~\u0000\u000fq\u0000~\u0000Hq\u0000~\u0000Iq\u0000~\u0000\nx"));
        }
        ...
        extends ru.runa.xpdl.generated.bpmnxpdl.impl.runtime.AbstractUnmarshallingEventHandlerImpl
    {
        ...
        public java.lang.Object owner() {
            return ru.runa.xpdl.generated.bpmnxpdl.impl.PoolsImpl.this;
        }
                ...
                switch (state) {
                    ...
                    case  1 :
                        if (("Pool" == ___local)&&("http://www.wfmc.org/2008/XPDL2.1" == ___uri)) {
                            spawnHandlerFromEnterElement((((ru.runa.xpdl.generated.bpmnxpdl.impl.PoolsTypeImpl) ru.runa.xpdl.generated.bpmnxpdl.impl.PoolsImpl.this).new Unmarshaller(context)), 2, ___uri, ___local, ___qname, __atts);
                            return ;
                        }
                        if (("Pool" == ___local)&&("http://www.wfmc.org/2008/XPDL2.1" == ___uri)) {
                            spawnHandlerFromEnterElement((((ru.runa.xpdl.generated.bpmnxpdl.impl.PoolsTypeImpl) ru.runa.xpdl.generated.bpmnxpdl.impl.PoolsImpl.this).new Unmarshaller(context)), 2, ___uri, ___local, ___qname, __atts);
            ...
            throws org.xml.sax.SAXException
        {
            ...
            while (true) {
                switch (state) {
                    case  1 :
                        spawnHandlerFromLeaveElement((((ru.runa.xpdl.generated.bpmnxpdl.impl.PoolsTypeImpl) ru.runa.xpdl.generated.bpmnxpdl.impl.PoolsImpl.this).new Unmarshaller(context)), 2, ___uri, ___local, ___qname);
                        return ;
                    case  3 :
            ...
            throws org.xml.sax.SAXException
        {
            ...
            while (true) {
                switch (state) {
                    case  1 :
                        spawnHandlerFromEnterAttribute((((ru.runa.xpdl.generated.bpmnxpdl.impl.PoolsTypeImpl) ru.runa.xpdl.generated.bpmnxpdl.impl.PoolsImpl.this).new Unmarshaller(context)), 2, ___uri, ___local, ___qname);
                        return ;
                    case  3 :
            ...
            throws org.xml.sax.SAXException
        {
            ...
            while (true) {
                switch (state) {
                    case  1 :
                        spawnHandlerFromLeaveAttribute((((ru.runa.xpdl.generated.bpmnxpdl.impl.PoolsTypeImpl) ru.runa.xpdl.generated.bpmnxpdl.impl.PoolsImpl.this).new Unmarshaller(context)), 2, ___uri, ___local, ___qname);
                        return ;
                    case  3 :
            ...
            throws org.xml.sax.SAXException
        {
            ...
            while (true) {
                try {
                    switch (state) {
                        case  1 :
                            spawnHandlerFromText((((ru.runa.xpdl.generated.bpmnxpdl.impl.PoolsTypeImpl) ru.runa.xpdl.generated.bpmnxpdl.impl.PoolsImpl.this).new Unmarshaller(context)), 2, value);
                            return ;
                        case  3 :
