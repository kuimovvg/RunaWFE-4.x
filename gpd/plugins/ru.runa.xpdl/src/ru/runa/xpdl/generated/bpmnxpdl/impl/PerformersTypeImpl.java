...
public class PerformersTypeImpl implements ru.runa.xpdl.generated.bpmnxpdl.PerformersType, com.sun.xml.bind.JAXBObject, ru.runa.xpdl.generated.bpmnxpdl.impl.runtime.UnmarshallableObject, ru.runa.xpdl.generated.bpmnxpdl.impl.runtime.XMLSerializable, ru.runa.xpdl.generated.bpmnxpdl.impl.runtime.ValidatableObject
{

    protected com.sun.xml.bind.util.ListImpl _Any;
    protected com.sun.xml.bind.util.ListImpl _Performer;
    ...
    private final static java.lang.Class PRIMARY_INTERFACE_CLASS() {
        return (ru.runa.xpdl.generated.bpmnxpdl.PerformersType.class);
    }
    ...
    protected com.sun.xml.bind.util.ListImpl _getPerformer() {
        if (_Performer == null) {
            _Performer = new com.sun.xml.bind.util.ListImpl(new java.util.ArrayList());
        }
        return _Performer;
    }

    public java.util.List getPerformer() {
        return _getPerformer();
    }
    ...
    public ru.runa.xpdl.generated.bpmnxpdl.impl.runtime.UnmarshallingEventHandler createUnmarshaller(ru.runa.xpdl.generated.bpmnxpdl.impl.runtime.UnmarshallingContext context) {
        return new ru.runa.xpdl.generated.bpmnxpdl.impl.PerformersTypeImpl.Unmarshaller(context);
    }
        ...
        throws org.xml.sax.SAXException
    {
        ...
        int idx2 = 0;
        final int len2 = ((_Performer == null)? 0 :_Performer.size());
        while (idx2 != len2) {
            if (_Performer.get(idx2) instanceof javax.xml.bind.Element) {
                context.childAsBody(((com.sun.xml.bind.JAXBObject) _Performer.get(idx2 ++)), "Performer");
            } else {
                context.startElement("http://www.wfmc.org/2008/XPDL2.1", "Performer");
                int idx_0 = idx2;
                context.childAsURIs(((com.sun.xml.bind.JAXBObject) _Performer.get(idx_0 ++)), "Performer");
                context.endNamespaceDecls();
                int idx_1 = idx2;
                context.childAsAttributes(((com.sun.xml.bind.JAXBObject) _Performer.get(idx_1 ++)), "Performer");
        ...
        throws org.xml.sax.SAXException
    {
        ...
        while (idx2 != len2) {
            if (_Performer.get(idx2) instanceof javax.xml.bind.Element) {
                context.childAsAttributes(((com.sun.xml.bind.JAXBObject) _Performer.get(idx2 ++)), "Performer");
            } else {
                idx2 += 1;
            }
        }
        ...
        throws org.xml.sax.SAXException
    {
        ...
        while (idx2 != len2) {
            if (_Performer.get(idx2) instanceof javax.xml.bind.Element) {
                context.childAsURIs(((com.sun.xml.bind.JAXBObject) _Performer.get(idx2 ++)), "Performer");
            } else {
                idx2 += 1;
            }
        }
...
+"RIq\u0000~\u0000\u001fxq\u0000~\u0000\u001at\u0000\u001cgenerated.bpmnxpdl.Performert\u0000+http://java.s"
+"un.com/jaxb/xjc/dummy-elementssq\u0000~\u0000\u000eq\u0000~\u0000\fp\u0000sq\u0000~\u0000\u0000ppsq\u0000~\u0000\u000epp\u0000"
+"sq\u0000~\u0000\u0006ppsq\u0000~\u0000\bq\u0000~\u0000\fpsq\u0000~\u0000\u0014q\u0000~\u0000\fpq\u0000~\u0000\u0017q\u0000~\u0000\u001bq\u0000~\u0000\u001dsq\u0000~\u0000\u001et\u0000 gene"
+"rated.bpmnxpdl.PerformerTypeq\u0000~\u0000\"sq\u0000~\u0000\u0006ppsq\u0000~\u0000\u0014q\u0000~\u0000\fpsr\u0000\u001bcom"
...
+"ceq\u0000~\u0000\u001dsq\u0000~\u0000\u001et\u0000\tPerformert\u0000 http://www.wfmc.org/2008/XPDL2.1"
...
+"\u0000&q\u0000~\u0000$q\u0000~\u0000\u0005q\u0000~\u0000Fq\u0000~\u0000Gq\u0000~\u0000+q\u0000~\u0000\rq\u0000~\u0000\nx"));
        ...
        extends ru.runa.xpdl.generated.bpmnxpdl.impl.runtime.AbstractUnmarshallingEventHandlerImpl
    {
        ...
        public java.lang.Object owner() {
            return ru.runa.xpdl.generated.bpmnxpdl.impl.PerformersTypeImpl.this;
        }
                ...
                switch (state) {
                    case  0 :
                        if (("Performer" == ___local)&&("http://www.wfmc.org/2008/XPDL2.1" == ___uri)) {
                            _getPerformer().add(((ru.runa.xpdl.generated.bpmnxpdl.impl.PerformerImpl) spawnChildFromEnterElement((ru.runa.xpdl.generated.bpmnxpdl.impl.PerformerImpl.class), 1, ___uri, ___local, ___qname, __atts)));
                            return ;
                        }
                        if (("Performer" == ___local)&&("http://www.wfmc.org/2008/XPDL2.1" == ___uri)) {
            ...
            throws org.xml.sax.SAXException
        {
            ...
            while (true) {
                try {
                    switch (state) {
                        case  3 :
                            _getPerformer().add(((ru.runa.xpdl.generated.bpmnxpdl.impl.PerformerTypeImpl) spawnChildFromText((ru.runa.xpdl.generated.bpmnxpdl.impl.PerformerTypeImpl.class), 4, value)));
                            return ;
                        case  0 :
                            state = 1;
                            continue outer;
