...
public class TriggerResultSignalTypeImpl implements ru.runa.xpdl.generated.bpmnxpdl.TriggerResultSignalType, com.sun.xml.bind.JAXBObject, ru.runa.xpdl.generated.bpmnxpdl.impl.runtime.UnmarshallableObject, ru.runa.xpdl.generated.bpmnxpdl.impl.runtime.XMLSerializable, ru.runa.xpdl.generated.bpmnxpdl.impl.runtime.ValidatableObject
{
    ...
    private final static java.lang.Class PRIMARY_INTERFACE_CLASS() {
        return (ru.runa.xpdl.generated.bpmnxpdl.TriggerResultSignalType.class);
    }
    ...
    public ru.runa.xpdl.generated.bpmnxpdl.impl.runtime.UnmarshallingEventHandler createUnmarshaller(ru.runa.xpdl.generated.bpmnxpdl.impl.runtime.UnmarshallingContext context) {
        return new ru.runa.xpdl.generated.bpmnxpdl.impl.TriggerResultSignalTypeImpl.Unmarshaller(context);
    }
        ...
        throws org.xml.sax.SAXException
    {
        ...
        int idx4 = 0;
        final int len4 = ((_Properties == null)? 0 :_Properties.size());
        while (idx4 != len4) {
            context.startElement("http://www.wfmc.org/2008/XPDL2.1", "Properties");
            int idx_0 = idx4;
            context.childAsURIs(((com.sun.xml.bind.JAXBObject) _Properties.get(idx_0 ++)), "Properties");
            context.endNamespaceDecls();
            int idx_1 = idx4;
            context.childAsAttributes(((com.sun.xml.bind.JAXBObject) _Properties.get(idx_1 ++)), "Properties");
            context.endAttributes();
            context.childAsBody(((com.sun.xml.bind.JAXBObject) _Properties.get(idx4 ++)), "Properties");
            context.endElement();
        }
        while (idx2 != len2) {
...
+"-instanceq\u0000~\u0000\u001fsq\u0000~\u0000 t\u0000\nPropertiest\u0000 http://www.wfmc.org/2008"
+"/XPDL2.1sq\u0000~\u0000\u0011ppsq\u0000~\u0000\bq\u0000~\u0000\u0015psq\u0000~\u0000\u000bq\u0000~\u0000\u0015p\u0000sq\u0000~\u0000\u0016ppq\u0000~\u0000\u0019sr\u0000\'co"
+"m.sun.msv.grammar.DifferenceNameClass\u0000\u0000\u0000\u0000\u0000\u0000\u0000\u0001\u0002\u0000\u0002L\u0000\u0003nc1q\u0000~\u0000\fL"
+"\u0000\u0003nc2q\u0000~\u0000\fxq\u0000~\u0000\u001cq\u0000~\u0000\u001dsr\u0000#com.sun.msv.grammar.ChoiceNameClass"
+"\u0000\u0000\u0000\u0000\u0000\u0000\u0000\u0001\u0002\u0000\u0002L\u0000\u0003nc1q\u0000~\u0000\fL\u0000\u0003nc2q\u0000~\u0000\fxq\u0000~\u0000\u001csr\u0000&com.sun.msv.gramm"
+"ar.NamespaceNameClass\u0000\u0000\u0000\u0000\u0000\u0000\u0000\u0001\u0002\u0000\u0001L\u0000\fnamespaceURIq\u0000~\u0000!xq\u0000~\u0000\u001ct\u0000"
+"\u0000sq\u0000~\u0000Hq\u0000~\u0000?sq\u0000~\u0000Hq\u0000~\u0000$q\u0000~\u0000\u001fsq\u0000~\u0000\u0011ppsq\u0000~\u0000\u0016q\u0000~\u0000\u0015psq\u0000~\u0000\'ppsr\u0000)"
...
+"acetNameq\u0000~\u0000!xq\u0000~\u0000.q\u0000~\u0000?pq\u0000~\u00005\u0000\u0000sr\u0000$com.sun.msv.datatype.xsd"
+".NmtokenType\u0000\u0000\u0000\u0000\u0000\u0000\u0000\u0001\u0002\u0000\u0000xr\u0000\"com.sun.msv.datatype.xsd.TokenTyp"
+"e\u0000\u0000\u0000\u0000\u0000\u0000\u0000\u0001\u0002\u0000\u0000xr\u0000#com.sun.msv.datatype.xsd.StringType\u0000\u0000\u0000\u0000\u0000\u0000\u0000\u0001\u0002"
+"\u0000\u0001Z\u0000\risAlwaysValidxq\u0000~\u0000,q\u0000~\u00001t\u0000\u0007NMTOKENq\u0000~\u00005\u0000q\u0000~\u0000Zt\u0000\u000benumera"
+"tionsr\u0000\u0011java.util.HashSet\u00baD\u0085\u0095\u0096\u00b8\u00b74\u0003\u0000\u0000xpw\f\u0000\u0000\u0000\u0010?@\u0000\u0000\u0000\u0000\u0000\u0002t\u0000\u0005CATCH"
+"t\u0000\u0005THROWxq\u0000~\u00007sq\u0000~\u00008t\u0000\u000fNMTOKEN-derivedq\u0000~\u0000?sq\u0000~\u0000 t\u0000\nCatchThr"
+"owq\u0000~\u0000Jq\u0000~\u0000\u001fsq\u0000~\u0000\u0011ppsq\u0000~\u0000\u0016q\u0000~\u0000\u0015psq\u0000~\u0000\'q\u0000~\u0000\u0015psq\u0000~\u0000Yq\u0000~\u00001t\u0000\u0006st"
+"ringsr\u00005com.sun.msv.datatype.xsd.WhiteSpaceProcessor$Preserv"
+"e\u0000\u0000\u0000\u0000\u0000\u0000\u0000\u0001\u0002\u0000\u0000xq\u0000~\u00004\u0001q\u0000~\u00007sq\u0000~\u00008q\u0000~\u0000iq\u0000~\u00001sq\u0000~\u0000 t\u0000\u0004Nameq\u0000~\u0000Jq\u0000"
...
+"q\u0000~\u0000\u0006q\u0000~\u0000%q\u0000~\u0000@x"));
        ...
        extends ru.runa.xpdl.generated.bpmnxpdl.impl.runtime.AbstractUnmarshallingEventHandlerImpl
    {
        ...
        public java.lang.Object owner() {
            return ru.runa.xpdl.generated.bpmnxpdl.impl.TriggerResultSignalTypeImpl.this;
        }
            ...
            while (true) {
                switch (state) {
                    ...
                    case  7 :
                        ...
                        if (true) {
                            _getProperties().add(((ru.runa.xpdl.generated.bpmnxpdl.impl.ExpressionTypeImpl) spawnChildFromEnterElement((ru.runa.xpdl.generated.bpmnxpdl.impl.ExpressionTypeImpl.class), 8, ___uri, ___local, ___qname, __atts)));
                            return ;
                        }
                        _getProperties().add(((ru.runa.xpdl.generated.bpmnxpdl.impl.ExpressionTypeImpl) spawnChildFromEnterElement((ru.runa.xpdl.generated.bpmnxpdl.impl.ExpressionTypeImpl.class), 8, ___uri, ___local, ___qname, __atts)));
                        return ;
            ...
            while (true) {
                switch (state) {
                    ...
                    case  7 :
                        ...
                        _getProperties().add(((ru.runa.xpdl.generated.bpmnxpdl.impl.ExpressionTypeImpl) spawnChildFromLeaveElement((ru.runa.xpdl.generated.bpmnxpdl.impl.ExpressionTypeImpl.class), 8, ___uri, ___local, ___qname)));
                        return ;
                    case  8 :
                        if (("Properties" == ___local)&&("http://www.wfmc.org/2008/XPDL2.1" == ___uri)) {
                ...
                switch (state) {
                    ...
                    case  7 :
                        if (("ScriptGrammar" == ___local)&&("" == ___uri)) {
                            _getProperties().add(((ru.runa.xpdl.generated.bpmnxpdl.impl.ExpressionTypeImpl) spawnChildFromEnterAttribute((ru.runa.xpdl.generated.bpmnxpdl.impl.ExpressionTypeImpl.class), 8, ___uri, ___local, ___qname)));
                            return ;
                        }
            ...
            while (true) {
                switch (state) {
                    ...
                    case  7 :
                        ...
                        _getProperties().add(((ru.runa.xpdl.generated.bpmnxpdl.impl.ExpressionTypeImpl) spawnChildFromLeaveAttribute((ru.runa.xpdl.generated.bpmnxpdl.impl.ExpressionTypeImpl.class), 8, ___uri, ___local, ___qname)));
                        return ;
                    case  5 :
                        if (("Name" == ___local)&&("" == ___uri)) {
                            state = 6;
                ...
                try {
                    switch (state) {
                        ...
                        case  7 :
                            ...
                            _getProperties().add(((ru.runa.xpdl.generated.bpmnxpdl.impl.ExpressionTypeImpl) spawnChildFromText((ru.runa.xpdl.generated.bpmnxpdl.impl.ExpressionTypeImpl.class), 8, value)));
                            return ;
                        case  9 :
                            state = 10;
                            continue outer;
