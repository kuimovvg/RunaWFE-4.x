...
public class TC1025ExtendedAttributesTypeImpl implements ru.runa.xpdl.generated.bpmnxpdl.TC1025ExtendedAttributesType, com.sun.xml.bind.JAXBObject, ru.runa.xpdl.generated.bpmnxpdl.impl.runtime.UnmarshallableObject, ru.runa.xpdl.generated.bpmnxpdl.impl.runtime.XMLSerializable, ru.runa.xpdl.generated.bpmnxpdl.impl.runtime.ValidatableObject
{

    protected com.sun.xml.bind.util.ListImpl _TC1025ExtendedAttribute;
    ...
    private final static java.lang.Class PRIMARY_INTERFACE_CLASS() {
        return (ru.runa.xpdl.generated.bpmnxpdl.TC1025ExtendedAttributesType.class);
    }

    protected com.sun.xml.bind.util.ListImpl _getTC1025ExtendedAttribute() {
        if (_TC1025ExtendedAttribute == null) {
            _TC1025ExtendedAttribute = new com.sun.xml.bind.util.ListImpl(new java.util.ArrayList());
        }
        return _TC1025ExtendedAttribute;
    }

    public java.util.List getTC1025ExtendedAttribute() {
        return _getTC1025ExtendedAttribute();
    }
    ...
    public ru.runa.xpdl.generated.bpmnxpdl.impl.runtime.UnmarshallingEventHandler createUnmarshaller(ru.runa.xpdl.generated.bpmnxpdl.impl.runtime.UnmarshallingContext context) {
        return new ru.runa.xpdl.generated.bpmnxpdl.impl.TC1025ExtendedAttributesTypeImpl.Unmarshaller(context);
    }
    ...
    {
        int idx1 = 0;
        final int len1 = ((_TC1025ExtendedAttribute == null)? 0 :_TC1025ExtendedAttribute.size());
        while (idx1 != len1) {
            if (_TC1025ExtendedAttribute.get(idx1) instanceof javax.xml.bind.Element) {
                context.childAsBody(((com.sun.xml.bind.JAXBObject) _TC1025ExtendedAttribute.get(idx1 ++)), "TC1025ExtendedAttribute");
            } else {
                context.startElement("http://www.wfmc.org/2002/XPDL1.0", "TC1025ExtendedAttribute");
                int idx_0 = idx1;
                context.childAsURIs(((com.sun.xml.bind.JAXBObject) _TC1025ExtendedAttribute.get(idx_0 ++)), "TC1025ExtendedAttribute");
                context.endNamespaceDecls();
                int idx_1 = idx1;
                context.childAsAttributes(((com.sun.xml.bind.JAXBObject) _TC1025ExtendedAttribute.get(idx_1 ++)), "TC1025ExtendedAttribute");
        ...
        throws org.xml.sax.SAXException
    {
        ...
        while (idx1 != len1) {
            if (_TC1025ExtendedAttribute.get(idx1) instanceof javax.xml.bind.Element) {
                context.childAsAttributes(((com.sun.xml.bind.JAXBObject) _TC1025ExtendedAttribute.get(idx1 ++)), "TC1025ExtendedAttribute");
            } else {
                idx1 += 1;
            }
        }
        ...
        throws org.xml.sax.SAXException
    {
        ...
        while (idx1 != len1) {
            if (_TC1025ExtendedAttribute.get(idx1) instanceof javax.xml.bind.Element) {
                context.childAsURIs(((com.sun.xml.bind.JAXBObject) _TC1025ExtendedAttribute.get(idx1 ++)), "TC1025ExtendedAttribute");
            } else {
                idx1 += 1;
            }
        }
...
+"spaceURIq\u0000~\u0000\u001dxq\u0000~\u0000\u0018t\u0000*ru.runa.xpdl.generated.bpmnxpdl.TC1025ExtendedAttri"
+"butet\u0000+http://java.sun.com/jaxb/xjc/dummy-elementssq\u0000~\u0000\fq\u0000~\u0000"
+"\np\u0000sr\u0000\u001fcom.sun.msv.grammar.SequenceExp\u0000\u0000\u0000\u0000\u0000\u0000\u0000\u0001\u0002\u0000\u0000xq\u0000~\u0000\u0001ppsq\u0000"
+"~\u0000\fpp\u0000sq\u0000~\u0000\u0000ppsq\u0000~\u0000\u0006q\u0000~\u0000\npsq\u0000~\u0000\u0012q\u0000~\u0000\npq\u0000~\u0000\u0015q\u0000~\u0000\u0019q\u0000~\u0000\u001bsq\u0000~\u0000\u001ct"
+"\u0000.ru.runa.xpdl.generated.bpmnxpdl.TC1025ExtendedAttributeTypeq\u0000~\u0000 sq\u0000~\u0000\u0000p"
...
+"001/XMLSchema-instanceq\u0000~\u0000\u001bsq\u0000~\u0000\u001ct\u0000\u0017TC1025ExtendedAttributet"
+"\u0000 http://www.wfmc.org/2002/XPDL1.0q\u0000~\u0000\u001bsr\u0000\"com.sun.msv.gramm"
...
+"&q\u0000~\u0000\u0005q\u0000~\u0000\u0010q\u0000~\u0000%q\u0000~\u0000#q\u0000~\u0000*q\u0000~\u0000\u000bq\u0000~\u0000\bx"));
        ...
        extends ru.runa.xpdl.generated.bpmnxpdl.impl.runtime.AbstractUnmarshallingEventHandlerImpl
    {
        ...
        public java.lang.Object owner() {
            return ru.runa.xpdl.generated.bpmnxpdl.impl.TC1025ExtendedAttributesTypeImpl.this;
        }
                ...
                switch (state) {
                    case  1 :
                        if (("TC1025ExtendedAttribute" == ___local)&&("http://www.wfmc.org/2002/XPDL1.0" == ___uri)) {
                            _getTC1025ExtendedAttribute().add(((ru.runa.xpdl.generated.bpmnxpdl.impl.TC1025ExtendedAttributeImpl) spawnChildFromEnterElement((ru.runa.xpdl.generated.bpmnxpdl.impl.TC1025ExtendedAttributeImpl.class), 1, ___uri, ___local, ___qname, __atts)));
                            return ;
                        }
                        if (("TC1025ExtendedAttribute" == ___local)&&("http://www.wfmc.org/2002/XPDL1.0" == ___uri)) {
                ...
                switch (state) {
                    ...
                    case  2 :
                        if (("Name" == ___local)&&("" == ___uri)) {
                            _getTC1025ExtendedAttribute().add(((ru.runa.xpdl.generated.bpmnxpdl.impl.TC1025ExtendedAttributeTypeImpl) spawnChildFromEnterAttribute((ru.runa.xpdl.generated.bpmnxpdl.impl.TC1025ExtendedAttributeTypeImpl.class), 3, ___uri, ___local, ___qname)));
                            return ;
                        }
                        break;
                }
