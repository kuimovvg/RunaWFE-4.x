...
public class TC1025WorkflowProcessesTypeImpl implements ru.runa.xpdl.generated.bpmnxpdl.TC1025WorkflowProcessesType, com.sun.xml.bind.JAXBObject, ru.runa.xpdl.generated.bpmnxpdl.impl.runtime.UnmarshallableObject, ru.runa.xpdl.generated.bpmnxpdl.impl.runtime.XMLSerializable, ru.runa.xpdl.generated.bpmnxpdl.impl.runtime.ValidatableObject
{

    protected com.sun.xml.bind.util.ListImpl _TC1025WorkflowProcess;
    ...
    private final static java.lang.Class PRIMARY_INTERFACE_CLASS() {
        return (ru.runa.xpdl.generated.bpmnxpdl.TC1025WorkflowProcessesType.class);
    }

    protected com.sun.xml.bind.util.ListImpl _getTC1025WorkflowProcess() {
        if (_TC1025WorkflowProcess == null) {
            _TC1025WorkflowProcess = new com.sun.xml.bind.util.ListImpl(new java.util.ArrayList());
        }
        return _TC1025WorkflowProcess;
    }

    public java.util.List getTC1025WorkflowProcess() {
        return _getTC1025WorkflowProcess();
    }
    ...
    public ru.runa.xpdl.generated.bpmnxpdl.impl.runtime.UnmarshallingEventHandler createUnmarshaller(ru.runa.xpdl.generated.bpmnxpdl.impl.runtime.UnmarshallingContext context) {
        return new ru.runa.xpdl.generated.bpmnxpdl.impl.TC1025WorkflowProcessesTypeImpl.Unmarshaller(context);
    }
    ...
    {
        int idx1 = 0;
        final int len1 = ((_TC1025WorkflowProcess == null)? 0 :_TC1025WorkflowProcess.size());
        while (idx1 != len1) {
            if (_TC1025WorkflowProcess.get(idx1) instanceof javax.xml.bind.Element) {
                context.childAsBody(((com.sun.xml.bind.JAXBObject) _TC1025WorkflowProcess.get(idx1 ++)), "TC1025WorkflowProcess");
            } else {
                context.startElement("http://www.wfmc.org/2002/XPDL1.0", "TC1025WorkflowProcess");
                int idx_0 = idx1;
                context.childAsURIs(((com.sun.xml.bind.JAXBObject) _TC1025WorkflowProcess.get(idx_0 ++)), "TC1025WorkflowProcess");
                context.endNamespaceDecls();
                int idx_1 = idx1;
                context.childAsAttributes(((com.sun.xml.bind.JAXBObject) _TC1025WorkflowProcess.get(idx_1 ++)), "TC1025WorkflowProcess");
        ...
        throws org.xml.sax.SAXException
    {
        ...
        while (idx1 != len1) {
            if (_TC1025WorkflowProcess.get(idx1) instanceof javax.xml.bind.Element) {
                context.childAsAttributes(((com.sun.xml.bind.JAXBObject) _TC1025WorkflowProcess.get(idx1 ++)), "TC1025WorkflowProcess");
            } else {
                idx1 += 1;
            }
        }
        ...
        throws org.xml.sax.SAXException
    {
        ...
        while (idx1 != len1) {
            if (_TC1025WorkflowProcess.get(idx1) instanceof javax.xml.bind.Element) {
                context.childAsURIs(((com.sun.xml.bind.JAXBObject) _TC1025WorkflowProcess.get(idx1 ++)), "TC1025WorkflowProcess");
            } else {
                idx1 += 1;
            }
        }
...
+"spaceURIq\u0000~\u0000\u001dxq\u0000~\u0000\u0018t\u0000(ru.runa.xpdl.generated.bpmnxpdl.TC1025WorkflowProce"
+"sst\u0000+http://java.sun.com/jaxb/xjc/dummy-elementssq\u0000~\u0000\fq\u0000~\u0000\np"
+"\u0000sr\u0000\u001fcom.sun.msv.grammar.SequenceExp\u0000\u0000\u0000\u0000\u0000\u0000\u0000\u0001\u0002\u0000\u0000xq\u0000~\u0000\u0001ppsq\u0000~\u0000"
+"\fpp\u0000sq\u0000~\u0000\u0000ppsq\u0000~\u0000\u0006q\u0000~\u0000\npsq\u0000~\u0000\u0012q\u0000~\u0000\npq\u0000~\u0000\u0015q\u0000~\u0000\u0019q\u0000~\u0000\u001bsq\u0000~\u0000\u001ct\u0000,"
+"ru.runa.xpdl.generated.bpmnxpdl.TC1025WorkflowProcessTypeq\u0000~\u0000 sq\u0000~\u0000\u0000ppsq\u0000"
...
+"XMLSchema-instanceq\u0000~\u0000\u001bsq\u0000~\u0000\u001ct\u0000\u0015TC1025WorkflowProcesst\u0000 http"
...
+"q\u0000~\u0000\u0010q\u0000~\u0000%q\u0000~\u0000#q\u0000~\u0000*q\u0000~\u0000\u000bq\u0000~\u0000\bx"));
        ...
        extends ru.runa.xpdl.generated.bpmnxpdl.impl.runtime.AbstractUnmarshallingEventHandlerImpl
    {
        ...
        public java.lang.Object owner() {
            return ru.runa.xpdl.generated.bpmnxpdl.impl.TC1025WorkflowProcessesTypeImpl.this;
        }
                ...
                switch (state) {
                    case  1 :
                        if (("TC1025WorkflowProcess" == ___local)&&("http://www.wfmc.org/2002/XPDL1.0" == ___uri)) {
                            _getTC1025WorkflowProcess().add(((ru.runa.xpdl.generated.bpmnxpdl.impl.TC1025WorkflowProcessImpl) spawnChildFromEnterElement((ru.runa.xpdl.generated.bpmnxpdl.impl.TC1025WorkflowProcessImpl.class), 1, ___uri, ___local, ___qname, __atts)));
                            return ;
                        }
                        if (("TC1025WorkflowProcess" == ___local)&&("http://www.wfmc.org/2002/XPDL1.0" == ___uri)) {
                ...
                switch (state) {
                    ...
                    case  2 :
                        if (("AccessLevel" == ___local)&&("" == ___uri)) {
                            _getTC1025WorkflowProcess().add(((ru.runa.xpdl.generated.bpmnxpdl.impl.TC1025WorkflowProcessTypeImpl) spawnChildFromEnterAttribute((ru.runa.xpdl.generated.bpmnxpdl.impl.TC1025WorkflowProcessTypeImpl.class), 3, ___uri, ___local, ___qname)));
                            return ;
                        }
