...
public class DataMappingTypeImpl implements ru.runa.xpdl.generated.bpmnxpdl.DataMappingType, com.sun.xml.bind.JAXBObject, ru.runa.xpdl.generated.bpmnxpdl.impl.runtime.UnmarshallableObject, ru.runa.xpdl.generated.bpmnxpdl.impl.runtime.XMLSerializable, ru.runa.xpdl.generated.bpmnxpdl.impl.runtime.ValidatableObject
{

    protected com.sun.xml.bind.util.ListImpl _Any;
    protected ru.runa.xpdl.generated.bpmnxpdl.ExpressionType _Actual;
    protected ru.runa.xpdl.generated.bpmnxpdl.ExpressionType _TestValue;
    protected java.lang.String _Formal;
    ...
    private final static java.lang.Class PRIMARY_INTERFACE_CLASS() {
        return (ru.runa.xpdl.generated.bpmnxpdl.DataMappingType.class);
    }
    ...
    public ru.runa.xpdl.generated.bpmnxpdl.ExpressionType getActual() {
        return _Actual;
    }

    public void setActual(ru.runa.xpdl.generated.bpmnxpdl.ExpressionType value) {
        _Actual = value;
    }

    public ru.runa.xpdl.generated.bpmnxpdl.ExpressionType getTestValue() {
        return _TestValue;
    }

    public void setTestValue(ru.runa.xpdl.generated.bpmnxpdl.ExpressionType value) {
        _TestValue = value;
    }
    ...
    public void setFormal(java.lang.String value) {
        _Formal = value;
    }
    ...
    public ru.runa.xpdl.generated.bpmnxpdl.impl.runtime.UnmarshallingEventHandler createUnmarshaller(ru.runa.xpdl.generated.bpmnxpdl.impl.runtime.UnmarshallingContext context) {
        return new ru.runa.xpdl.generated.bpmnxpdl.impl.DataMappingTypeImpl.Unmarshaller(context);
    }
        ...
        throws org.xml.sax.SAXException
    {
        ...
        context.startElement("http://www.wfmc.org/2008/XPDL2.1", "Actual");
        context.childAsURIs(((com.sun.xml.bind.JAXBObject) _Actual), "Actual");
        context.endNamespaceDecls();
        context.childAsAttributes(((com.sun.xml.bind.JAXBObject) _Actual), "Actual");
        context.endAttributes();
        context.childAsBody(((com.sun.xml.bind.JAXBObject) _Actual), "Actual");
        context.endElement();
        if (_TestValue!= null) {
            context.startElement("http://www.wfmc.org/2008/XPDL2.1", "TestValue");
            context.childAsURIs(((com.sun.xml.bind.JAXBObject) _TestValue), "TestValue");
            context.endNamespaceDecls();
            context.childAsAttributes(((com.sun.xml.bind.JAXBObject) _TestValue), "TestValue");
            context.endAttributes();
            context.childAsBody(((com.sun.xml.bind.JAXBObject) _TestValue), "TestValue");
            context.endElement();
        }
        while (idx1 != len1) {
        ...
        throws org.xml.sax.SAXException
    {
        ...
        context.startAttribute("", "Formal");
        try {
            context.text(((java.lang.String) _Formal), "Formal");
        } catch (java.lang.Exception e) {
            ru.runa.xpdl.generated.bpmnxpdl.impl.runtime.Util.handlePrintConversionException(this, e, context);
        }
        context.endAttribute();
...
+"-instanceq\u0000~\u0000\u001fsq\u0000~\u0000 t\u0000\u0006Actualt\u0000 http://www.wfmc.org/2008/XPD"
+"L2.1sq\u0000~\u0000\u000fppsq\u0000~\u0000\tq\u0000~\u0000\u0015p\u0000sq\u0000~\u0000\u0000ppsq\u0000~\u0000\tpp\u0000sq\u0000~\u0000\u000fppsq\u0000~\u0000\u0011q\u0000~\u0000"
+"\u0015psq\u0000~\u0000\u0016q\u0000~\u0000\u0015pq\u0000~\u0000\u0019q\u0000~\u0000\u001dq\u0000~\u0000\u001fsq\u0000~\u0000 q\u0000~\u0000#q\u0000~\u0000$sq\u0000~\u0000\u000fppsq\u0000~\u0000\u0016q"
+"\u0000~\u0000\u0015pq\u0000~\u0000*q\u0000~\u0000:q\u0000~\u0000\u001fsq\u0000~\u0000 t\u0000\tTestValueq\u0000~\u0000?q\u0000~\u0000\u001fsq\u0000~\u0000\u000fppsq\u0000~"
+"\u0000\u0011q\u0000~\u0000\u0015psq\u0000~\u0000\tq\u0000~\u0000\u0015p\u0000sq\u0000~\u0000\u0016ppq\u0000~\u0000\u0019sr\u0000\'com.sun.msv.grammar.Di"
+"fferenceNameClass\u0000\u0000\u0000\u0000\u0000\u0000\u0000\u0001\u0002\u0000\u0002L\u0000\u0003nc1q\u0000~\u0000\nL\u0000\u0003nc2q\u0000~\u0000\nxq\u0000~\u0000\u001cq\u0000~\u0000"
+"\u001dsr\u0000#com.sun.msv.grammar.ChoiceNameClass\u0000\u0000\u0000\u0000\u0000\u0000\u0000\u0001\u0002\u0000\u0002L\u0000\u0003nc1q\u0000~"
+"\u0000\nL\u0000\u0003nc2q\u0000~\u0000\nxq\u0000~\u0000\u001csr\u0000&com.sun.msv.grammar.NamespaceNameClas"
+"s\u0000\u0000\u0000\u0000\u0000\u0000\u0000\u0001\u0002\u0000\u0001L\u0000\fnamespaceURIq\u0000~\u0000!xq\u0000~\u0000\u001ct\u0000\u0000sq\u0000~\u0000Tq\u0000~\u0000?sq\u0000~\u0000Tq\u0000"
...
+"\u0000~\u0000?pq\u0000~\u00005\u0000\u0000sr\u0000$com.sun.msv.datatype.xsd.NmtokenType\u0000\u0000\u0000\u0000\u0000\u0000\u0000\u0001"
+"\u0002\u0000\u0000xr\u0000\"com.sun.msv.datatype.xsd.TokenType\u0000\u0000\u0000\u0000\u0000\u0000\u0000\u0001\u0002\u0000\u0000xr\u0000#com."
+"sun.msv.datatype.xsd.StringType\u0000\u0000\u0000\u0000\u0000\u0000\u0000\u0001\u0002\u0000\u0001Z\u0000\risAlwaysValidxq"
+"\u0000~\u0000,q\u0000~\u00001t\u0000\u0007NMTOKENq\u0000~\u00005\u0000q\u0000~\u0000ft\u0000\u000benumerationsr\u0000\u0011java.util.Ha"
+"shSet\u00baD\u0085\u0095\u0096\u00b8\u00b74\u0003\u0000\u0000xpw\f\u0000\u0000\u0000\u0010?@\u0000\u0000\u0000\u0000\u0000\u0003t\u0000\u0002INt\u0000\u0003OUTt\u0000\u0005INOUTxq\u0000~\u00007sq\u0000"
+"~\u00008t\u0000\u000fNMTOKEN-derivedq\u0000~\u0000?sq\u0000~\u0000 t\u0000\tDirectionq\u0000~\u0000Vq\u0000~\u0000\u001fsq\u0000~\u0000\u0016"
+"ppsq\u0000~\u0000\'q\u0000~\u0000\u0015psq\u0000~\u0000eq\u0000~\u00001t\u0000\u0006stringsr\u00005com.sun.msv.datatype.x"
+"sd.WhiteSpaceProcessor$Preserve\u0000\u0000\u0000\u0000\u0000\u0000\u0000\u0001\u0002\u0000\u0000xq\u0000~\u00004\u0001q\u0000~\u00007sq\u0000~\u00008"
+"q\u0000~\u0000uq\u0000~\u00001sq\u0000~\u0000 t\u0000\u0006Formalq\u0000~\u0000Vsr\u0000\"com.sun.msv.grammar.Expres"
...
+"om/sun/msv/grammar/ExpressionPool;xp\u0000\u0000\u0000\u0010\u0001pq\u0000~\u0000\u0013q\u0000~\u0000Eq\u0000~\u0000Mq\u0000~"
+"\u0000Yq\u0000~\u0000\u0010q\u0000~\u0000Dq\u0000~\u0000@q\u0000~\u0000\rq\u0000~\u0000Bq\u0000~\u0000Lq\u0000~\u0000\bq\u0000~\u0000%q\u0000~\u0000Hq\u0000~\u0000\u0005q\u0000~\u0000\u0007q\u0000~"
+"\u0000\u0006x"));
        }
        ...
        extends ru.runa.xpdl.generated.bpmnxpdl.impl.runtime.AbstractUnmarshallingEventHandlerImpl
    {
        ...
        public java.lang.Object owner() {
            return ru.runa.xpdl.generated.bpmnxpdl.impl.DataMappingTypeImpl.this;
        }
            ...
            while (true) {
                switch (state) {
                    ...
                    case  0 :
                        ...
                        continue outer;
                    case  3 :
                        attIdx = context.getAttribute("", "Formal");
                        if (attIdx >= 0) {
                            final java.lang.String v = context.eatAttribute(attIdx);
                            state = 6;
                            eatText2(v);
                        ...
                        break;
                    case  6 :
                        if (("Actual" == ___local)&&("http://www.wfmc.org/2008/XPDL2.1" == ___uri)) {
                        ...
                        break;
                    case  9 :
                        if (("TestValue" == ___local)&&("http://www.wfmc.org/2008/XPDL2.1" == ___uri)) {
                            context.pushAttributes(__atts, true);
                            state = 10;
                            return ;
                        }
                    ...
                    case  10 :
                        ...
                        if (true) {
                            _TestValue = ((ru.runa.xpdl.generated.bpmnxpdl.impl.ExpressionTypeImpl) spawnChildFromEnterElement((ru.runa.xpdl.generated.bpmnxpdl.impl.ExpressionTypeImpl.class), 11, ___uri, ___local, ___qname, __atts));
                            return ;
                        }
                        _TestValue = ((ru.runa.xpdl.generated.bpmnxpdl.impl.ExpressionTypeImpl) spawnChildFromEnterElement((ru.runa.xpdl.generated.bpmnxpdl.impl.ExpressionTypeImpl.class), 11, ___uri, ___local, ___qname, __atts));
                        return ;
                    ...
                    case  7 :
                        ...
                        if (true) {
                            _Actual = ((ru.runa.xpdl.generated.bpmnxpdl.impl.ExpressionTypeImpl) spawnChildFromEnterElement((ru.runa.xpdl.generated.bpmnxpdl.impl.ExpressionTypeImpl.class), 8, ___uri, ___local, ___qname, __atts));
                            return ;
                        }
                        _Actual = ((ru.runa.xpdl.generated.bpmnxpdl.impl.ExpressionTypeImpl) spawnChildFromEnterElement((ru.runa.xpdl.generated.bpmnxpdl.impl.ExpressionTypeImpl.class), 8, ___uri, ___local, ___qname, __atts));
                        return ;
            ...
            while (true) {
                switch (state) {
                    ...
                    case  10 :
                        ...
                        _TestValue = ((ru.runa.xpdl.generated.bpmnxpdl.impl.ExpressionTypeImpl) spawnChildFromLeaveElement((ru.runa.xpdl.generated.bpmnxpdl.impl.ExpressionTypeImpl.class), 11, ___uri, ___local, ___qname));
                        return ;
                    case  12 :
                        state = 13;
                        continue outer;
                    case  7 :
                        ...
                        _Actual = ((ru.runa.xpdl.generated.bpmnxpdl.impl.ExpressionTypeImpl) spawnChildFromLeaveElement((ru.runa.xpdl.generated.bpmnxpdl.impl.ExpressionTypeImpl.class), 8, ___uri, ___local, ___qname));
                        return ;
                }
                ...
                switch (state) {
                    ...
                    case  10 :
                        if (("ScriptGrammar" == ___local)&&("" == ___uri)) {
                            _TestValue = ((ru.runa.xpdl.generated.bpmnxpdl.impl.ExpressionTypeImpl) spawnChildFromEnterAttribute((ru.runa.xpdl.generated.bpmnxpdl.impl.ExpressionTypeImpl.class), 11, ___uri, ___local, ___qname));
                            return ;
                        }
                    ...
                    case  7 :
                        if (("ScriptGrammar" == ___local)&&("" == ___uri)) {
                            _Actual = ((ru.runa.xpdl.generated.bpmnxpdl.impl.ExpressionTypeImpl) spawnChildFromEnterAttribute((ru.runa.xpdl.generated.bpmnxpdl.impl.ExpressionTypeImpl.class), 8, ___uri, ___local, ___qname));
                            return ;
                        }
                        if (("ScriptType" == ___local)&&("" == ___uri)) {
                            _Actual = ((ru.runa.xpdl.generated.bpmnxpdl.impl.ExpressionTypeImpl) spawnChildFromEnterAttribute((ru.runa.xpdl.generated.bpmnxpdl.impl.ExpressionTypeImpl.class), 8, ___uri, ___local, ___qname));
            ...
            while (true) {
                switch (state) {
                    ...
                    case  10 :
                        ...
                        _TestValue = ((ru.runa.xpdl.generated.bpmnxpdl.impl.ExpressionTypeImpl) spawnChildFromLeaveAttribute((ru.runa.xpdl.generated.bpmnxpdl.impl.ExpressionTypeImpl.class), 11, ___uri, ___local, ___qname));
                        return ;
                    case  12 :
                        state = 13;
                        continue outer;
                    case  7 :
                        ...
                        _Actual = ((ru.runa.xpdl.generated.bpmnxpdl.impl.ExpressionTypeImpl) spawnChildFromLeaveAttribute((ru.runa.xpdl.generated.bpmnxpdl.impl.ExpressionTypeImpl.class), 8, ___uri, ___local, ___qname));
                        return ;
                }
                ...
                try {
                    switch (state) {
                        ...
                        case  10 :
                            ...
                            _TestValue = ((ru.runa.xpdl.generated.bpmnxpdl.impl.ExpressionTypeImpl) spawnChildFromText((ru.runa.xpdl.generated.bpmnxpdl.impl.ExpressionTypeImpl.class), 11, value));
                            return ;
                        case  12 :
                            state = 13;
                            continue outer;
                        case  7 :
                            ...
                            _Actual = ((ru.runa.xpdl.generated.bpmnxpdl.impl.ExpressionTypeImpl) spawnChildFromText((ru.runa.xpdl.generated.bpmnxpdl.impl.ExpressionTypeImpl.class), 8, value));
                            return ;
                    }
