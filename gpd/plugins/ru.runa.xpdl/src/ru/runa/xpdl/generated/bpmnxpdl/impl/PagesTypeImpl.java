...
public class PagesTypeImpl implements ru.runa.xpdl.generated.bpmnxpdl.PagesType, com.sun.xml.bind.JAXBObject, ru.runa.xpdl.generated.bpmnxpdl.impl.runtime.UnmarshallableObject, ru.runa.xpdl.generated.bpmnxpdl.impl.runtime.XMLSerializable, ru.runa.xpdl.generated.bpmnxpdl.impl.runtime.ValidatableObject
{
    ...
    private final static java.lang.Class PRIMARY_INTERFACE_CLASS() {
        return (ru.runa.xpdl.generated.bpmnxpdl.PagesType.class);
    }
    ...
    public ru.runa.xpdl.generated.bpmnxpdl.impl.runtime.UnmarshallingEventHandler createUnmarshaller(ru.runa.xpdl.generated.bpmnxpdl.impl.runtime.UnmarshallingContext context) {
        return new ru.runa.xpdl.generated.bpmnxpdl.impl.PagesTypeImpl.Unmarshaller(context);
    }
        ...
        throws org.xml.sax.SAXException
    {
        ...
        int idx2 = 0;
        final int len2 = ((_Page == null)? 0 :_Page.size());
        while (idx2 != len2) {
            if (_Page.get(idx2) instanceof javax.xml.bind.Element) {
                context.childAsBody(((com.sun.xml.bind.JAXBObject) _Page.get(idx2 ++)), "Page");
            } else {
        ...
        throws org.xml.sax.SAXException
    {
        ...
        while (idx2 != len2) {
            if (_Page.get(idx2) instanceof javax.xml.bind.Element) {
                context.childAsAttributes(((com.sun.xml.bind.JAXBObject) _Page.get(idx2 ++)), "Page");
            } else {
                idx2 += 1;
            }
        }
        ...
        throws org.xml.sax.SAXException
    {
        ...
        while (idx2 != len2) {
            if (_Page.get(idx2) instanceof javax.xml.bind.Element) {
                context.childAsURIs(((com.sun.xml.bind.JAXBObject) _Page.get(idx2 ++)), "Page");
            } else {
                idx2 += 1;
            }
        }
...
+"RIq\u0000~\u0000\u001fxq\u0000~\u0000\u001at\u0000\u0017generated.bpmnxpdl.Paget\u0000+http://java.sun.co"
+"m/jaxb/xjc/dummy-elementssq\u0000~\u0000\u000eq\u0000~\u0000\fp\u0000sq\u0000~\u0000\u0000ppsq\u0000~\u0000\u000epp\u0000sq\u0000~\u0000"
+"\u0006ppsq\u0000~\u0000\bq\u0000~\u0000\fpsq\u0000~\u0000\u0014q\u0000~\u0000\fpq\u0000~\u0000\u0017q\u0000~\u0000\u001bq\u0000~\u0000\u001dsq\u0000~\u0000\u001et\u0000\u001bgenerated"
+".bpmnxpdl.PageTypeq\u0000~\u0000\"sq\u0000~\u0000\u0006ppsq\u0000~\u0000\u0014q\u0000~\u0000\fpsr\u0000\u001bcom.sun.msv.g"
...
+"~\u0000\u001et\u0000\u0004Paget\u0000 http://www.wfmc.org/2008/XPDL2.1q\u0000~\u0000\u001dsq\u0000~\u0000\u0006ppsq"
...
+"\u0000Gq\u0000~\u0000\u0005q\u0000~\u0000+q\u0000~\u0000\rq\u0000~\u0000\nx"));
        ...
        extends ru.runa.xpdl.generated.bpmnxpdl.impl.runtime.AbstractUnmarshallingEventHandlerImpl
    {
        ...
        public java.lang.Object owner() {
            return ru.runa.xpdl.generated.bpmnxpdl.impl.PagesTypeImpl.this;
        }
                ...
                switch (state) {
                    ...
                    case  0 :
                        if (("Page" == ___local)&&("http://www.wfmc.org/2008/XPDL2.1" == ___uri)) {
                            _getPage().add(((ru.runa.xpdl.generated.bpmnxpdl.impl.PageImpl) spawnChildFromEnterElement((ru.runa.xpdl.generated.bpmnxpdl.impl.PageImpl.class), 1, ___uri, ___local, ___qname, __atts)));
                            return ;
                        }
                        if (("Page" == ___local)&&("http://www.wfmc.org/2008/XPDL2.1" == ___uri)) {
                ...
                switch (state) {
                    ...
                    case  2 :
                        if (("Height" == ___local)&&("" == ___uri)) {
                            _getPage().add(((ru.runa.xpdl.generated.bpmnxpdl.impl.PageTypeImpl) spawnChildFromEnterAttribute((ru.runa.xpdl.generated.bpmnxpdl.impl.PageTypeImpl.class), 3, ___uri, ___local, ___qname)));
                            return ;
                        }
