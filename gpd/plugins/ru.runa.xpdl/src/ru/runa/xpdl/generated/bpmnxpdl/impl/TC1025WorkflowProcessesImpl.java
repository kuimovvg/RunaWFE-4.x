...
public class TC1025WorkflowProcessesImpl
    extends ru.runa.xpdl.generated.bpmnxpdl.impl.TC1025WorkflowProcessesTypeImpl
    implements ru.runa.xpdl.generated.bpmnxpdl.TC1025WorkflowProcesses, com.sun.xml.bind.RIElement, com.sun.xml.bind.JAXBObject, ru.runa.xpdl.generated.bpmnxpdl.impl.runtime.UnmarshallableObject, ru.runa.xpdl.generated.bpmnxpdl.impl.runtime.XMLSerializable, ru.runa.xpdl.generated.bpmnxpdl.impl.runtime.ValidatableObject
{
    ...
    private final static java.lang.Class PRIMARY_INTERFACE_CLASS() {
        return (ru.runa.xpdl.generated.bpmnxpdl.TC1025WorkflowProcesses.class);
    }
    ...
    public java.lang.String ____jaxb_ri____getLocalName() {
        return "TC1025WorkflowProcesses";
    }
    ...
    public ru.runa.xpdl.generated.bpmnxpdl.impl.runtime.UnmarshallingEventHandler createUnmarshaller(ru.runa.xpdl.generated.bpmnxpdl.impl.runtime.UnmarshallingContext context) {
        return new ru.runa.xpdl.generated.bpmnxpdl.impl.TC1025WorkflowProcessesImpl.Unmarshaller(context);
    }
...
+"amespaceURIq\u0000~\u0000 xq\u0000~\u0000\u001bt\u0000(ru.runa.xpdl.generated.bpmnxpdl.TC1025WorkflowPr"
+"ocesst\u0000+http://java.sun.com/jaxb/xjc/dummy-elementssq\u0000~\u0000\u0000q\u0000~"
+"\u0000\u0010p\u0000sq\u0000~\u0000\u0007ppsq\u0000~\u0000\u0000pp\u0000sq\u0000~\u0000\nppsq\u0000~\u0000\fq\u0000~\u0000\u0010psq\u0000~\u0000\u0015q\u0000~\u0000\u0010pq\u0000~\u0000\u0018q\u0000"
+"~\u0000\u001cq\u0000~\u0000\u001esq\u0000~\u0000\u001ft\u0000,ru.runa.xpdl.generated.bpmnxpdl.TC1025WorkflowProcessTyp"
...
+"/www.w3.org/2001/XMLSchema-instanceq\u0000~\u0000\u001esq\u0000~\u0000\u001ft\u0000\u0015TC1025Workf"
+"lowProcesst\u0000 http://www.wfmc.org/2002/XPDL1.0q\u0000~\u0000\u001esq\u0000~\u0000\nppsq"
+"\u0000~\u0000\u0015q\u0000~\u0000\u0010pq\u0000~\u00001q\u0000~\u0000Aq\u0000~\u0000\u001esq\u0000~\u0000\u001ft\u0000\u0017TC1025WorkflowProcessesq\u0000~"
...
+"nPool;xp\u0000\u0000\u0000\u000b\u0001pq\u0000~\u0000\u0014q\u0000~\u0000(q\u0000~\u0000\u000bq\u0000~\u0000\tq\u0000~\u0000\u0013q\u0000~\u0000\'q\u0000~\u0000%q\u0000~\u0000,q\u0000~\u0000Gq"
+"\u0000~\u0000\u0011q\u0000~\u0000\u000ex"));
        }
        ...
        extends ru.runa.xpdl.generated.bpmnxpdl.impl.runtime.AbstractUnmarshallingEventHandlerImpl
    {
        ...
        public java.lang.Object owner() {
            return ru.runa.xpdl.generated.bpmnxpdl.impl.TC1025WorkflowProcessesImpl.this;
        }
                ...
                switch (state) {
                    ...
                    case  1 :
                        if (("TC1025WorkflowProcess" == ___local)&&("http://www.wfmc.org/2002/XPDL1.0" == ___uri)) {
                            spawnHandlerFromEnterElement((((ru.runa.xpdl.generated.bpmnxpdl.impl.TC1025WorkflowProcessesTypeImpl) ru.runa.xpdl.generated.bpmnxpdl.impl.TC1025WorkflowProcessesImpl.this).new Unmarshaller(context)), 2, ___uri, ___local, ___qname, __atts);
                            return ;
                        }
                        if (("TC1025WorkflowProcess" == ___local)&&("http://www.wfmc.org/2002/XPDL1.0" == ___uri)) {
                            spawnHandlerFromEnterElement((((ru.runa.xpdl.generated.bpmnxpdl.impl.TC1025WorkflowProcessesTypeImpl) ru.runa.xpdl.generated.bpmnxpdl.impl.TC1025WorkflowProcessesImpl.this).new Unmarshaller(context)), 2, ___uri, ___local, ___qname, __atts);
            ...
            while (true) {
                switch (state) {
                    ...
                    case  2 :
                        ...
                        break;
                    case  1 :
                        spawnHandlerFromLeaveElement((((ru.runa.xpdl.generated.bpmnxpdl.impl.TC1025WorkflowProcessesTypeImpl) ru.runa.xpdl.generated.bpmnxpdl.impl.TC1025WorkflowProcessesImpl.this).new Unmarshaller(context)), 2, ___uri, ___local, ___qname);
                        return ;
                }
            ...
            while (true) {
                switch (state) {
                    case  3 :
                        ...
                        return ;
                    case  1 :
                        spawnHandlerFromEnterAttribute((((ru.runa.xpdl.generated.bpmnxpdl.impl.TC1025WorkflowProcessesTypeImpl) ru.runa.xpdl.generated.bpmnxpdl.impl.TC1025WorkflowProcessesImpl.this).new Unmarshaller(context)), 2, ___uri, ___local, ___qname);
                        return ;
                }
            ...
            while (true) {
                switch (state) {
                    case  3 :
                        ...
                        return ;
                    case  1 :
                        spawnHandlerFromLeaveAttribute((((ru.runa.xpdl.generated.bpmnxpdl.impl.TC1025WorkflowProcessesTypeImpl) ru.runa.xpdl.generated.bpmnxpdl.impl.TC1025WorkflowProcessesImpl.this).new Unmarshaller(context)), 2, ___uri, ___local, ___qname);
                        return ;
                }
                ...
                try {
                    switch (state) {
                        case  3 :
                            ...
                            return ;
                        case  1 :
                            spawnHandlerFromText((((ru.runa.xpdl.generated.bpmnxpdl.impl.TC1025WorkflowProcessesTypeImpl) ru.runa.xpdl.generated.bpmnxpdl.impl.TC1025WorkflowProcessesImpl.this).new Unmarshaller(context)), 2, value);
                            return ;
                    }
