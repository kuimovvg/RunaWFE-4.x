...
public class TC1025ActivitiesTypeImpl implements ru.runa.xpdl.generated.bpmnxpdl.TC1025ActivitiesType, com.sun.xml.bind.JAXBObject, ru.runa.xpdl.generated.bpmnxpdl.impl.runtime.UnmarshallableObject, ru.runa.xpdl.generated.bpmnxpdl.impl.runtime.XMLSerializable, ru.runa.xpdl.generated.bpmnxpdl.impl.runtime.ValidatableObject
{

    protected com.sun.xml.bind.util.ListImpl _TC1025Activity;
    ...
    private final static java.lang.Class PRIMARY_INTERFACE_CLASS() {
        return (ru.runa.xpdl.generated.bpmnxpdl.TC1025ActivitiesType.class);
    }

    protected com.sun.xml.bind.util.ListImpl _getTC1025Activity() {
        if (_TC1025Activity == null) {
            _TC1025Activity = new com.sun.xml.bind.util.ListImpl(new java.util.ArrayList());
        }
        return _TC1025Activity;
    }

    public java.util.List getTC1025Activity() {
        return _getTC1025Activity();
    }
    ...
    public ru.runa.xpdl.generated.bpmnxpdl.impl.runtime.UnmarshallingEventHandler createUnmarshaller(ru.runa.xpdl.generated.bpmnxpdl.impl.runtime.UnmarshallingContext context) {
        return new ru.runa.xpdl.generated.bpmnxpdl.impl.TC1025ActivitiesTypeImpl.Unmarshaller(context);
    }
    ...
    {
        int idx1 = 0;
        final int len1 = ((_TC1025Activity == null)? 0 :_TC1025Activity.size());
        while (idx1 != len1) {
            if (_TC1025Activity.get(idx1) instanceof javax.xml.bind.Element) {
                context.childAsBody(((com.sun.xml.bind.JAXBObject) _TC1025Activity.get(idx1 ++)), "TC1025Activity");
            } else {
                context.startElement("http://www.wfmc.org/2002/XPDL1.0", "TC1025Activity");
                int idx_0 = idx1;
                context.childAsURIs(((com.sun.xml.bind.JAXBObject) _TC1025Activity.get(idx_0 ++)), "TC1025Activity");
                context.endNamespaceDecls();
                int idx_1 = idx1;
                context.childAsAttributes(((com.sun.xml.bind.JAXBObject) _TC1025Activity.get(idx_1 ++)), "TC1025Activity");
        ...
        throws org.xml.sax.SAXException
    {
        ...
        while (idx1 != len1) {
            if (_TC1025Activity.get(idx1) instanceof javax.xml.bind.Element) {
                context.childAsAttributes(((com.sun.xml.bind.JAXBObject) _TC1025Activity.get(idx1 ++)), "TC1025Activity");
            } else {
                idx1 += 1;
            }
        }
        ...
        throws org.xml.sax.SAXException
    {
        ...
        while (idx1 != len1) {
            if (_TC1025Activity.get(idx1) instanceof javax.xml.bind.Element) {
                context.childAsURIs(((com.sun.xml.bind.JAXBObject) _TC1025Activity.get(idx1 ++)), "TC1025Activity");
            } else {
                idx1 += 1;
            }
        }
...
+"spaceURIq\u0000~\u0000\u001dxq\u0000~\u0000\u0018t\u0000!ru.runa.xpdl.generated.bpmnxpdl.TC1025Activityt\u0000+ht"
+"tp://java.sun.com/jaxb/xjc/dummy-elementssq\u0000~\u0000\fq\u0000~\u0000\np\u0000sr\u0000\u001fco"
+"m.sun.msv.grammar.SequenceExp\u0000\u0000\u0000\u0000\u0000\u0000\u0000\u0001\u0002\u0000\u0000xq\u0000~\u0000\u0001ppsq\u0000~\u0000\fpp\u0000sq\u0000"
+"~\u0000\u0000ppsq\u0000~\u0000\u0006q\u0000~\u0000\npsq\u0000~\u0000\u0012q\u0000~\u0000\npq\u0000~\u0000\u0015q\u0000~\u0000\u0019q\u0000~\u0000\u001bsq\u0000~\u0000\u001ct\u0000%generat"
+"ed.bpmnxpdl.TC1025ActivityTypeq\u0000~\u0000 sq\u0000~\u0000\u0000ppsq\u0000~\u0000\u0012q\u0000~\u0000\npsr\u0000\u001bc"
...
+"anceq\u0000~\u0000\u001bsq\u0000~\u0000\u001ct\u0000\u000eTC1025Activityt\u0000 http://www.wfmc.org/2002/"
+"XPDL1.0q\u0000~\u0000\u001bsr\u0000\"com.sun.msv.grammar.ExpressionPool\u0000\u0000\u0000\u0000\u0000\u0000\u0000\u0001\u0002\u0000"
...
+"\u0000~\u0000\u000bq\u0000~\u0000\bx"));
        ...
        extends ru.runa.xpdl.generated.bpmnxpdl.impl.runtime.AbstractUnmarshallingEventHandlerImpl
    {
        ...
        public java.lang.Object owner() {
            return ru.runa.xpdl.generated.bpmnxpdl.impl.TC1025ActivitiesTypeImpl.this;
        }
                ...
                switch (state) {
                    case  0 :
                        if (("TC1025Activity" == ___local)&&("http://www.wfmc.org/2002/XPDL1.0" == ___uri)) {
                            _getTC1025Activity().add(((ru.runa.xpdl.generated.bpmnxpdl.impl.TC1025ActivityImpl) spawnChildFromEnterElement((ru.runa.xpdl.generated.bpmnxpdl.impl.TC1025ActivityImpl.class), 3, ___uri, ___local, ___qname, __atts)));
                            return ;
                        }
                        if (("TC1025Activity" == ___local)&&("http://www.wfmc.org/2002/XPDL1.0" == ___uri)) {
                ...
                switch (state) {
                    ...
                    case  1 :
                        if (("Id" == ___local)&&("" == ___uri)) {
                            _getTC1025Activity().add(((ru.runa.xpdl.generated.bpmnxpdl.impl.TC1025ActivityTypeImpl) spawnChildFromEnterAttribute((ru.runa.xpdl.generated.bpmnxpdl.impl.TC1025ActivityTypeImpl.class), 2, ___uri, ___local, ___qname)));
                            return ;
                        }
                        break;
                    case  3 :
