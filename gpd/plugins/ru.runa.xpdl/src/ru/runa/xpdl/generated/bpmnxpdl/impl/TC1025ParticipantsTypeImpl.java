...
public class TC1025ParticipantsTypeImpl implements ru.runa.xpdl.generated.bpmnxpdl.TC1025ParticipantsType, com.sun.xml.bind.JAXBObject, ru.runa.xpdl.generated.bpmnxpdl.impl.runtime.UnmarshallableObject, ru.runa.xpdl.generated.bpmnxpdl.impl.runtime.XMLSerializable, ru.runa.xpdl.generated.bpmnxpdl.impl.runtime.ValidatableObject
{

    protected com.sun.xml.bind.util.ListImpl _TC1025Participant;
    ...
    private final static java.lang.Class PRIMARY_INTERFACE_CLASS() {
        return (ru.runa.xpdl.generated.bpmnxpdl.TC1025ParticipantsType.class);
    }

    protected com.sun.xml.bind.util.ListImpl _getTC1025Participant() {
        if (_TC1025Participant == null) {
            _TC1025Participant = new com.sun.xml.bind.util.ListImpl(new java.util.ArrayList());
        }
        return _TC1025Participant;
    }

    public java.util.List getTC1025Participant() {
        return _getTC1025Participant();
    }
    ...
    public ru.runa.xpdl.generated.bpmnxpdl.impl.runtime.UnmarshallingEventHandler createUnmarshaller(ru.runa.xpdl.generated.bpmnxpdl.impl.runtime.UnmarshallingContext context) {
        return new ru.runa.xpdl.generated.bpmnxpdl.impl.TC1025ParticipantsTypeImpl.Unmarshaller(context);
    }
    ...
    {
        int idx1 = 0;
        final int len1 = ((_TC1025Participant == null)? 0 :_TC1025Participant.size());
        while (idx1 != len1) {
            if (_TC1025Participant.get(idx1) instanceof javax.xml.bind.Element) {
                context.childAsBody(((com.sun.xml.bind.JAXBObject) _TC1025Participant.get(idx1 ++)), "TC1025Participant");
            } else {
                context.startElement("http://www.wfmc.org/2002/XPDL1.0", "TC1025Participant");
                int idx_0 = idx1;
                context.childAsURIs(((com.sun.xml.bind.JAXBObject) _TC1025Participant.get(idx_0 ++)), "TC1025Participant");
                context.endNamespaceDecls();
                int idx_1 = idx1;
                context.childAsAttributes(((com.sun.xml.bind.JAXBObject) _TC1025Participant.get(idx_1 ++)), "TC1025Participant");
        ...
        throws org.xml.sax.SAXException
    {
        ...
        while (idx1 != len1) {
            if (_TC1025Participant.get(idx1) instanceof javax.xml.bind.Element) {
                context.childAsAttributes(((com.sun.xml.bind.JAXBObject) _TC1025Participant.get(idx1 ++)), "TC1025Participant");
            } else {
                idx1 += 1;
            }
        }
        ...
        throws org.xml.sax.SAXException
    {
        ...
        while (idx1 != len1) {
            if (_TC1025Participant.get(idx1) instanceof javax.xml.bind.Element) {
                context.childAsURIs(((com.sun.xml.bind.JAXBObject) _TC1025Participant.get(idx1 ++)), "TC1025Participant");
            } else {
                idx1 += 1;
            }
        }
...
+"spaceURIq\u0000~\u0000\u001dxq\u0000~\u0000\u0018t\u0000$ru.runa.xpdl.generated.bpmnxpdl.TC1025Participantt\u0000"
+"+http://java.sun.com/jaxb/xjc/dummy-elementssq\u0000~\u0000\fq\u0000~\u0000\np\u0000sr\u0000"
+"\u001fcom.sun.msv.grammar.SequenceExp\u0000\u0000\u0000\u0000\u0000\u0000\u0000\u0001\u0002\u0000\u0000xq\u0000~\u0000\u0001ppsq\u0000~\u0000\fpp\u0000"
+"sq\u0000~\u0000\u0000ppsq\u0000~\u0000\u0006q\u0000~\u0000\npsq\u0000~\u0000\u0012q\u0000~\u0000\npq\u0000~\u0000\u0015q\u0000~\u0000\u0019q\u0000~\u0000\u001bsq\u0000~\u0000\u001ct\u0000)gene"
+"rated.bpmnxpdl.TC1025ParticipantType2q\u0000~\u0000 sq\u0000~\u0000\u0000ppsq\u0000~\u0000\u0012q\u0000~\u0000"
...
+"on$NullSetExpression\u0000\u0000\u0000\u0000\u0000\u0000\u0000\u0001\u0002\u0000\u0000xq\u0000~\u0000\u0003q\u0000~\u0000\npsr\u0000\u001bcom.sun.msv.u"
+"til.StringPair\u00d0t\u001ejB\u008f\u008d\u00a0\u0002\u0000\u0002L\u0000\tlocalNameq\u0000~\u0000\u001dL\u0000\fnamespaceURIq\u0000~"
+"\u0000\u001dxpq\u0000~\u00007q\u0000~\u00006sq\u0000~\u0000\u001ct\u0000\u0004typet\u0000)http://www.w3.org/2001/XMLSche"
+"ma-instanceq\u0000~\u0000\u001bsq\u0000~\u0000\u001ct\u0000\u0011TC1025Participantt\u0000 http://www.wfmc"
+".org/2002/XPDL1.0q\u0000~\u0000\u001bsr\u0000\"com.sun.msv.grammar.ExpressionPool"
...
+"\u0000~\u0000#q\u0000~\u0000*q\u0000~\u0000\u000bq\u0000~\u0000\bx"));
        ...
        extends ru.runa.xpdl.generated.bpmnxpdl.impl.runtime.AbstractUnmarshallingEventHandlerImpl
    {
        ...
        public java.lang.Object owner() {
            return ru.runa.xpdl.generated.bpmnxpdl.impl.TC1025ParticipantsTypeImpl.this;
        }
                ...
                switch (state) {
                    case  1 :
                        if (("TC1025Participant" == ___local)&&("http://www.wfmc.org/2002/XPDL1.0" == ___uri)) {
                            _getTC1025Participant().add(((ru.runa.xpdl.generated.bpmnxpdl.impl.TC1025ParticipantImpl) spawnChildFromEnterElement((ru.runa.xpdl.generated.bpmnxpdl.impl.TC1025ParticipantImpl.class), 1, ___uri, ___local, ___qname, __atts)));
                            return ;
                        }
                        if (("TC1025Participant" == ___local)&&("http://www.wfmc.org/2002/XPDL1.0" == ___uri)) {
                ...
                switch (state) {
                    ...
                    case  2 :
                        if (("Id" == ___local)&&("" == ___uri)) {
                            _getTC1025Participant().add(((ru.runa.xpdl.generated.bpmnxpdl.impl.TC1025ParticipantType2Impl) spawnChildFromEnterAttribute((ru.runa.xpdl.generated.bpmnxpdl.impl.TC1025ParticipantType2Impl.class), 3, ___uri, ___local, ___qname)));
                            return ;
                        }
                        break;
                }
