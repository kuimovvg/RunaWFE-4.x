...
public class OutputSetTypeImpl implements ru.runa.xpdl.generated.bpmnxpdl.OutputSetType, com.sun.xml.bind.JAXBObject, ru.runa.xpdl.generated.bpmnxpdl.impl.runtime.UnmarshallableObject, ru.runa.xpdl.generated.bpmnxpdl.impl.runtime.XMLSerializable, ru.runa.xpdl.generated.bpmnxpdl.impl.runtime.ValidatableObject
{

    protected com.sun.xml.bind.util.ListImpl _Any;
    protected com.sun.xml.bind.util.ListImpl _Output;
    ...
    private final static java.lang.Class PRIMARY_INTERFACE_CLASS() {
        return (ru.runa.xpdl.generated.bpmnxpdl.OutputSetType.class);
    }
    ...
    protected com.sun.xml.bind.util.ListImpl _getOutput() {
        if (_Output == null) {
            _Output = new com.sun.xml.bind.util.ListImpl(new java.util.ArrayList());
        }
        return _Output;
    }
    ...
    public ru.runa.xpdl.generated.bpmnxpdl.impl.runtime.UnmarshallingEventHandler createUnmarshaller(ru.runa.xpdl.generated.bpmnxpdl.impl.runtime.UnmarshallingContext context) {
        return new ru.runa.xpdl.generated.bpmnxpdl.impl.OutputSetTypeImpl.Unmarshaller(context);
    }
        ...
        throws org.xml.sax.SAXException
    {
        ...
        int idx2 = 0;
        final int len2 = ((_Output == null)? 0 :_Output.size());
        while (idx2 != len2) {
            if (_Output.get(idx2) instanceof javax.xml.bind.Element) {
                context.childAsBody(((com.sun.xml.bind.JAXBObject) _Output.get(idx2 ++)), "Output");
            } else {
                context.startElement("http://www.wfmc.org/2008/XPDL2.1", "Output");
                int idx_0 = idx2;
                context.childAsURIs(((com.sun.xml.bind.JAXBObject) _Output.get(idx_0 ++)), "Output");
                context.endNamespaceDecls();
                int idx_1 = idx2;
                context.childAsAttributes(((com.sun.xml.bind.JAXBObject) _Output.get(idx_1 ++)), "Output");
        ...
        throws org.xml.sax.SAXException
    {
        ...
        while (idx2 != len2) {
            if (_Output.get(idx2) instanceof javax.xml.bind.Element) {
                context.childAsAttributes(((com.sun.xml.bind.JAXBObject) _Output.get(idx2 ++)), "Output");
            } else {
                idx2 += 1;
            }
        }
        ...
        throws org.xml.sax.SAXException
    {
        ...
        while (idx2 != len2) {
            if (_Output.get(idx2) instanceof javax.xml.bind.Element) {
                context.childAsURIs(((com.sun.xml.bind.JAXBObject) _Output.get(idx2 ++)), "Output");
            } else {
                idx2 += 1;
            }
        }
...
+"rated.bpmnxpdl.Outputt\u0000+http://java.sun.com/jaxb/xjc/dummy-e"
+"lementssq\u0000~\u0000\u000bpp\u0000sq\u0000~\u0000\u0000ppsq\u0000~\u0000\u000bpp\u0000sq\u0000~\u0000\tppsq\u0000~\u0000\u0006q\u0000~\u0000\u0012psq\u0000~\u0000\u0013q"
+"\u0000~\u0000\u0012pq\u0000~\u0000\u0016q\u0000~\u0000\u001aq\u0000~\u0000\u001csq\u0000~\u0000\u001dt\u0000\u001dgenerated.bpmnxpdl.OutputTypeq\u0000"
...
+"w.w3.org/2001/XMLSchema-instanceq\u0000~\u0000\u001csq\u0000~\u0000\u001dt\u0000\u0006Outputt\u0000 http:"
...
+"\u0000~\u0000\u0010q\u0000~\u0000&q\u0000~\u0000\u0005q\u0000~\u0000\u000fq\u0000~\u0000%q\u0000~\u0000#q\u0000~\u0000Eq\u0000~\u0000Fq\u0000~\u0000*q\u0000~\u0000\nq\u0000~\u0000\bx"));
        ...
        extends ru.runa.xpdl.generated.bpmnxpdl.impl.runtime.AbstractUnmarshallingEventHandlerImpl
    {
        ...
        public java.lang.Object owner() {
            return ru.runa.xpdl.generated.bpmnxpdl.impl.OutputSetTypeImpl.this;
        }
                ...
                switch (state) {
                    case  0 :
                        if (("Output" == ___local)&&("http://www.wfmc.org/2008/XPDL2.1" == ___uri)) {
                            _getOutput().add(((ru.runa.xpdl.generated.bpmnxpdl.impl.OutputImpl) spawnChildFromEnterElement((ru.runa.xpdl.generated.bpmnxpdl.impl.OutputImpl.class), 1, ___uri, ___local, ___qname, __atts)));
                            return ;
                        }
                        if (("Output" == ___local)&&("http://www.wfmc.org/2008/XPDL2.1" == ___uri)) {
                ...
                switch (state) {
                    ...
                    case  3 :
                        if (("ArtifactId" == ___local)&&("" == ___uri)) {
                            _getOutput().add(((ru.runa.xpdl.generated.bpmnxpdl.impl.OutputTypeImpl) spawnChildFromEnterAttribute((ru.runa.xpdl.generated.bpmnxpdl.impl.OutputTypeImpl.class), 4, ___uri, ___local, ___qname)));
                            return ;
                        }
                        break;
                }
