...
import ru.runa.bpm.ui.properties.DefaultTaskDueDatePropertyDescriptor;
import ru.runa.bpm.ui.properties.StartImagePropertyDescriptor;
...
public class ProcessDefinition extends NamedGraphElement implements Active, Describable, ITimeOut {
    ...
    public void setDefaultTaskDuedate(String defaultTaskDuedate) {
        if (defaultTaskDuedate == null || defaultTaskDuedate == "") {
