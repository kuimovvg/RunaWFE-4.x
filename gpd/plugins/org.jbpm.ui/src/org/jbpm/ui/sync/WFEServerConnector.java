...
import ru.runa.bpm.ui.dialog.UserInputDialog;
...
public class WFEServerConnector implements IConnector, PrefConstants {
    ...
    public <T> T getService(String jndiName, Class<? extends EJBHome> homeClass) throws Exception {
        Object homeRef = remoteContext.lookup(jndiName);
        Object home = PortableRemoteObject.narrow(homeRef, homeClass);
        T service = (T) home.getClass().getMethod("create", new Class[0]).invoke(home, new Object[0]);
        return service;
    }
