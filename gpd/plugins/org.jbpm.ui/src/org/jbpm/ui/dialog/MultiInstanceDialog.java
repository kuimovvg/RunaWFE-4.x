...
public class MultiInstanceDialog extends Dialog {
    ...
    protected Control createDialogArea(Composite parent) {
        ...
        label2.setText(Messages.getString("Multiinstance.TypeMultiInstance"));
    ...
    private void createTabFolder(Composite parent) {
...

        {
            ...
            tabItem1.setText(Messages.getString("Multiinstance.tab.variable"));
...

        {
            ...
            composite1.setLayout(new GridLayout());
            CTabItem tabItem1 = new CTabItem(typeTabFolder, SWT.NONE);
            tabItem1.setText(Messages.getString("Multiinstance.tab.group"));
            tabItem1.setControl(composite1);
...

        {
            ...
            composite1.setLayout(new GridLayout());
            CTabItem tabItem1 = new CTabItem(typeTabFolder, SWT.NONE);
            tabItem1.setText(Messages.getString("Multiinstance.tab.relation"));
            tabItem1.setControl(composite1);
    ...
    private void createTabVariable(Composite parent) {
...

        {
            ...
            labelProcessVariable.setText(Messages.getString("Subprocess.ProcessVariableName") + ":");
...

        {
            Label labelProcessVariable = new Label(composite, SWT.NONE);
            labelProcessVariable.setLayoutData(new GridData(GridData.HORIZONTAL_ALIGN_END));
            labelProcessVariable.setText(Messages.getString("Subprocess.SubprocessVariableName") + ":");
        ...
        setButton.setText(Messages.getString("Multiinstance.button.setTypeMultiInstance"));
    ...
    private void createTabGroup(Composite parent) {
...

        {
            ...
            labelProcessVariable.setLayoutData(new GridData(GridData.HORIZONTAL_ALIGN_END));
            labelProcessVariable.setText(Messages.getString("Multiinstance.GroupName") + ":");
    ...
    private void createTabRelation(Composite parent) {
...

        {
            Label labelProcessVariable = new Label(composite, SWT.READ_ONLY);
            labelProcessVariable.setLayoutData(new GridData(GridData.HORIZONTAL_ALIGN_END));
            labelProcessVariable.setText(Messages.getString("Multiinstance.RelationName") + ":");
...

        {
            Label labelProcessVariable = new Label(composite, SWT.READ_ONLY);
            labelProcessVariable.setLayoutData(new GridData(GridData.HORIZONTAL_ALIGN_END));
            labelProcessVariable.setText(Messages.getString("Multiinstance.RelationParam") + ":");
        ...
        removeButton.addSelectionListener(new SelectionAdapter() {
            ...
            public void widgetSelected(SelectionEvent event) {
                ...
                if (!selection.isEmpty()) {
                    ...
                    if (MessageDialog.openQuestion(comp.getShell(), Messages.getString("Mapping.Remove.title"), Messages
                            .getString("Mapping.Remove.message"))) {
    ...
    private void editVariableMapping(VariableMapping oldMapping) {
        SubprocessVariableDialog dialog = new SubprocessVariableDialog(getProcessVariablesNamesAll(definition.getName()),
                getProcessVariablesNamesAll(getSubprocessName()), oldMapping);
