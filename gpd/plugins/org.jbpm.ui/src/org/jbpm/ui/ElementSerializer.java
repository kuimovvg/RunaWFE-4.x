...
public abstract class ElementSerializer {
    ...
    protected void writeTransitions(Document document, Element parent, ru.runa.bpm.ui.common.model.Node node) {
    ...
    protected Element writeNode(Document document, Element parent, ru.runa.bpm.ui.common.model.Node node, String delegationNodeName) {
