...
public class SwimlaneElementRegistry {
    ...
    private static SwimlaneElement parseElement(IConfigurationElement configElement) throws Exception {
        try {
            ...
            DesignerLogger.logError("Error processing extension 'ru.runa.bpm.ui.swimlaneelements'", e);
            return null;
        }
    }
    ...
    public static List<SwimlaneElement> getSwimlaneElements() {
        ...
        try {
            IExtension[] extensions = Platform.getExtensionRegistry().getExtensionPoint("ru.runa.bpm.ui.swimlaneelements").getExtensions();
            ...
            for (SwimlaneElement swimlaneElement : lazySwimlaneElements) {
                try {
                    ...
                    DesignerLogger.logError("Invalid TreePath in SwimlaneElement", e);
                }
            }
        } catch (Exception e) {
            DesignerLogger.logError("Error processing extension 'ru.runa.bpm.ui.swimlaneelements'", e);
