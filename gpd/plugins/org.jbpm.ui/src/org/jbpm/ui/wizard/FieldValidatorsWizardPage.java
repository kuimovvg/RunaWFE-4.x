...
import ru.runa.bpm.ui.wizard.ValidatorWizard.DefaultParamsComposite;
...
public class FieldValidatorsWizardPage extends WizardPage {
    ...
    protected FieldValidatorsWizardPage(String pageName, List<Variable> variables, List<Swimlane> swimlanes) {
        ...
        setTitle(Messages.getString("ValidatorWizardPage.fieldpage.title"));
        setDescription(Messages.getString("ValidatorWizardPage.fieldpage.description"));
    }
    ...
    public void createControl(Composite parent) {
        ...
        tabItem1.setText(Messages.getString("FieldValidatorsWizardPage.Variables"));
        ...
        tabItem2.setText(Messages.getString("FieldValidatorsWizardPage.Swimlanes"));
        ...
        validatorsTableViewer = createTableViewer(right, 300, 100, Messages.getString("FieldValidatorsWizardPage.Validators"));
