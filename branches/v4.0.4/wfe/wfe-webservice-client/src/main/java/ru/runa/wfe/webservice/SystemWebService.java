 ...
 * 
 */
@WebServiceClient(name = "SystemWebService", targetNamespace = "http://impl.service.wfe.runa.ru/", wsdlLocation = "http://localhost:8080/runawfe-wfe-service-4.0.0/SystemServiceBean?wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("http://localhost:8080/runawfe-wfe-service-4.0.0/SystemServiceBean?wsdl");
