...
public interface TaskCache extends VersionedCache {
    ...
    /**
     * Set tasks for {@link Actor} with specified id, and specified {@link BatchPresentation}. Next call to {@link #getTasks(Long, BatchPresentation)} with same parameters will
     * return this tasks.
     * 
     * @param cacheVersion
     *            Cache version, which may accept tasks.
     * @param actorId
