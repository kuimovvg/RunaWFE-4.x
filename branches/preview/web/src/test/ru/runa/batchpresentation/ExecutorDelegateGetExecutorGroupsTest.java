 ...
 * 
 */
public class ExecutorDelegateGetExecutorGroupsTest extends ServletTestCase {
    ...
    public static Test suite() {
        return new TestSuite(ExecutorDelegateGetExecutorGroupsTest.class);
    }
    ...
    protected void setUp() throws Exception {
        ...
        helper.addSubjectedActorToTestGroups();
    ...
    public void testGetExecutorGroup_CriteriaFilterName() throws Exception {
        int i = 3;
        ...
        List<Group> groups = executorService.getExecutorGroups(helper.getViewerSubject(), helper.getSubjectedActor(), batchPresentation, false);
    ...
    public void testGetExecutorGroup_CriteriaSortDescriptionAsc() throws Exception {
    ...
    public void testGetExecutorGroup_CriteriaSortDescriptionDesc() throws Exception {
    ...
    public void testGetExecutorGroup_CriteriaSortNameAsc() throws Exception {
    ...
    public void testGetExecutorGroup_CriteriaSortNameDesc() throws Exception {
    ...
    public void testGetExecutorGroup_CriteriaSortNameDescriptionAsc() throws Exception {
    ...
    public void testGetExecutorGroup_CriteriaSortNameDescriptionDesc() throws Exception {
