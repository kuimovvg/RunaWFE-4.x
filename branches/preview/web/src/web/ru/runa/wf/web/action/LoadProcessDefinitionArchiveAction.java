...
public class LoadProcessDefinitionArchiveAction extends Action {
    ...
    public ActionForward execute(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) throws Exception {
        ...
        String parFileName = definitionService.getProcessDefinitionStub(subject, idForm.getId()).getName() + ".par";
        byte[] bytes = definitionService.getFile(subject, idForm.getId(), "par");
