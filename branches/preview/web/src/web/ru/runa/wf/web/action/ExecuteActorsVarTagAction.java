...
/**
 * @struts:action path="/executeActorsVarTag" name="executeActorsVarTag" validate="false"
 */
public class ExecuteActorsVarTagAction extends Action {
    protected static final Log log = LogFactory.getLog(ExecuteActorsVarTagAction.class);
    ...
    public ActionForward execute(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) throws Exception {
        ...
        try {
            ...
            xmlBuffer.append("<actor id=\"0\" name=\"Error: ").append(e.getMessage()).append("\"/>\n");
