...
class NodeEnterState extends BaseState {
    public NodeEnterState(BaseState parent) {
        super(parent);
    }

    @Override
    protected List<Element> acceptLog(ProcessLog currentLog, LogIterator logs) {
        TaskCreateLog invLog = (TaskCreateLog) currentLog;
        ...
        retVal.add(new StringElement(
                replacePlaceholders(Messages.HISTORY_TASK_START, invLog.getTaskInstance(), invLog.getActorId(), null, null, null)));
        return retVal;
    }
}
