...
public class ListExecutorRightRelationsFormTag extends IdentifiableFormTag {
    ...
    protected void fillFormData(TD tdFormElement) throws JspException {
        ...
        try {
            ...
            for (RelationPair pair : relationService.getExecutorsRelationPairsRight(getSubject(), null, executors)) {
            ...
            RowBuilder rowBuilder = new ReflectionRowBuilder(Lists.newArrayList(relations), executorBatchPresentation, pageContext,
                    ru.runa.af.web.Resources.ACTION_MAPPING_MANAGE_EXECUTOR_RIGHT_RELATION, "", new RelationURLStrategy(), builders);
