...
public class UpdateExecutorDetailsAction extends Action {
    ...
    public ActionForward execute(ActionMapping mapping, ActionForm actionForm, HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Executor executor = executorService.getExecutor(subject, id);
            if (executor instanceof Actor) {
                executorService.update(subject, (Actor) executor,
                        new Actor(name, form.getDescription(), form.getFullName(), form.getCode(), form.getEmail(), form.getPhone()));
            } else {
                executorService.update(subject, (Group) executor, new Group(name, form.getDescription(), form.getEmail()));
            }
