...
public class ListExecutorLeftRelationMembersFormTag extends TitledFormTag {
    ...
    protected void fillFormElement(TD tdFormElement) throws JspException {
        try {
            ...
            BatchPresentation executorBatchPresentation = AFProfileStrategy.EXECUTOR_DEAFAULT_BATCH_PRESENTATOIN_FACTORY
            ...
            List<RelationPair> relationPairs = relationService.getExecutorsRelationPairsLeft(getSubject(), null, executors);
            ...
            BatchPresentation batchPresentation = AFProfileStrategy.RELATIONS_DEFAULT_BATCH_PRESENTATOIN_FACTORY.getDefaultBatchPresentation();
            ...
            RowBuilder rowBuilder = new ReflectionRowBuilder(relationPairs, batchPresentation, pageContext,
                    ru.runa.af.web.Resources.ACTION_MAPPING_UPDATE_EXECUTOR, getReturnAction(), IdForm.ID_INPUT_NAME, builders);
