 ...
 * 
 * @struts:action path="/removeExecutorsFromGroup" name="idsForm" validate="true" input = "/WEB-INF/af/manage_executor.jsp"
 ...
 */
public class RemoveExecutorsFromGroupAction extends Action {
    ...
    public ActionForward execute(ActionMapping mapping, ActionForm actionForm, HttpServletRequest request, HttpServletResponse responce)
        ...
        try {
            ...
            executorService.removeExecutorsFromGroup(subject, Lists.newArrayList(form.getIds()), form.getId());
