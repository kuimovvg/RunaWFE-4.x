...
/**
 * This class in conjunction with {@link ru.runa.af.web.action.NTLMLoginAction}provides NTLM support for IE. Created on 10.11.2005 If user-agent name contails MSIE than filter ask him to pass NTLM authentication again.
 * 
...
public class NTLMFilter extends HTTPFilterBase {
    ...
    protected void doFilter(HttpServletRequest request, HttpServletResponse response, FilterChain chain) throws IOException, ServletException {
        ...
        if (NTLMSupportResources.isNTLMSupported() && isMSIEUserAgentBrowser && isPostRequest
