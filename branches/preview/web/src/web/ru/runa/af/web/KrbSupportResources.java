...
public class KrbSupportResources extends ResourceCommons {
    ...
    private static final String KRB_SUPPORTED = "krb_supported";

    static {
        loginModuleParams = new HashMap<String, String>();
        Enumeration propertiesEnum = getKeys(PROPERTY_FILE);
    ...
    public static boolean isKrbSupported() {
        return Boolean.TRUE.toString().equalsIgnoreCase(readProperty(KRB_SUPPORTED, PROPERTY_FILE));
    }
}
