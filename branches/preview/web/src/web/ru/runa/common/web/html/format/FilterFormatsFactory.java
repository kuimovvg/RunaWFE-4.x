...
import ru.runa.wf.presentation.SystemLogTypeFilterCriteria;
import ru.runa.wf.presentation.SystemLogTypeHelper;
...
public class FilterFormatsFactory {
    ...
    static {
        ...
        formattersMap.put(VariableInstance.class.getName(), new StringFilterTDFormatter());
