...
public class InputSetsTypeImpl implements ru.runa.xpdl.generated.bpmnxpdl.InputSetsType, com.sun.xml.bind.JAXBObject, ru.runa.xpdl.generated.bpmnxpdl.impl.runtime.UnmarshallableObject, ru.runa.xpdl.generated.bpmnxpdl.impl.runtime.XMLSerializable, ru.runa.xpdl.generated.bpmnxpdl.impl.runtime.ValidatableObject
{
    ...
    private final static java.lang.Class PRIMARY_INTERFACE_CLASS() {
        return (ru.runa.xpdl.generated.bpmnxpdl.InputSetsType.class);
    }
    ...
    protected com.sun.xml.bind.util.ListImpl _getInputSet() {
        if (_InputSet == null) {
            _InputSet = new com.sun.xml.bind.util.ListImpl(new java.util.ArrayList());
        }
        return _InputSet;
    }

    public java.util.List getInputSet() {
        return _getInputSet();
    }
    ...
    public ru.runa.xpdl.generated.bpmnxpdl.impl.runtime.UnmarshallingEventHandler createUnmarshaller(ru.runa.xpdl.generated.bpmnxpdl.impl.runtime.UnmarshallingContext context) {
        return new ru.runa.xpdl.generated.bpmnxpdl.impl.InputSetsTypeImpl.Unmarshaller(context);
    }
        ...
        throws org.xml.sax.SAXException
    {
        ...
        int idx2 = 0;
        final int len2 = ((_InputSet == null)? 0 :_InputSet.size());
        while (idx2 != len2) {
            if (_InputSet.get(idx2) instanceof javax.xml.bind.Element) {
                context.childAsBody(((com.sun.xml.bind.JAXBObject) _InputSet.get(idx2 ++)), "InputSet");
            } else {
                context.startElement("http://www.wfmc.org/2008/XPDL2.1", "InputSet");
                int idx_0 = idx2;
                context.childAsURIs(((com.sun.xml.bind.JAXBObject) _InputSet.get(idx_0 ++)), "InputSet");
                context.endNamespaceDecls();
                int idx_1 = idx2;
                context.childAsAttributes(((com.sun.xml.bind.JAXBObject) _InputSet.get(idx_1 ++)), "InputSet");
        ...
        throws org.xml.sax.SAXException
    {
        ...
        while (idx2 != len2) {
            if (_InputSet.get(idx2) instanceof javax.xml.bind.Element) {
                context.childAsAttributes(((com.sun.xml.bind.JAXBObject) _InputSet.get(idx2 ++)), "InputSet");
            } else {
                idx2 += 1;
            }
        }
        ...
        throws org.xml.sax.SAXException
    {
        ...
        while (idx2 != len2) {
            if (_InputSet.get(idx2) instanceof javax.xml.bind.Element) {
                context.childAsURIs(((com.sun.xml.bind.JAXBObject) _InputSet.get(idx2 ++)), "InputSet");
            } else {
                idx2 += 1;
            }
        }
...
+"rated.bpmnxpdl.InputSett\u0000+http://java.sun.com/jaxb/xjc/dummy"
+"-elementssq\u0000~\u0000\u000bpp\u0000sq\u0000~\u0000\u0000ppsq\u0000~\u0000\u000bpp\u0000sq\u0000~\u0000\tppsq\u0000~\u0000\u0006q\u0000~\u0000\u0012psq\u0000~\u0000"
+"\u0013q\u0000~\u0000\u0012pq\u0000~\u0000\u0016q\u0000~\u0000\u001aq\u0000~\u0000\u001csq\u0000~\u0000\u001dt\u0000\u001fgenerated.bpmnxpdl.InputSetTy"
...
+"//www.w3.org/2001/XMLSchema-instanceq\u0000~\u0000\u001csq\u0000~\u0000\u001dt\u0000\bInputSett\u0000"
...
+"x"));
        ...
        extends ru.runa.xpdl.generated.bpmnxpdl.impl.runtime.AbstractUnmarshallingEventHandlerImpl
    {
        ...
        public java.lang.Object owner() {
            return ru.runa.xpdl.generated.bpmnxpdl.impl.InputSetsTypeImpl.this;
        }
                ...
                switch (state) {
                    case  0 :
                        if (("InputSet" == ___local)&&("http://www.wfmc.org/2008/XPDL2.1" == ___uri)) {
                            _getInputSet().add(((ru.runa.xpdl.generated.bpmnxpdl.impl.InputSetImpl) spawnChildFromEnterElement((ru.runa.xpdl.generated.bpmnxpdl.impl.InputSetImpl.class), 3, ___uri, ___local, ___qname, __atts)));
                            return ;
                        }
                        if (("InputSet" == ___local)&&("http://www.wfmc.org/2008/XPDL2.1" == ___uri)) {
                    ...
                    case  1 :
                        if (("Input" == ___local)&&("http://www.wfmc.org/2008/XPDL2.1" == ___uri)) {
                            _getInputSet().add(((ru.runa.xpdl.generated.bpmnxpdl.impl.InputSetTypeImpl) spawnChildFromEnterElement((ru.runa.xpdl.generated.bpmnxpdl.impl.InputSetTypeImpl.class), 2, ___uri, ___local, ___qname, __atts)));
                            return ;
                        }
                        if (("Input" == ___local)&&("http://www.wfmc.org/2008/XPDL2.1" == ___uri)) {
                            _getInputSet().add(((ru.runa.xpdl.generated.bpmnxpdl.impl.InputSetTypeImpl) spawnChildFromEnterElement((ru.runa.xpdl.generated.bpmnxpdl.impl.InputSetTypeImpl.class), 2, ___uri, ___local, ___qname, __atts)));
