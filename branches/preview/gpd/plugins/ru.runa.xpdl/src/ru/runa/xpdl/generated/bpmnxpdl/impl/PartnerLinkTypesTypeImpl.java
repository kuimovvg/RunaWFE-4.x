...
public class PartnerLinkTypesTypeImpl implements ru.runa.xpdl.generated.bpmnxpdl.PartnerLinkTypesType, com.sun.xml.bind.JAXBObject, ru.runa.xpdl.generated.bpmnxpdl.impl.runtime.UnmarshallableObject, ru.runa.xpdl.generated.bpmnxpdl.impl.runtime.XMLSerializable, ru.runa.xpdl.generated.bpmnxpdl.impl.runtime.ValidatableObject
{

    protected com.sun.xml.bind.util.ListImpl _PartnerLinkType;
    ...
    private final static java.lang.Class PRIMARY_INTERFACE_CLASS() {
        return (ru.runa.xpdl.generated.bpmnxpdl.PartnerLinkTypesType.class);
    }

    protected com.sun.xml.bind.util.ListImpl _getPartnerLinkType() {
        if (_PartnerLinkType == null) {
            _PartnerLinkType = new com.sun.xml.bind.util.ListImpl(new java.util.ArrayList());
        }
        return _PartnerLinkType;
    }

    public java.util.List getPartnerLinkType() {
        return _getPartnerLinkType();
    }
    ...
    public ru.runa.xpdl.generated.bpmnxpdl.impl.runtime.UnmarshallingEventHandler createUnmarshaller(ru.runa.xpdl.generated.bpmnxpdl.impl.runtime.UnmarshallingContext context) {
        return new ru.runa.xpdl.generated.bpmnxpdl.impl.PartnerLinkTypesTypeImpl.Unmarshaller(context);
    }
    ...
    {
        int idx1 = 0;
        final int len1 = ((_PartnerLinkType == null)? 0 :_PartnerLinkType.size());
        int idx2 = 0;
        final int len2 = ((_Any == null)? 0 :_Any.size());
        while (idx1 != len1) {
            if (_PartnerLinkType.get(idx1) instanceof javax.xml.bind.Element) {
                context.childAsBody(((com.sun.xml.bind.JAXBObject) _PartnerLinkType.get(idx1 ++)), "PartnerLinkType");
            } else {
                context.startElement("http://www.wfmc.org/2008/XPDL2.1", "PartnerLinkType");
                int idx_0 = idx1;
                context.childAsURIs(((com.sun.xml.bind.JAXBObject) _PartnerLinkType.get(idx_0 ++)), "PartnerLinkType");
                context.endNamespaceDecls();
                int idx_1 = idx1;
                context.childAsAttributes(((com.sun.xml.bind.JAXBObject) _PartnerLinkType.get(idx_1 ++)), "PartnerLinkType");
        ...
        throws org.xml.sax.SAXException
    {
        ...
        while (idx1 != len1) {
            if (_PartnerLinkType.get(idx1) instanceof javax.xml.bind.Element) {
                context.childAsAttributes(((com.sun.xml.bind.JAXBObject) _PartnerLinkType.get(idx1 ++)), "PartnerLinkType");
            } else {
                idx1 += 1;
            }
        }
        ...
        throws org.xml.sax.SAXException
    {
        ...
        while (idx1 != len1) {
            if (_PartnerLinkType.get(idx1) instanceof javax.xml.bind.Element) {
                context.childAsURIs(((com.sun.xml.bind.JAXBObject) _PartnerLinkType.get(idx1 ++)), "PartnerLinkType");
            } else {
                idx1 += 1;
            }
        }
...
+"rated.bpmnxpdl.PartnerLinkTypet\u0000+http://java.sun.com/jaxb/xj"
+"c/dummy-elementssq\u0000~\u0000\u000bpp\u0000sq\u0000~\u0000\u0000ppsq\u0000~\u0000\u000bpp\u0000sq\u0000~\u0000\tppsq\u0000~\u0000\u0006q\u0000~\u0000"
+"\u0012psq\u0000~\u0000\u0013q\u0000~\u0000\u0012pq\u0000~\u0000\u0016q\u0000~\u0000\u001aq\u0000~\u0000\u001csq\u0000~\u0000\u001dt\u0000&ru.runa.xpdl.generated.bpmnxpdl.Par"
+"tnerLinkTypeTypeq\u0000~\u0000!sq\u0000~\u0000\tppsq\u0000~\u0000\u0013q\u0000~\u0000\u0012psr\u0000\u001bcom.sun.msv.gra"
...
+"\u001dt\u0000\u000fPartnerLinkTypet\u0000 http://www.wfmc.org/2008/XPDL2.1sq\u0000~\u0000\t"
+"ppsq\u0000~\u0000\u0006q\u0000~\u0000\u0012psq\u0000~\u0000\u000bq\u0000~\u0000\u0012p\u0000sq\u0000~\u0000\u0013ppq\u0000~\u0000\u0016sr\u0000\'com.sun.msv.gram"
+"mar.DifferenceNameClass\u0000\u0000\u0000\u0000\u0000\u0000\u0000\u0001\u0002\u0000\u0002L\u0000\u0003nc1q\u0000~\u0000\fL\u0000\u0003nc2q\u0000~\u0000\fxq\u0000~"
+"\u0000\u0019q\u0000~\u0000\u001asr\u0000#com.sun.msv.grammar.ChoiceNameClass\u0000\u0000\u0000\u0000\u0000\u0000\u0000\u0001\u0002\u0000\u0002L\u0000\u0003"
+"nc1q\u0000~\u0000\fL\u0000\u0003nc2q\u0000~\u0000\fxq\u0000~\u0000\u0019sr\u0000&com.sun.msv.grammar.NamespaceNa"
+"meClass\u0000\u0000\u0000\u0000\u0000\u0000\u0000\u0001\u0002\u0000\u0001L\u0000\fnamespaceURIq\u0000~\u0000\u001exq\u0000~\u0000\u0019t\u0000\u0000sq\u0000~\u0000Mq\u0000~\u0000Dsq"
...
+"ar/ExpressionPool;xp\u0000\u0000\u0000\u000b\u0001pq\u0000~\u0000\u0010q\u0000~\u0000&q\u0000~\u0000Fq\u0000~\u0000\u000fq\u0000~\u0000%q\u0000~\u0000\u0005q\u0000~\u0000"
+"#q\u0000~\u0000*q\u0000~\u0000\nq\u0000~\u0000\bq\u0000~\u0000Ex"));
        }
        ...
        extends ru.runa.xpdl.generated.bpmnxpdl.impl.runtime.AbstractUnmarshallingEventHandlerImpl
    {
        ...
        public java.lang.Object owner() {
            return ru.runa.xpdl.generated.bpmnxpdl.impl.PartnerLinkTypesTypeImpl.this;
        }
                ...
                switch (state) {
                    ...
                    case  3 :
                        if (("PartnerLinkType" == ___local)&&("http://www.wfmc.org/2008/XPDL2.1" == ___uri)) {
                            _getPartnerLinkType().add(((ru.runa.xpdl.generated.bpmnxpdl.impl.PartnerLinkTypeImpl) spawnChildFromEnterElement((ru.runa.xpdl.generated.bpmnxpdl.impl.PartnerLinkTypeImpl.class), 3, ___uri, ___local, ___qname, __atts)));
                            return ;
                        }
                        if (("PartnerLinkType" == ___local)&&("http://www.wfmc.org/2008/XPDL2.1" == ___uri)) {
                ...
                switch (state) {
                    ...
                    case  1 :
                        if (("Id" == ___local)&&("" == ___uri)) {
                            _getPartnerLinkType().add(((ru.runa.xpdl.generated.bpmnxpdl.impl.PartnerLinkTypeTypeImpl) spawnChildFromEnterAttribute((ru.runa.xpdl.generated.bpmnxpdl.impl.PartnerLinkTypeTypeImpl.class), 2, ___uri, ___local, ___qname)));
                            return ;
                        }
                        break;
                }
