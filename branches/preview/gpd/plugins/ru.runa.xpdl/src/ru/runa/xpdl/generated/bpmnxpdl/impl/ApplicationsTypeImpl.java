...
public class ApplicationsTypeImpl implements ru.runa.xpdl.generated.bpmnxpdl.ApplicationsType, com.sun.xml.bind.JAXBObject, ru.runa.xpdl.generated.bpmnxpdl.impl.runtime.UnmarshallableObject, ru.runa.xpdl.generated.bpmnxpdl.impl.runtime.XMLSerializable, ru.runa.xpdl.generated.bpmnxpdl.impl.runtime.ValidatableObject
{
    ...
    private final static java.lang.Class PRIMARY_INTERFACE_CLASS() {
        return (ru.runa.xpdl.generated.bpmnxpdl.ApplicationsType.class);
    }
    ...
    protected com.sun.xml.bind.util.ListImpl _getApplication() {
        if (_Application == null) {
            _Application = new com.sun.xml.bind.util.ListImpl(new java.util.ArrayList());
        }
        return _Application;
    }

    public java.util.List getApplication() {
    ...
    public ru.runa.xpdl.generated.bpmnxpdl.impl.runtime.UnmarshallingEventHandler createUnmarshaller(ru.runa.xpdl.generated.bpmnxpdl.impl.runtime.UnmarshallingContext context) {
        return new ru.runa.xpdl.generated.bpmnxpdl.impl.ApplicationsTypeImpl.Unmarshaller(context);
    }
        ...
        throws org.xml.sax.SAXException
    {
        ...
        int idx2 = 0;
        final int len2 = ((_Application == null)? 0 :_Application.size());
        while (idx2 != len2) {
            if (_Application.get(idx2) instanceof javax.xml.bind.Element) {
                context.childAsBody(((com.sun.xml.bind.JAXBObject) _Application.get(idx2 ++)), "Application");
            } else {
                context.startElement("http://www.wfmc.org/2008/XPDL2.1", "Application");
                int idx_0 = idx2;
                context.childAsURIs(((com.sun.xml.bind.JAXBObject) _Application.get(idx_0 ++)), "Application");
                context.endNamespaceDecls();
                int idx_1 = idx2;
                context.childAsAttributes(((com.sun.xml.bind.JAXBObject) _Application.get(idx_1 ++)), "Application");
        ...
        throws org.xml.sax.SAXException
    {
        ...
        while (idx2 != len2) {
            if (_Application.get(idx2) instanceof javax.xml.bind.Element) {
                context.childAsAttributes(((com.sun.xml.bind.JAXBObject) _Application.get(idx2 ++)), "Application");
            } else {
                idx2 += 1;
            }
        }
        ...
        throws org.xml.sax.SAXException
    {
        ...
        while (idx2 != len2) {
            if (_Application.get(idx2) instanceof javax.xml.bind.Element) {
                context.childAsURIs(((com.sun.xml.bind.JAXBObject) _Application.get(idx2 ++)), "Application");
            } else {
                idx2 += 1;
            }
        }
...
+"RIq\u0000~\u0000\u001fxq\u0000~\u0000\u001at\u0000\u001egenerated.bpmnxpdl.Applicationt\u0000+http://java"
+".sun.com/jaxb/xjc/dummy-elementssq\u0000~\u0000\u000eq\u0000~\u0000\fp\u0000sq\u0000~\u0000\u0000ppsq\u0000~\u0000\u000ep"
+"p\u0000sq\u0000~\u0000\u0006ppsq\u0000~\u0000\bq\u0000~\u0000\fpsq\u0000~\u0000\u0014q\u0000~\u0000\fpq\u0000~\u0000\u0017q\u0000~\u0000\u001bq\u0000~\u0000\u001dsq\u0000~\u0000\u001et\u0000#ge"
+"nerated.bpmnxpdl.ApplicationType2q\u0000~\u0000\"sq\u0000~\u0000\u0006ppsq\u0000~\u0000\u0014q\u0000~\u0000\fpsr"
...
+"nstanceq\u0000~\u0000\u001dsq\u0000~\u0000\u001et\u0000\u000bApplicationt\u0000 http://www.wfmc.org/2008/"
...
+"Lcom/sun/msv/grammar/ExpressionPool;xp\u0000\u0000\u0000\f\u0001pq\u0000~\u0000\u0013q\u0000~\u0000\'q\u0000~\u0000Gq"
+"\u0000~\u0000\u0007q\u0000~\u0000\u0012q\u0000~\u0000&q\u0000~\u0000$q\u0000~\u0000Fq\u0000~\u0000\u0005q\u0000~\u0000+q\u0000~\u0000\rq\u0000~\u0000\nx"));
        }
        ...
        extends ru.runa.xpdl.generated.bpmnxpdl.impl.runtime.AbstractUnmarshallingEventHandlerImpl
    {
        ...
        public java.lang.Object owner() {
            return ru.runa.xpdl.generated.bpmnxpdl.impl.ApplicationsTypeImpl.this;
        }
                ...
                switch (state) {
                    case  0 :
                        if (("Application" == ___local)&&("http://www.wfmc.org/2008/XPDL2.1" == ___uri)) {
                            _getApplication().add(((ru.runa.xpdl.generated.bpmnxpdl.impl.ApplicationImpl) spawnChildFromEnterElement((ru.runa.xpdl.generated.bpmnxpdl.impl.ApplicationImpl.class), 3, ___uri, ___local, ___qname, __atts)));
                            return ;
                        }
                        if (("Application" == ___local)&&("http://www.wfmc.org/2008/XPDL2.1" == ___uri)) {
                ...
                switch (state) {
                    ...
                    case  1 :
                        if (("Id" == ___local)&&("" == ___uri)) {
                            _getApplication().add(((ru.runa.xpdl.generated.bpmnxpdl.impl.ApplicationType2Impl) spawnChildFromEnterAttribute((ru.runa.xpdl.generated.bpmnxpdl.impl.ApplicationType2Impl.class), 2, ___uri, ___local, ___qname)));
                            return ;
                        }
                        break;
                    case  3 :
