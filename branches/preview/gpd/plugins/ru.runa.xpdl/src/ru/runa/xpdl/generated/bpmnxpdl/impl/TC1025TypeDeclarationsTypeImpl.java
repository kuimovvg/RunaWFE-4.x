...
public class TC1025TypeDeclarationsTypeImpl implements ru.runa.xpdl.generated.bpmnxpdl.TC1025TypeDeclarationsType, com.sun.xml.bind.JAXBObject, ru.runa.xpdl.generated.bpmnxpdl.impl.runtime.UnmarshallableObject, ru.runa.xpdl.generated.bpmnxpdl.impl.runtime.XMLSerializable, ru.runa.xpdl.generated.bpmnxpdl.impl.runtime.ValidatableObject
{

    protected com.sun.xml.bind.util.ListImpl _TC1025TypeDeclaration;
    ...
    private final static java.lang.Class PRIMARY_INTERFACE_CLASS() {
        return (ru.runa.xpdl.generated.bpmnxpdl.TC1025TypeDeclarationsType.class);
    }

    protected com.sun.xml.bind.util.ListImpl _getTC1025TypeDeclaration() {
        if (_TC1025TypeDeclaration == null) {
            _TC1025TypeDeclaration = new com.sun.xml.bind.util.ListImpl(new java.util.ArrayList());
        }
        return _TC1025TypeDeclaration;
    }

    public java.util.List getTC1025TypeDeclaration() {
        return _getTC1025TypeDeclaration();
    }
    ...
    public ru.runa.xpdl.generated.bpmnxpdl.impl.runtime.UnmarshallingEventHandler createUnmarshaller(ru.runa.xpdl.generated.bpmnxpdl.impl.runtime.UnmarshallingContext context) {
        return new ru.runa.xpdl.generated.bpmnxpdl.impl.TC1025TypeDeclarationsTypeImpl.Unmarshaller(context);
    }
    ...
    {
        int idx1 = 0;
        final int len1 = ((_TC1025TypeDeclaration == null)? 0 :_TC1025TypeDeclaration.size());
        while (idx1 != len1) {
            if (_TC1025TypeDeclaration.get(idx1) instanceof javax.xml.bind.Element) {
                context.childAsBody(((com.sun.xml.bind.JAXBObject) _TC1025TypeDeclaration.get(idx1 ++)), "TC1025TypeDeclaration");
            } else {
                context.startElement("http://www.wfmc.org/2002/XPDL1.0", "TC1025TypeDeclaration");
                int idx_0 = idx1;
                context.childAsURIs(((com.sun.xml.bind.JAXBObject) _TC1025TypeDeclaration.get(idx_0 ++)), "TC1025TypeDeclaration");
                context.endNamespaceDecls();
                int idx_1 = idx1;
                context.childAsAttributes(((com.sun.xml.bind.JAXBObject) _TC1025TypeDeclaration.get(idx_1 ++)), "TC1025TypeDeclaration");
        ...
        throws org.xml.sax.SAXException
    {
        ...
        while (idx1 != len1) {
            if (_TC1025TypeDeclaration.get(idx1) instanceof javax.xml.bind.Element) {
                context.childAsAttributes(((com.sun.xml.bind.JAXBObject) _TC1025TypeDeclaration.get(idx1 ++)), "TC1025TypeDeclaration");
            } else {
                idx1 += 1;
            }
        }
        ...
        throws org.xml.sax.SAXException
    {
        ...
        while (idx1 != len1) {
            if (_TC1025TypeDeclaration.get(idx1) instanceof javax.xml.bind.Element) {
                context.childAsURIs(((com.sun.xml.bind.JAXBObject) _TC1025TypeDeclaration.get(idx1 ++)), "TC1025TypeDeclaration");
            } else {
                idx1 += 1;
            }
        }
...
+"spaceURIq\u0000~\u0000\u001dxq\u0000~\u0000\u0018t\u0000(ru.runa.xpdl.generated.bpmnxpdl.TC1025TypeDeclarati"
+"ont\u0000+http://java.sun.com/jaxb/xjc/dummy-elementssq\u0000~\u0000\fq\u0000~\u0000\np"
+"\u0000sr\u0000\u001fcom.sun.msv.grammar.SequenceExp\u0000\u0000\u0000\u0000\u0000\u0000\u0000\u0001\u0002\u0000\u0000xq\u0000~\u0000\u0001ppsq\u0000~\u0000"
+"\fpp\u0000sq\u0000~\u0000\u0000ppsq\u0000~\u0000\u0006q\u0000~\u0000\npsq\u0000~\u0000\u0012q\u0000~\u0000\npq\u0000~\u0000\u0015q\u0000~\u0000\u0019q\u0000~\u0000\u001bsq\u0000~\u0000\u001ct\u0000,"
+"ru.runa.xpdl.generated.bpmnxpdl.TC1025TypeDeclarationTypeq\u0000~\u0000 sq\u0000~\u0000\u0000ppsq\u0000"
...
+"XMLSchema-instanceq\u0000~\u0000\u001bsq\u0000~\u0000\u001ct\u0000\u0015TC1025TypeDeclarationt\u0000 http"
...
+"q\u0000~\u0000\u0010q\u0000~\u0000%q\u0000~\u0000#q\u0000~\u0000*q\u0000~\u0000\u000bq\u0000~\u0000\bx"));
        ...
        extends ru.runa.xpdl.generated.bpmnxpdl.impl.runtime.AbstractUnmarshallingEventHandlerImpl
    {
        ...
        public java.lang.Object owner() {
            return ru.runa.xpdl.generated.bpmnxpdl.impl.TC1025TypeDeclarationsTypeImpl.this;
        }
                ...
                switch (state) {
                    case  0 :
                        if (("TC1025TypeDeclaration" == ___local)&&("http://www.wfmc.org/2002/XPDL1.0" == ___uri)) {
                            _getTC1025TypeDeclaration().add(((ru.runa.xpdl.generated.bpmnxpdl.impl.TC1025TypeDeclarationImpl) spawnChildFromEnterElement((ru.runa.xpdl.generated.bpmnxpdl.impl.TC1025TypeDeclarationImpl.class), 3, ___uri, ___local, ___qname, __atts)));
                            return ;
                        }
                        if (("TC1025TypeDeclaration" == ___local)&&("http://www.wfmc.org/2002/XPDL1.0" == ___uri)) {
                ...
                switch (state) {
                    ...
                    case  1 :
                        if (("Id" == ___local)&&("" == ___uri)) {
                            _getTC1025TypeDeclaration().add(((ru.runa.xpdl.generated.bpmnxpdl.impl.TC1025TypeDeclarationTypeImpl) spawnChildFromEnterAttribute((ru.runa.xpdl.generated.bpmnxpdl.impl.TC1025TypeDeclarationTypeImpl.class), 2, ___uri, ___local, ___qname)));
                            return ;
                        }
                        break;
                    case  3 :
