...
public class EndStateTypeImpl implements ru.runa.xpdl.generated.jpdl32.EndStateType, com.sun.xml.bind.JAXBObject, ru.runa.xpdl.generated.jpdl32.impl.runtime.UnmarshallableObject, ru.runa.xpdl.generated.jpdl32.impl.runtime.XMLSerializable, ru.runa.xpdl.generated.jpdl32.impl.runtime.ValidatableObject
{
    ...
    private final static java.lang.Class PRIMARY_INTERFACE_CLASS() {
        return (ru.runa.xpdl.generated.jpdl32.EndStateType.class);
    }
    ...
    public ru.runa.xpdl.generated.jpdl32.impl.runtime.UnmarshallingEventHandler createUnmarshaller(ru.runa.xpdl.generated.jpdl32.impl.runtime.UnmarshallingContext context) {
        return new ru.runa.xpdl.generated.jpdl32.impl.EndStateTypeImpl.Unmarshaller(context);
    }
    ...
    {
        int idx2 = 0;
        final int len2 = ((_DescriptionOrEventOrExceptionHandler == null)? 0 :_DescriptionOrEventOrExceptionHandler.size());
        while (idx2 != len2) {
            context.childAsBody(((com.sun.xml.bind.JAXBObject) _DescriptionOrEventOrExceptionHandler.get(idx2 ++)), "DescriptionOrEventOrExceptionHandler");
        }
    }
        ...
        throws org.xml.sax.SAXException
    {
        ...
        while (idx2 != len2) {
            context.childAsAttributes(((com.sun.xml.bind.JAXBObject) _DescriptionOrEventOrExceptionHandler.get(idx2 ++)), "DescriptionOrEventOrExceptionHandler");
        }
    }
        ...
        throws org.xml.sax.SAXException
    {
        ...
        final int len2 = ((_DescriptionOrEventOrExceptionHandler == null)? 0 :_DescriptionOrEventOrExceptionHandler.size());
        while (idx2 != len2) {
            context.childAsURIs(((com.sun.xml.bind.JAXBObject) _DescriptionOrEventOrExceptionHandler.get(idx2 ++)), "DescriptionOrEventOrExceptionHandler");
        }
    }
...
+"\u0006q\u0000~\u0000\fpsr\u0000\'com.sun.msv.grammar.trex.ElementPattern\u0000\u0000\u0000\u0000\u0000\u0000\u0000\u0001\u0002\u0000"
+"\u0001L\u0000\tnameClasst\u0000\u001fLcom/sun/msv/grammar/NameClass;xr\u0000\u001ecom.sun.m"
+"sv.grammar.ElementExp\u0000\u0000\u0000\u0000\u0000\u0000\u0000\u0001\u0002\u0000\u0002Z\u0000\u001aignoreUndeclaredAttribute"
+"sL\u0000\fcontentModelq\u0000~\u0000\u0002xq\u0000~\u0000\u0003q\u0000~\u0000\fp\u0000sq\u0000~\u0000\u0006ppsq\u0000~\u0000\bq\u0000~\u0000\fpsr\u0000 co"
+"m.sun.msv.grammar.AttributeExp\u0000\u0000\u0000\u0000\u0000\u0000\u0000\u0001\u0002\u0000\u0002L\u0000\u0003expq\u0000~\u0000\u0002L\u0000\tnameC"
+"lassq\u0000~\u0000\u0010xq\u0000~\u0000\u0003q\u0000~\u0000\fpsr\u00002com.sun.msv.grammar.Expression$AnyS"
+"tringExpression\u0000\u0000\u0000\u0000\u0000\u0000\u0000\u0001\u0002\u0000\u0000xq\u0000~\u0000\u0003sq\u0000~\u0000\u000b\u0001psr\u0000 com.sun.msv.gram"
...
+"aceURIq\u0000~\u0000 xq\u0000~\u0000\u001bt\u0000\u001cgenerated.jpdl32.Descriptiont\u0000+http://ja"
+"va.sun.com/jaxb/xjc/dummy-elementssq\u0000~\u0000\u000fq\u0000~\u0000\fp\u0000sq\u0000~\u0000\u0006ppsq\u0000~\u0000"
+"\bq\u0000~\u0000\fpsq\u0000~\u0000\u0015q\u0000~\u0000\fpq\u0000~\u0000\u0018q\u0000~\u0000\u001cq\u0000~\u0000\u001esq\u0000~\u0000\u001ft\u0000\u0016generated.jpdl32."
+"Eventq\u0000~\u0000#sq\u0000~\u0000\u000fq\u0000~\u0000\fp\u0000sq\u0000~\u0000\u0006ppsq\u0000~\u0000\bq\u0000~\u0000\fpsq\u0000~\u0000\u0015q\u0000~\u0000\fpq\u0000~\u0000\u0018"
+"q\u0000~\u0000\u001cq\u0000~\u0000\u001esq\u0000~\u0000\u001ft\u0000!ru.runa.xpdl.generated.jpdl32.ExceptionHandlerq\u0000~\u0000#q\u0000~"
...
+"ocalNameq\u0000~\u0000 L\u0000\fnamespaceURIq\u0000~\u0000 xpq\u0000~\u0000<q\u0000~\u0000;sq\u0000~\u0000\u001ft\u0000\u0004namet\u0000"
...
+"~\u0000\nq\u0000~\u0000\rx"));
        ...
        extends ru.runa.xpdl.generated.jpdl32.impl.runtime.AbstractUnmarshallingEventHandlerImpl
    {
        ...
        public java.lang.Object owner() {
            return ru.runa.xpdl.generated.jpdl32.impl.EndStateTypeImpl.this;
        }
                ...
                switch (state) {
                    case  3 :
                        if (("description" == ___local)&&("urn:jbpm.org:jpdl-3.2" == ___uri)) {
                            _getDescriptionOrEventOrExceptionHandler().add(((ru.runa.xpdl.generated.jpdl32.impl.DescriptionImpl) spawnChildFromEnterElement((ru.runa.xpdl.generated.jpdl32.impl.DescriptionImpl.class), 4, ___uri, ___local, ___qname, __atts)));
                            return ;
                        }
                        if (("event" == ___local)&&("urn:jbpm.org:jpdl-3.2" == ___uri)) {
                            _getDescriptionOrEventOrExceptionHandler().add(((ru.runa.xpdl.generated.jpdl32.impl.EventImpl) spawnChildFromEnterElement((ru.runa.xpdl.generated.jpdl32.impl.EventImpl.class), 4, ___uri, ___local, ___qname, __atts)));
                            return ;
                        }
                        if (("exception-handler" == ___local)&&("urn:jbpm.org:jpdl-3.2" == ___uri)) {
                            _getDescriptionOrEventOrExceptionHandler().add(((ru.runa.xpdl.generated.jpdl32.impl.ExceptionHandlerImpl) spawnChildFromEnterElement((ru.runa.xpdl.generated.jpdl32.impl.ExceptionHandlerImpl.class), 4, ___uri, ___local, ___qname, __atts)));
                            return ;
                        }
                        state = 4;
                        continue outer;
