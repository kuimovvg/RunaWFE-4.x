...
public class TC1025TransitionsTypeImpl implements ru.runa.xpdl.generated.bpmnxpdl.TC1025TransitionsType, com.sun.xml.bind.JAXBObject, ru.runa.xpdl.generated.bpmnxpdl.impl.runtime.UnmarshallableObject, ru.runa.xpdl.generated.bpmnxpdl.impl.runtime.XMLSerializable, ru.runa.xpdl.generated.bpmnxpdl.impl.runtime.ValidatableObject
{

    protected com.sun.xml.bind.util.ListImpl _TC1025Transition;
    ...
    private final static java.lang.Class PRIMARY_INTERFACE_CLASS() {
        return (ru.runa.xpdl.generated.bpmnxpdl.TC1025TransitionsType.class);
    }

    protected com.sun.xml.bind.util.ListImpl _getTC1025Transition() {
        if (_TC1025Transition == null) {
            _TC1025Transition = new com.sun.xml.bind.util.ListImpl(new java.util.ArrayList());
        }
        return _TC1025Transition;
    }

    public java.util.List getTC1025Transition() {
        return _getTC1025Transition();
    }
    ...
    public ru.runa.xpdl.generated.bpmnxpdl.impl.runtime.UnmarshallingEventHandler createUnmarshaller(ru.runa.xpdl.generated.bpmnxpdl.impl.runtime.UnmarshallingContext context) {
        return new ru.runa.xpdl.generated.bpmnxpdl.impl.TC1025TransitionsTypeImpl.Unmarshaller(context);
    }
    ...
    {
        int idx1 = 0;
        final int len1 = ((_TC1025Transition == null)? 0 :_TC1025Transition.size());
        while (idx1 != len1) {
            if (_TC1025Transition.get(idx1) instanceof javax.xml.bind.Element) {
                context.childAsBody(((com.sun.xml.bind.JAXBObject) _TC1025Transition.get(idx1 ++)), "TC1025Transition");
            } else {
                context.startElement("http://www.wfmc.org/2002/XPDL1.0", "TC1025Transition");
                int idx_0 = idx1;
                context.childAsURIs(((com.sun.xml.bind.JAXBObject) _TC1025Transition.get(idx_0 ++)), "TC1025Transition");
                context.endNamespaceDecls();
                int idx_1 = idx1;
                context.childAsAttributes(((com.sun.xml.bind.JAXBObject) _TC1025Transition.get(idx_1 ++)), "TC1025Transition");
        ...
        throws org.xml.sax.SAXException
    {
        ...
        while (idx1 != len1) {
            if (_TC1025Transition.get(idx1) instanceof javax.xml.bind.Element) {
                context.childAsAttributes(((com.sun.xml.bind.JAXBObject) _TC1025Transition.get(idx1 ++)), "TC1025Transition");
            } else {
                idx1 += 1;
            }
        }
        ...
        throws org.xml.sax.SAXException
    {
        ...
        while (idx1 != len1) {
            if (_TC1025Transition.get(idx1) instanceof javax.xml.bind.Element) {
                context.childAsURIs(((com.sun.xml.bind.JAXBObject) _TC1025Transition.get(idx1 ++)), "TC1025Transition");
            } else {
                idx1 += 1;
            }
        }
...
+"spaceURIq\u0000~\u0000\u001dxq\u0000~\u0000\u0018t\u0000#ru.runa.xpdl.generated.bpmnxpdl.TC1025Transitiont\u0000+"
+"http://java.sun.com/jaxb/xjc/dummy-elementssq\u0000~\u0000\fq\u0000~\u0000\np\u0000sr\u0000\u001f"
+"com.sun.msv.grammar.SequenceExp\u0000\u0000\u0000\u0000\u0000\u0000\u0000\u0001\u0002\u0000\u0000xq\u0000~\u0000\u0001ppsq\u0000~\u0000\fpp\u0000s"
+"q\u0000~\u0000\u0000ppsq\u0000~\u0000\u0006q\u0000~\u0000\npsq\u0000~\u0000\u0012q\u0000~\u0000\npq\u0000~\u0000\u0015q\u0000~\u0000\u0019q\u0000~\u0000\u001bsq\u0000~\u0000\u001ct\u0000\'gener"
+"ated.bpmnxpdl.TC1025TransitionTypeq\u0000~\u0000 sq\u0000~\u0000\u0000ppsq\u0000~\u0000\u0012q\u0000~\u0000\nps"
...
+"NullSetExpression\u0000\u0000\u0000\u0000\u0000\u0000\u0000\u0001\u0002\u0000\u0000xq\u0000~\u0000\u0003q\u0000~\u0000\npsr\u0000\u001bcom.sun.msv.util"
+".StringPair\u00d0t\u001ejB\u008f\u008d\u00a0\u0002\u0000\u0002L\u0000\tlocalNameq\u0000~\u0000\u001dL\u0000\fnamespaceURIq\u0000~\u0000\u001dx"
+"pq\u0000~\u00007q\u0000~\u00006sq\u0000~\u0000\u001ct\u0000\u0004typet\u0000)http://www.w3.org/2001/XMLSchema-"
+"instanceq\u0000~\u0000\u001bsq\u0000~\u0000\u001ct\u0000\u0010TC1025Transitiont\u0000 http://www.wfmc.org"
+"/2002/XPDL1.0q\u0000~\u0000\u001bsr\u0000\"com.sun.msv.grammar.ExpressionPool\u0000\u0000\u0000\u0000"
...
+"q\u0000~\u0000*q\u0000~\u0000\u000bq\u0000~\u0000\bx"));
        ...
        extends ru.runa.xpdl.generated.bpmnxpdl.impl.runtime.AbstractUnmarshallingEventHandlerImpl
    {
        ...
        public java.lang.Object owner() {
            return ru.runa.xpdl.generated.bpmnxpdl.impl.TC1025TransitionsTypeImpl.this;
        }
                ...
                switch (state) {
                    case  0 :
                        if (("TC1025Transition" == ___local)&&("http://www.wfmc.org/2002/XPDL1.0" == ___uri)) {
                            _getTC1025Transition().add(((ru.runa.xpdl.generated.bpmnxpdl.impl.TC1025TransitionImpl) spawnChildFromEnterElement((ru.runa.xpdl.generated.bpmnxpdl.impl.TC1025TransitionImpl.class), 1, ___uri, ___local, ___qname, __atts)));
                            return ;
                        }
                        if (("TC1025Transition" == ___local)&&("http://www.wfmc.org/2002/XPDL1.0" == ___uri)) {
                ...
                switch (state) {
                    ...
                    case  2 :
                        if (("From" == ___local)&&("" == ___uri)) {
                            _getTC1025Transition().add(((ru.runa.xpdl.generated.bpmnxpdl.impl.TC1025TransitionTypeImpl) spawnChildFromEnterAttribute((ru.runa.xpdl.generated.bpmnxpdl.impl.TC1025TransitionTypeImpl.class), 3, ___uri, ___local, ___qname)));
                            return ;
                        }
                        break;
                    case  1 :
