...
public class SchemaTypeImpl
    extends ru.runa.xpdl.generated.bpmnxpdl.impl.SchemaTypeTypeImpl
    implements ru.runa.xpdl.generated.bpmnxpdl.SchemaType, com.sun.xml.bind.RIElement, com.sun.xml.bind.JAXBObject, ru.runa.xpdl.generated.bpmnxpdl.impl.runtime.UnmarshallableObject, ru.runa.xpdl.generated.bpmnxpdl.impl.runtime.XMLSerializable, ru.runa.xpdl.generated.bpmnxpdl.impl.runtime.ValidatableObject
{
    ...
    private final static java.lang.Class PRIMARY_INTERFACE_CLASS() {
        return (ru.runa.xpdl.generated.bpmnxpdl.SchemaType.class);
    }
    ...
    public ru.runa.xpdl.generated.bpmnxpdl.impl.runtime.UnmarshallingEventHandler createUnmarshaller(ru.runa.xpdl.generated.bpmnxpdl.impl.runtime.UnmarshallingContext context) {
        return new ru.runa.xpdl.generated.bpmnxpdl.impl.SchemaTypeImpl.Unmarshaller(context);
    }
...
+"\u0000\u001et\u0000 http://www.wfmc.org/2008/XPDL2.1sq\u0000~\u0000\u001et\u0000+http://java.su"
...
+"hemaTypeq\u0000~\u0000#sr\u0000\"com.sun.msv.grammar.ExpressionPool\u0000\u0000\u0000\u0000\u0000\u0000\u0000\u0001\u0002"
...
+"r/ExpressionPool;xp\u0000\u0000\u0000\u0004\u0001pq\u0000~\u0000\u000eq\u0000~\u0000\u000bq\u0000~\u0000\tq\u0000~\u0000(x"));
        ...
        extends ru.runa.xpdl.generated.bpmnxpdl.impl.runtime.AbstractUnmarshallingEventHandlerImpl
    {
        ...
        public java.lang.Object owner() {
            return ru.runa.xpdl.generated.bpmnxpdl.impl.SchemaTypeImpl.this;
        }
                ...
                switch (state) {
                    ...
                    case  1 :
                        if (!(("" == ___uri)||("http://www.wfmc.org/2008/XPDL2.1" == ___uri))) {
                            spawnHandlerFromEnterElement((((ru.runa.xpdl.generated.bpmnxpdl.impl.SchemaTypeTypeImpl) ru.runa.xpdl.generated.bpmnxpdl.impl.SchemaTypeImpl.this).new Unmarshaller(context)), 2, ___uri, ___local, ___qname, __atts);
                            return ;
                        }
                        spawnHandlerFromEnterElement((((ru.runa.xpdl.generated.bpmnxpdl.impl.SchemaTypeTypeImpl) ru.runa.xpdl.generated.bpmnxpdl.impl.SchemaTypeImpl.this).new Unmarshaller(context)), 2, ___uri, ___local, ___qname, __atts);
                        return ;
            ...
            while (true) {
                switch (state) {
                    ...
                    case  2 :
                        ...
                        break;
                    case  1 :
                        spawnHandlerFromLeaveElement((((ru.runa.xpdl.generated.bpmnxpdl.impl.SchemaTypeTypeImpl) ru.runa.xpdl.generated.bpmnxpdl.impl.SchemaTypeImpl.this).new Unmarshaller(context)), 2, ___uri, ___local, ___qname);
                        return ;
                }
            ...
            while (true) {
                switch (state) {
                    case  3 :
                        ...
                        return ;
                    case  1 :
                        spawnHandlerFromEnterAttribute((((ru.runa.xpdl.generated.bpmnxpdl.impl.SchemaTypeTypeImpl) ru.runa.xpdl.generated.bpmnxpdl.impl.SchemaTypeImpl.this).new Unmarshaller(context)), 2, ___uri, ___local, ___qname);
                        return ;
                }
            ...
            while (true) {
                switch (state) {
                    case  3 :
                        ...
                        return ;
                    case  1 :
                        spawnHandlerFromLeaveAttribute((((ru.runa.xpdl.generated.bpmnxpdl.impl.SchemaTypeTypeImpl) ru.runa.xpdl.generated.bpmnxpdl.impl.SchemaTypeImpl.this).new Unmarshaller(context)), 2, ___uri, ___local, ___qname);
                        return ;
                }
                ...
                try {
                    switch (state) {
                        case  3 :
                            ...
                            return ;
                        case  1 :
                            spawnHandlerFromText((((ru.runa.xpdl.generated.bpmnxpdl.impl.SchemaTypeTypeImpl) ru.runa.xpdl.generated.bpmnxpdl.impl.SchemaTypeImpl.this).new Unmarshaller(context)), 2, value);
                            return ;
                    }
