...
public class AutomaticImpl
    extends ru.runa.xpdl.generated.bpmnxpdl.impl.AutomaticTypeImpl
    implements ru.runa.xpdl.generated.bpmnxpdl.Automatic, com.sun.xml.bind.RIElement, com.sun.xml.bind.JAXBObject, ru.runa.xpdl.generated.bpmnxpdl.impl.runtime.UnmarshallableObject, ru.runa.xpdl.generated.bpmnxpdl.impl.runtime.XMLSerializable, ru.runa.xpdl.generated.bpmnxpdl.impl.runtime.ValidatableObject
{
    ...
    private final static java.lang.Class PRIMARY_INTERFACE_CLASS() {
        return (ru.runa.xpdl.generated.bpmnxpdl.Automatic.class);
    }
    ...
    public ru.runa.xpdl.generated.bpmnxpdl.impl.runtime.UnmarshallingEventHandler createUnmarshaller(ru.runa.xpdl.generated.bpmnxpdl.impl.runtime.UnmarshallingContext context) {
        return new ru.runa.xpdl.generated.bpmnxpdl.impl.AutomaticImpl.Unmarshaller(context);
    }
...
+"Expression\u0000\u0000\u0000\u0000\u0000\u0000\u0000\u0001\u0002\u0000\u0000xq\u0000~\u0000\u0004sq\u0000~\u0000\f\u0001q\u0000~\u0000(sq\u0000~\u0000\"t\u0000\tAutomatict\u0000 "
+"http://www.wfmc.org/2002/XPDL1.0sr\u0000\"com.sun.msv.grammar.Expr"
...
+"Lcom/sun/msv/grammar/ExpressionPool;xp\u0000\u0000\u0000\u0001\u0001pq\u0000~\u0000\tx"));
        ...
        extends ru.runa.xpdl.generated.bpmnxpdl.impl.runtime.AbstractUnmarshallingEventHandlerImpl
    {
        ...
        public java.lang.Object owner() {
            return ru.runa.xpdl.generated.bpmnxpdl.impl.AutomaticImpl.this;
        }
            ...
            while (true) {
                switch (state) {
                    ...
                    case  0 :
                        ...
                        break;
                    case  1 :
                        spawnHandlerFromEnterElement((((ru.runa.xpdl.generated.bpmnxpdl.impl.AutomaticTypeImpl) ru.runa.xpdl.generated.bpmnxpdl.impl.AutomaticImpl.this).new Unmarshaller(context)), 2, ___uri, ___local, ___qname, __atts);
                        return ;
                }
            ...
            while (true) {
                switch (state) {
                    case  3 :
                        ...
                        return ;
                    case  1 :
                        spawnHandlerFromLeaveElement((((ru.runa.xpdl.generated.bpmnxpdl.impl.AutomaticTypeImpl) ru.runa.xpdl.generated.bpmnxpdl.impl.AutomaticImpl.this).new Unmarshaller(context)), 2, ___uri, ___local, ___qname);
                        return ;
                    case  2 :
                        if (("Automatic" == ___local)&&("http://www.wfmc.org/2002/XPDL1.0" == ___uri)) {
            ...
            while (true) {
                switch (state) {
                    case  3 :
                        ...
                        return ;
                    case  1 :
                        spawnHandlerFromEnterAttribute((((ru.runa.xpdl.generated.bpmnxpdl.impl.AutomaticTypeImpl) ru.runa.xpdl.generated.bpmnxpdl.impl.AutomaticImpl.this).new Unmarshaller(context)), 2, ___uri, ___local, ___qname);
                        return ;
                }
            ...
            while (true) {
                switch (state) {
                    case  3 :
                        ...
                        return ;
                    case  1 :
                        spawnHandlerFromLeaveAttribute((((ru.runa.xpdl.generated.bpmnxpdl.impl.AutomaticTypeImpl) ru.runa.xpdl.generated.bpmnxpdl.impl.AutomaticImpl.this).new Unmarshaller(context)), 2, ___uri, ___local, ___qname);
                        return ;
                }
                ...
                try {
                    switch (state) {
                        case  3 :
                            ...
                            return ;
                        case  1 :
                            spawnHandlerFromText((((ru.runa.xpdl.generated.bpmnxpdl.impl.AutomaticTypeImpl) ru.runa.xpdl.generated.bpmnxpdl.impl.AutomaticImpl.this).new Unmarshaller(context)), 2, value);
                            return ;
                    }
