...
public class VendorExtensionsTypeImpl implements ru.runa.xpdl.generated.bpmnxpdl.VendorExtensionsType, com.sun.xml.bind.JAXBObject, ru.runa.xpdl.generated.bpmnxpdl.impl.runtime.UnmarshallableObject, ru.runa.xpdl.generated.bpmnxpdl.impl.runtime.XMLSerializable, ru.runa.xpdl.generated.bpmnxpdl.impl.runtime.ValidatableObject
{

    protected com.sun.xml.bind.util.ListImpl _Any;
    protected com.sun.xml.bind.util.ListImpl _VendorExtension;
    ...
    private final static java.lang.Class PRIMARY_INTERFACE_CLASS() {
        return (ru.runa.xpdl.generated.bpmnxpdl.VendorExtensionsType.class);
    }
    ...
    protected com.sun.xml.bind.util.ListImpl _getVendorExtension() {
        if (_VendorExtension == null) {
            _VendorExtension = new com.sun.xml.bind.util.ListImpl(new java.util.ArrayList());
        }
        return _VendorExtension;
    }

    public java.util.List getVendorExtension() {
        return _getVendorExtension();
    }
    ...
    public ru.runa.xpdl.generated.bpmnxpdl.impl.runtime.UnmarshallingEventHandler createUnmarshaller(ru.runa.xpdl.generated.bpmnxpdl.impl.runtime.UnmarshallingContext context) {
        return new ru.runa.xpdl.generated.bpmnxpdl.impl.VendorExtensionsTypeImpl.Unmarshaller(context);
    }
        ...
        throws org.xml.sax.SAXException
    {
        ...
        int idx2 = 0;
        final int len2 = ((_VendorExtension == null)? 0 :_VendorExtension.size());
        while (idx2 != len2) {
            if (_VendorExtension.get(idx2) instanceof javax.xml.bind.Element) {
                context.childAsBody(((com.sun.xml.bind.JAXBObject) _VendorExtension.get(idx2 ++)), "VendorExtension");
            } else {
                context.startElement("http://www.wfmc.org/2008/XPDL2.1", "VendorExtension");
                int idx_0 = idx2;
                context.childAsURIs(((com.sun.xml.bind.JAXBObject) _VendorExtension.get(idx_0 ++)), "VendorExtension");
                context.endNamespaceDecls();
                int idx_1 = idx2;
                context.childAsAttributes(((com.sun.xml.bind.JAXBObject) _VendorExtension.get(idx_1 ++)), "VendorExtension");
        ...
        throws org.xml.sax.SAXException
    {
        ...
        while (idx2 != len2) {
            if (_VendorExtension.get(idx2) instanceof javax.xml.bind.Element) {
                context.childAsAttributes(((com.sun.xml.bind.JAXBObject) _VendorExtension.get(idx2 ++)), "VendorExtension");
            } else {
                idx2 += 1;
            }
        }
        ...
        throws org.xml.sax.SAXException
    {
        ...
        while (idx2 != len2) {
            if (_VendorExtension.get(idx2) instanceof javax.xml.bind.Element) {
                context.childAsURIs(((com.sun.xml.bind.JAXBObject) _VendorExtension.get(idx2 ++)), "VendorExtension");
            } else {
                idx2 += 1;
            }
        }
...
+"RIq\u0000~\u0000\u001fxq\u0000~\u0000\u001at\u0000\"ru.runa.xpdl.generated.bpmnxpdl.VendorExtensiont\u0000+http://"
+"java.sun.com/jaxb/xjc/dummy-elementssq\u0000~\u0000\u000eq\u0000~\u0000\fp\u0000sq\u0000~\u0000\u0000ppsq\u0000"
+"~\u0000\u000epp\u0000sq\u0000~\u0000\u0006ppsq\u0000~\u0000\bq\u0000~\u0000\fpsq\u0000~\u0000\u0014q\u0000~\u0000\fpq\u0000~\u0000\u0017q\u0000~\u0000\u001bq\u0000~\u0000\u001dsq\u0000~\u0000\u001et"
+"\u0000&ru.runa.xpdl.generated.bpmnxpdl.VendorExtensionTypeq\u0000~\u0000\"sq\u0000~\u0000\u0006ppsq\u0000~\u0000\u0014q"
...
+"chema-instanceq\u0000~\u0000\u001dsq\u0000~\u0000\u001et\u0000\u000fVendorExtensiont\u0000 http://www.wfm"
...
+"q\u0000~\u0000\'q\u0000~\u0000\u0005q\u0000~\u0000\u0007q\u0000~\u0000\u0012q\u0000~\u0000&q\u0000~\u0000$q\u0000~\u0000Fq\u0000~\u0000Gq\u0000~\u0000+q\u0000~\u0000\rq\u0000~\u0000\nx"));
        ...
        extends ru.runa.xpdl.generated.bpmnxpdl.impl.runtime.AbstractUnmarshallingEventHandlerImpl
    {
        ...
        public java.lang.Object owner() {
            return ru.runa.xpdl.generated.bpmnxpdl.impl.VendorExtensionsTypeImpl.this;
        }
                ...
                switch (state) {
                    case  3 :
                        if (("VendorExtension" == ___local)&&("http://www.wfmc.org/2008/XPDL2.1" == ___uri)) {
                            _getVendorExtension().add(((ru.runa.xpdl.generated.bpmnxpdl.impl.VendorExtensionImpl) spawnChildFromEnterElement((ru.runa.xpdl.generated.bpmnxpdl.impl.VendorExtensionImpl.class), 3, ___uri, ___local, ___qname, __atts)));
                            return ;
                        }
                        if (("VendorExtension" == ___local)&&("http://www.wfmc.org/2008/XPDL2.1" == ___uri)) {
                ...
                switch (state) {
                    ...
                    case  1 :
                        if (("ToolId" == ___local)&&("" == ___uri)) {
                            _getVendorExtension().add(((ru.runa.xpdl.generated.bpmnxpdl.impl.VendorExtensionTypeImpl) spawnChildFromEnterAttribute((ru.runa.xpdl.generated.bpmnxpdl.impl.VendorExtensionTypeImpl.class), 2, ___uri, ___local, ___qname)));
                            return ;
                        }
                        break;
                    case  0 :
