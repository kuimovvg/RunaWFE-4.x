...
public class DataMappingsTypeImpl implements ru.runa.xpdl.generated.bpmnxpdl.DataMappingsType, com.sun.xml.bind.JAXBObject, ru.runa.xpdl.generated.bpmnxpdl.impl.runtime.UnmarshallableObject, ru.runa.xpdl.generated.bpmnxpdl.impl.runtime.XMLSerializable, ru.runa.xpdl.generated.bpmnxpdl.impl.runtime.ValidatableObject
{

    protected com.sun.xml.bind.util.ListImpl _Any;
    protected com.sun.xml.bind.util.ListImpl _DataMapping;
    ...
    private final static java.lang.Class PRIMARY_INTERFACE_CLASS() {
        return (ru.runa.xpdl.generated.bpmnxpdl.DataMappingsType.class);
    }
    ...
    protected com.sun.xml.bind.util.ListImpl _getDataMapping() {
        if (_DataMapping == null) {
            _DataMapping = new com.sun.xml.bind.util.ListImpl(new java.util.ArrayList());
        }
        return _DataMapping;
    }

    public java.util.List getDataMapping() {
        return _getDataMapping();
    }
    ...
    public ru.runa.xpdl.generated.bpmnxpdl.impl.runtime.UnmarshallingEventHandler createUnmarshaller(ru.runa.xpdl.generated.bpmnxpdl.impl.runtime.UnmarshallingContext context) {
        return new ru.runa.xpdl.generated.bpmnxpdl.impl.DataMappingsTypeImpl.Unmarshaller(context);
    }
        ...
        throws org.xml.sax.SAXException
    {
        ...
        int idx2 = 0;
        final int len2 = ((_DataMapping == null)? 0 :_DataMapping.size());
        while (idx2 != len2) {
            if (_DataMapping.get(idx2) instanceof javax.xml.bind.Element) {
                context.childAsBody(((com.sun.xml.bind.JAXBObject) _DataMapping.get(idx2 ++)), "DataMapping");
            } else {
                context.startElement("http://www.wfmc.org/2008/XPDL2.1", "DataMapping");
                int idx_0 = idx2;
                context.childAsURIs(((com.sun.xml.bind.JAXBObject) _DataMapping.get(idx_0 ++)), "DataMapping");
                context.endNamespaceDecls();
                int idx_1 = idx2;
                context.childAsAttributes(((com.sun.xml.bind.JAXBObject) _DataMapping.get(idx_1 ++)), "DataMapping");
        ...
        throws org.xml.sax.SAXException
    {
        ...
        while (idx2 != len2) {
            if (_DataMapping.get(idx2) instanceof javax.xml.bind.Element) {
                context.childAsAttributes(((com.sun.xml.bind.JAXBObject) _DataMapping.get(idx2 ++)), "DataMapping");
            } else {
                idx2 += 1;
            }
        }
        ...
        throws org.xml.sax.SAXException
    {
        ...
        while (idx2 != len2) {
            if (_DataMapping.get(idx2) instanceof javax.xml.bind.Element) {
                context.childAsURIs(((com.sun.xml.bind.JAXBObject) _DataMapping.get(idx2 ++)), "DataMapping");
            } else {
                idx2 += 1;
            }
        }
...
+"RIq\u0000~\u0000\u001fxq\u0000~\u0000\u001at\u0000\u001egenerated.bpmnxpdl.DataMappingt\u0000+http://java"
+".sun.com/jaxb/xjc/dummy-elementssq\u0000~\u0000\u000eq\u0000~\u0000\fp\u0000sq\u0000~\u0000\u0000ppsq\u0000~\u0000\u000ep"
+"p\u0000sq\u0000~\u0000\u0006ppsq\u0000~\u0000\bq\u0000~\u0000\fpsq\u0000~\u0000\u0014q\u0000~\u0000\fpq\u0000~\u0000\u0017q\u0000~\u0000\u001bq\u0000~\u0000\u001dsq\u0000~\u0000\u001et\u0000\"ge"
+"nerated.bpmnxpdl.DataMappingTypeq\u0000~\u0000\"sq\u0000~\u0000\u0006ppsq\u0000~\u0000\u0014q\u0000~\u0000\fpsr\u0000"
...
+"stanceq\u0000~\u0000\u001dsq\u0000~\u0000\u001et\u0000\u000bDataMappingt\u0000 http://www.wfmc.org/2008/X"
+"PDL2.1q\u0000~\u0000\u001dsq\u0000~\u0000\u0006ppsq\u0000~\u0000\bq\u0000~\u0000\fpsq\u0000~\u0000\u000eq\u0000~\u0000\fp\u0000sq\u0000~\u0000\u0014ppq\u0000~\u0000\u0017sr\u0000"
...
+"\u001at\u0000\u0000sq\u0000~\u0000Nq\u0000~\u0000Esq\u0000~\u0000Nq\u0000~\u0000\"q\u0000~\u0000\u001dsr\u0000\"com.sun.msv.grammar.Expre"
...
+"com/sun/msv/grammar/ExpressionPool;xp\u0000\u0000\u0000\f\u0001pq\u0000~\u0000\u0013q\u0000~\u0000\'q\u0000~\u0000\u0005q\u0000"
+"~\u0000\u0007q\u0000~\u0000\u0012q\u0000~\u0000&q\u0000~\u0000$q\u0000~\u0000Gq\u0000~\u0000+q\u0000~\u0000\rq\u0000~\u0000Fq\u0000~\u0000\nx"));
        }
        ...
        extends ru.runa.xpdl.generated.bpmnxpdl.impl.runtime.AbstractUnmarshallingEventHandlerImpl
    {
        ...
        public java.lang.Object owner() {
            return ru.runa.xpdl.generated.bpmnxpdl.impl.DataMappingsTypeImpl.this;
        }
                ...
                switch (state) {
                    ...
                    case  0 :
                        if (("DataMapping" == ___local)&&("http://www.wfmc.org/2008/XPDL2.1" == ___uri)) {
                            _getDataMapping().add(((ru.runa.xpdl.generated.bpmnxpdl.impl.DataMappingImpl) spawnChildFromEnterElement((ru.runa.xpdl.generated.bpmnxpdl.impl.DataMappingImpl.class), 3, ___uri, ___local, ___qname, __atts)));
                            return ;
                        }
                        if (("DataMapping" == ___local)&&("http://www.wfmc.org/2008/XPDL2.1" == ___uri)) {
                ...
                switch (state) {
                    ...
                    case  1 :
                        if (("Direction" == ___local)&&("" == ___uri)) {
                            _getDataMapping().add(((ru.runa.xpdl.generated.bpmnxpdl.impl.DataMappingTypeImpl) spawnChildFromEnterAttribute((ru.runa.xpdl.generated.bpmnxpdl.impl.DataMappingTypeImpl.class), 2, ___uri, ___local, ___qname)));
                            return ;
                        }
