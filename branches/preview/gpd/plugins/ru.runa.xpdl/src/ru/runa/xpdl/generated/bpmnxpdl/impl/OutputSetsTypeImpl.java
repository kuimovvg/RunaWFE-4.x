...
public class OutputSetsTypeImpl implements ru.runa.xpdl.generated.bpmnxpdl.OutputSetsType, com.sun.xml.bind.JAXBObject, ru.runa.xpdl.generated.bpmnxpdl.impl.runtime.UnmarshallableObject, ru.runa.xpdl.generated.bpmnxpdl.impl.runtime.XMLSerializable, ru.runa.xpdl.generated.bpmnxpdl.impl.runtime.ValidatableObject
{

    protected com.sun.xml.bind.util.ListImpl _Any;
    protected com.sun.xml.bind.util.ListImpl _OutputSet;
    ...
    private final static java.lang.Class PRIMARY_INTERFACE_CLASS() {
        return (ru.runa.xpdl.generated.bpmnxpdl.OutputSetsType.class);
    }
    ...
    protected com.sun.xml.bind.util.ListImpl _getOutputSet() {
        if (_OutputSet == null) {
            _OutputSet = new com.sun.xml.bind.util.ListImpl(new java.util.ArrayList());
        }
        return _OutputSet;
    }

    public java.util.List getOutputSet() {
        return _getOutputSet();
    }
    ...
    public ru.runa.xpdl.generated.bpmnxpdl.impl.runtime.UnmarshallingEventHandler createUnmarshaller(ru.runa.xpdl.generated.bpmnxpdl.impl.runtime.UnmarshallingContext context) {
        return new ru.runa.xpdl.generated.bpmnxpdl.impl.OutputSetsTypeImpl.Unmarshaller(context);
    }
        ...
        throws org.xml.sax.SAXException
    {
        ...
        int idx2 = 0;
        final int len2 = ((_OutputSet == null)? 0 :_OutputSet.size());
        while (idx2 != len2) {
            if (_OutputSet.get(idx2) instanceof javax.xml.bind.Element) {
                context.childAsBody(((com.sun.xml.bind.JAXBObject) _OutputSet.get(idx2 ++)), "OutputSet");
            } else {
                context.startElement("http://www.wfmc.org/2008/XPDL2.1", "OutputSet");
                int idx_0 = idx2;
                context.childAsURIs(((com.sun.xml.bind.JAXBObject) _OutputSet.get(idx_0 ++)), "OutputSet");
                context.endNamespaceDecls();
                int idx_1 = idx2;
                context.childAsAttributes(((com.sun.xml.bind.JAXBObject) _OutputSet.get(idx_1 ++)), "OutputSet");
        ...
        throws org.xml.sax.SAXException
    {
        ...
        while (idx2 != len2) {
            if (_OutputSet.get(idx2) instanceof javax.xml.bind.Element) {
                context.childAsAttributes(((com.sun.xml.bind.JAXBObject) _OutputSet.get(idx2 ++)), "OutputSet");
            } else {
                idx2 += 1;
            }
        }
        ...
        throws org.xml.sax.SAXException
    {
        ...
        while (idx2 != len2) {
            if (_OutputSet.get(idx2) instanceof javax.xml.bind.Element) {
                context.childAsURIs(((com.sun.xml.bind.JAXBObject) _OutputSet.get(idx2 ++)), "OutputSet");
            } else {
                idx2 += 1;
            }
        }
...
+"rated.bpmnxpdl.OutputSett\u0000+http://java.sun.com/jaxb/xjc/dumm"
+"y-elementssq\u0000~\u0000\u000bpp\u0000sq\u0000~\u0000\u0000ppsq\u0000~\u0000\u000bpp\u0000sq\u0000~\u0000\tppsq\u0000~\u0000\u0006q\u0000~\u0000\u0012psq\u0000~"
+"\u0000\u0013q\u0000~\u0000\u0012pq\u0000~\u0000\u0016q\u0000~\u0000\u001aq\u0000~\u0000\u001csq\u0000~\u0000\u001dt\u0000 ru.runa.xpdl.generated.bpmnxpdl.OutputSet"
...
+"p://www.w3.org/2001/XMLSchema-instanceq\u0000~\u0000\u001csq\u0000~\u0000\u001dt\u0000\tOutputSe"
+"tt\u0000 http://www.wfmc.org/2008/XPDL2.1sq\u0000~\u0000\tppsq\u0000~\u0000\u0006q\u0000~\u0000\u0012psq\u0000~"
+"\u0000\u000bq\u0000~\u0000\u0012p\u0000sq\u0000~\u0000\u0013ppq\u0000~\u0000\u0016sr\u0000\'com.sun.msv.grammar.DifferenceName"
+"Class\u0000\u0000\u0000\u0000\u0000\u0000\u0000\u0001\u0002\u0000\u0002L\u0000\u0003nc1q\u0000~\u0000\fL\u0000\u0003nc2q\u0000~\u0000\fxq\u0000~\u0000\u0019q\u0000~\u0000\u001asr\u0000#com.sun"
+".msv.grammar.ChoiceNameClass\u0000\u0000\u0000\u0000\u0000\u0000\u0000\u0001\u0002\u0000\u0002L\u0000\u0003nc1q\u0000~\u0000\fL\u0000\u0003nc2q\u0000~\u0000"
+"\fxq\u0000~\u0000\u0019sr\u0000&com.sun.msv.grammar.NamespaceNameClass\u0000\u0000\u0000\u0000\u0000\u0000\u0000\u0001\u0002\u0000\u0001"
+"L\u0000\fnamespaceURIq\u0000~\u0000\u001exq\u0000~\u0000\u0019t\u0000\u0000sq\u0000~\u0000Mq\u0000~\u0000Dsq\u0000~\u0000Mq\u0000~\u0000!q\u0000~\u0000\u001csr\u0000\""
...
+"~\u0000\bx"));
        ...
        extends ru.runa.xpdl.generated.bpmnxpdl.impl.runtime.AbstractUnmarshallingEventHandlerImpl
    {
        ...
        public java.lang.Object owner() {
            return ru.runa.xpdl.generated.bpmnxpdl.impl.OutputSetsTypeImpl.this;
        }
                ...
                switch (state) {
                    case  1 :
                        if (("OutputSet" == ___local)&&("http://www.wfmc.org/2008/XPDL2.1" == ___uri)) {
                            _getOutputSet().add(((ru.runa.xpdl.generated.bpmnxpdl.impl.OutputSetImpl) spawnChildFromEnterElement((ru.runa.xpdl.generated.bpmnxpdl.impl.OutputSetImpl.class), 1, ___uri, ___local, ___qname, __atts)));
                            return ;
                        }
                        if (("OutputSet" == ___local)&&("http://www.wfmc.org/2008/XPDL2.1" == ___uri)) {
                    ...
                    case  4 :
                        ...
                        return ;
                    case  2 :
                        if (("Output" == ___local)&&("http://www.wfmc.org/2008/XPDL2.1" == ___uri)) {
                            _getOutputSet().add(((ru.runa.xpdl.generated.bpmnxpdl.impl.OutputSetTypeImpl) spawnChildFromEnterElement((ru.runa.xpdl.generated.bpmnxpdl.impl.OutputSetTypeImpl.class), 3, ___uri, ___local, ___qname, __atts)));
                            return ;
                        }
                        if (("Output" == ___local)&&("http://www.wfmc.org/2008/XPDL2.1" == ___uri)) {
                            _getOutputSet().add(((ru.runa.xpdl.generated.bpmnxpdl.impl.OutputSetTypeImpl) spawnChildFromEnterElement((ru.runa.xpdl.generated.bpmnxpdl.impl.OutputSetTypeImpl.class), 3, ___uri, ___local, ___qname, __atts)));
