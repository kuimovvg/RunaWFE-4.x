...
public class NodeGraphicsInfosTypeImpl implements ru.runa.xpdl.generated.bpmnxpdl.NodeGraphicsInfosType, com.sun.xml.bind.JAXBObject, ru.runa.xpdl.generated.bpmnxpdl.impl.runtime.UnmarshallableObject, ru.runa.xpdl.generated.bpmnxpdl.impl.runtime.XMLSerializable, ru.runa.xpdl.generated.bpmnxpdl.impl.runtime.ValidatableObject
{

    protected com.sun.xml.bind.util.ListImpl _Any;
    protected com.sun.xml.bind.util.ListImpl _NodeGraphicsInfo;
    ...
    private final static java.lang.Class PRIMARY_INTERFACE_CLASS() {
        return (ru.runa.xpdl.generated.bpmnxpdl.NodeGraphicsInfosType.class);
    }
    ...
    protected com.sun.xml.bind.util.ListImpl _getNodeGraphicsInfo() {
        if (_NodeGraphicsInfo == null) {
            _NodeGraphicsInfo = new com.sun.xml.bind.util.ListImpl(new java.util.ArrayList());
        }
        return _NodeGraphicsInfo;
    }

    public java.util.List getNodeGraphicsInfo() {
        return _getNodeGraphicsInfo();
    }
    ...
    public ru.runa.xpdl.generated.bpmnxpdl.impl.runtime.UnmarshallingEventHandler createUnmarshaller(ru.runa.xpdl.generated.bpmnxpdl.impl.runtime.UnmarshallingContext context) {
        return new ru.runa.xpdl.generated.bpmnxpdl.impl.NodeGraphicsInfosTypeImpl.Unmarshaller(context);
    }
        ...
        throws org.xml.sax.SAXException
    {
        ...
        int idx2 = 0;
        final int len2 = ((_NodeGraphicsInfo == null)? 0 :_NodeGraphicsInfo.size());
        while (idx2 != len2) {
            if (_NodeGraphicsInfo.get(idx2) instanceof javax.xml.bind.Element) {
                context.childAsBody(((com.sun.xml.bind.JAXBObject) _NodeGraphicsInfo.get(idx2 ++)), "NodeGraphicsInfo");
            } else {
                context.startElement("http://www.wfmc.org/2008/XPDL2.1", "NodeGraphicsInfo");
                int idx_0 = idx2;
                context.childAsURIs(((com.sun.xml.bind.JAXBObject) _NodeGraphicsInfo.get(idx_0 ++)), "NodeGraphicsInfo");
                context.endNamespaceDecls();
                int idx_1 = idx2;
                context.childAsAttributes(((com.sun.xml.bind.JAXBObject) _NodeGraphicsInfo.get(idx_1 ++)), "NodeGraphicsInfo");
        ...
        throws org.xml.sax.SAXException
    {
        ...
        while (idx2 != len2) {
            if (_NodeGraphicsInfo.get(idx2) instanceof javax.xml.bind.Element) {
                context.childAsAttributes(((com.sun.xml.bind.JAXBObject) _NodeGraphicsInfo.get(idx2 ++)), "NodeGraphicsInfo");
            } else {
                idx2 += 1;
            }
        }
        ...
        throws org.xml.sax.SAXException
    {
        ...
        while (idx2 != len2) {
            if (_NodeGraphicsInfo.get(idx2) instanceof javax.xml.bind.Element) {
                context.childAsURIs(((com.sun.xml.bind.JAXBObject) _NodeGraphicsInfo.get(idx2 ++)), "NodeGraphicsInfo");
            } else {
                idx2 += 1;
            }
        }
...
+"RIq\u0000~\u0000\u001fxq\u0000~\u0000\u001at\u0000#ru.runa.xpdl.generated.bpmnxpdl.NodeGraphicsInfot\u0000+http:/"
+"/java.sun.com/jaxb/xjc/dummy-elementssq\u0000~\u0000\u000eq\u0000~\u0000\fp\u0000sq\u0000~\u0000\u0000ppsq"
+"\u0000~\u0000\u000epp\u0000sq\u0000~\u0000\u0006ppsq\u0000~\u0000\bq\u0000~\u0000\fpsq\u0000~\u0000\u0014q\u0000~\u0000\fpq\u0000~\u0000\u0017q\u0000~\u0000\u001bq\u0000~\u0000\u001dsq\u0000~\u0000\u001e"
+"t\u0000\'ru.runa.xpdl.generated.bpmnxpdl.NodeGraphicsInfoTypeq\u0000~\u0000\"sq\u0000~\u0000\u0006ppsq\u0000~\u0000"
...
+"LSchema-instanceq\u0000~\u0000\u001dsq\u0000~\u0000\u001et\u0000\u0010NodeGraphicsInfot\u0000 http://www."
+"wfmc.org/2008/XPDL2.1q\u0000~\u0000\u001dsq\u0000~\u0000\u0006ppsq\u0000~\u0000\bq\u0000~\u0000\fpsq\u0000~\u0000\u000eq\u0000~\u0000\fp\u0000s"
...
+"ceURIq\u0000~\u0000\u001fxq\u0000~\u0000\u001at\u0000\u0000sq\u0000~\u0000Nq\u0000~\u0000Esq\u0000~\u0000Nq\u0000~\u0000\"q\u0000~\u0000\u001dsr\u0000\"com.sun.ms"
...
+"~\u0000\u0013q\u0000~\u0000\'q\u0000~\u0000\u0007q\u0000~\u0000\u0012q\u0000~\u0000&q\u0000~\u0000$q\u0000~\u0000Fq\u0000~\u0000\u0005q\u0000~\u0000+q\u0000~\u0000\rq\u0000~\u0000\nq\u0000~\u0000Gx"));
        ...
        extends ru.runa.xpdl.generated.bpmnxpdl.impl.runtime.AbstractUnmarshallingEventHandlerImpl
    {
        ...
        public java.lang.Object owner() {
            return ru.runa.xpdl.generated.bpmnxpdl.impl.NodeGraphicsInfosTypeImpl.this;
        }
                ...
                switch (state) {
                    case  2 :
                        ...
                        if (("Coordinates" == ___local)&&("http://www.wfmc.org/2008/XPDL2.1" == ___uri)) {
                            _getNodeGraphicsInfo().add(((ru.runa.xpdl.generated.bpmnxpdl.impl.NodeGraphicsInfoTypeImpl) spawnChildFromEnterElement((ru.runa.xpdl.generated.bpmnxpdl.impl.NodeGraphicsInfoTypeImpl.class), 3, ___uri, ___local, ___qname, __atts)));
                            return ;
                        }
                        if (("Coordinates" == ___local)&&("http://www.wfmc.org/2008/XPDL2.1" == ___uri)) {
                            _getNodeGraphicsInfo().add(((ru.runa.xpdl.generated.bpmnxpdl.impl.NodeGraphicsInfoTypeImpl) spawnChildFromEnterElement((ru.runa.xpdl.generated.bpmnxpdl.impl.NodeGraphicsInfoTypeImpl.class), 3, ___uri, ___local, ___qname, __atts)));
                    ...
                    case  1 :
                        if (("NodeGraphicsInfo" == ___local)&&("http://www.wfmc.org/2008/XPDL2.1" == ___uri)) {
                            _getNodeGraphicsInfo().add(((ru.runa.xpdl.generated.bpmnxpdl.impl.NodeGraphicsInfoImpl) spawnChildFromEnterElement((ru.runa.xpdl.generated.bpmnxpdl.impl.NodeGraphicsInfoImpl.class), 1, ___uri, ___local, ___qname, __atts)));
                            return ;
                        }
                        if (("NodeGraphicsInfo" == ___local)&&("http://www.wfmc.org/2008/XPDL2.1" == ___uri)) {
            ...
            while (true) {
                switch (state) {
                    case  2 :
                        ...
                        _getNodeGraphicsInfo().add(((ru.runa.xpdl.generated.bpmnxpdl.impl.NodeGraphicsInfoTypeImpl) spawnChildFromLeaveElement((ru.runa.xpdl.generated.bpmnxpdl.impl.NodeGraphicsInfoTypeImpl.class), 3, ___uri, ___local, ___qname)));
                        return ;
                    case  4 :
                ...
                switch (state) {
                    case  2 :
                        if (("BorderColor" == ___local)&&("" == ___uri)) {
                            _getNodeGraphicsInfo().add(((ru.runa.xpdl.generated.bpmnxpdl.impl.NodeGraphicsInfoTypeImpl) spawnChildFromEnterAttribute((ru.runa.xpdl.generated.bpmnxpdl.impl.NodeGraphicsInfoTypeImpl.class), 3, ___uri, ___local, ___qname)));
                            return ;
                        }
            ...
            while (true) {
                switch (state) {
                    case  2 :
                        ...
                        _getNodeGraphicsInfo().add(((ru.runa.xpdl.generated.bpmnxpdl.impl.NodeGraphicsInfoTypeImpl) spawnChildFromLeaveAttribute((ru.runa.xpdl.generated.bpmnxpdl.impl.NodeGraphicsInfoTypeImpl.class), 3, ___uri, ___local, ___qname)));
                        return ;
                    case  4 :
                ...
                try {
                    switch (state) {
                        case  2 :
                            ...
                            _getNodeGraphicsInfo().add(((ru.runa.xpdl.generated.bpmnxpdl.impl.NodeGraphicsInfoTypeImpl) spawnChildFromText((ru.runa.xpdl.generated.bpmnxpdl.impl.NodeGraphicsInfoTypeImpl.class), 3, value)));
                            return ;
                        case  4 :
