...
public class TransitionsImpl
    extends ru.runa.xpdl.generated.bpmnxpdl.impl.TransitionsTypeImpl
    implements ru.runa.xpdl.generated.bpmnxpdl.Transitions, com.sun.xml.bind.RIElement, com.sun.xml.bind.JAXBObject, ru.runa.xpdl.generated.bpmnxpdl.impl.runtime.UnmarshallableObject, ru.runa.xpdl.generated.bpmnxpdl.impl.runtime.XMLSerializable, ru.runa.xpdl.generated.bpmnxpdl.impl.runtime.ValidatableObject
{
    ...
    private final static java.lang.Class PRIMARY_INTERFACE_CLASS() {
        return (ru.runa.xpdl.generated.bpmnxpdl.Transitions.class);
    }
    ...
    public ru.runa.xpdl.generated.bpmnxpdl.impl.runtime.UnmarshallingEventHandler createUnmarshaller(ru.runa.xpdl.generated.bpmnxpdl.impl.runtime.UnmarshallingContext context) {
        return new ru.runa.xpdl.generated.bpmnxpdl.impl.TransitionsImpl.Unmarshaller(context);
    }
...
+"ing;L\u0000\fnamespaceURIq\u0000~\u0000!xq\u0000~\u0000\u001ct\u0000\u001dgenerated.bpmnxpdl.Transiti"
+"ont\u0000+http://java.sun.com/jaxb/xjc/dummy-elementssq\u0000~\u0000\u0000q\u0000~\u0000\u0011p"
+"\u0000sq\u0000~\u0000\u0007ppsq\u0000~\u0000\u0000pp\u0000sq\u0000~\u0000\u000bppsq\u0000~\u0000\rq\u0000~\u0000\u0011psq\u0000~\u0000\u0016q\u0000~\u0000\u0011pq\u0000~\u0000\u0019q\u0000~\u0000\u001d"
+"q\u0000~\u0000\u001fsq\u0000~\u0000 t\u0000!ru.runa.xpdl.generated.bpmnxpdl.TransitionTypeq\u0000~\u0000$sq\u0000~\u0000\u000bpp"
...
+"\u0000~\u0000\u0011pq\u0000~\u00002q\u0000~\u0000Bq\u0000~\u0000\u001fsq\u0000~\u0000 t\u0000\u000bTransitionsq\u0000~\u0000Gsr\u0000\"com.sun.msv"
...
+"\u0000\u000fq\u0000~\u0000Ix"));
        ...
        extends ru.runa.xpdl.generated.bpmnxpdl.impl.runtime.AbstractUnmarshallingEventHandlerImpl
    {
        ...
        public java.lang.Object owner() {
            return ru.runa.xpdl.generated.bpmnxpdl.impl.TransitionsImpl.this;
        }
                ...
                switch (state) {
                    ...
                    case  1 :
                        if (("Transition" == ___local)&&("http://www.wfmc.org/2008/XPDL2.1" == ___uri)) {
                            spawnHandlerFromEnterElement((((ru.runa.xpdl.generated.bpmnxpdl.impl.TransitionsTypeImpl) ru.runa.xpdl.generated.bpmnxpdl.impl.TransitionsImpl.this).new Unmarshaller(context)), 2, ___uri, ___local, ___qname, __atts);
                            return ;
                        }
                        if (("Transition" == ___local)&&("http://www.wfmc.org/2008/XPDL2.1" == ___uri)) {
                            spawnHandlerFromEnterElement((((ru.runa.xpdl.generated.bpmnxpdl.impl.TransitionsTypeImpl) ru.runa.xpdl.generated.bpmnxpdl.impl.TransitionsImpl.this).new Unmarshaller(context)), 2, ___uri, ___local, ___qname, __atts);
            ...
            while (true) {
                switch (state) {
                    ...
                    case  3 :
                        ...
                        return ;
                    case  1 :
                        spawnHandlerFromLeaveElement((((ru.runa.xpdl.generated.bpmnxpdl.impl.TransitionsTypeImpl) ru.runa.xpdl.generated.bpmnxpdl.impl.TransitionsImpl.this).new Unmarshaller(context)), 2, ___uri, ___local, ___qname);
                        return ;
                }
            ...
            while (true) {
                switch (state) {
                    case  3 :
                        ...
                        return ;
                    case  1 :
                        spawnHandlerFromEnterAttribute((((ru.runa.xpdl.generated.bpmnxpdl.impl.TransitionsTypeImpl) ru.runa.xpdl.generated.bpmnxpdl.impl.TransitionsImpl.this).new Unmarshaller(context)), 2, ___uri, ___local, ___qname);
                        return ;
                }
            ...
            while (true) {
                switch (state) {
                    case  3 :
                        ...
                        return ;
                    case  1 :
                        spawnHandlerFromLeaveAttribute((((ru.runa.xpdl.generated.bpmnxpdl.impl.TransitionsTypeImpl) ru.runa.xpdl.generated.bpmnxpdl.impl.TransitionsImpl.this).new Unmarshaller(context)), 2, ___uri, ___local, ___qname);
                        return ;
                }
                ...
                try {
                    switch (state) {
                        case  3 :
                            ...
                            return ;
                        case  1 :
                            spawnHandlerFromText((((ru.runa.xpdl.generated.bpmnxpdl.impl.TransitionsTypeImpl) ru.runa.xpdl.generated.bpmnxpdl.impl.TransitionsImpl.this).new Unmarshaller(context)), 2, value);
                            return ;
                    }
