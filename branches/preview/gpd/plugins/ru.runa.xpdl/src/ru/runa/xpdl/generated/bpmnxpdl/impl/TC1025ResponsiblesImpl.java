...
public class TC1025ResponsiblesImpl
    extends ru.runa.xpdl.generated.bpmnxpdl.impl.TC1025ResponsiblesTypeImpl
    implements ru.runa.xpdl.generated.bpmnxpdl.TC1025Responsibles, com.sun.xml.bind.RIElement, com.sun.xml.bind.JAXBObject, ru.runa.xpdl.generated.bpmnxpdl.impl.runtime.UnmarshallableObject, ru.runa.xpdl.generated.bpmnxpdl.impl.runtime.XMLSerializable, ru.runa.xpdl.generated.bpmnxpdl.impl.runtime.ValidatableObject
{
    ...
    private final static java.lang.Class PRIMARY_INTERFACE_CLASS() {
        return (ru.runa.xpdl.generated.bpmnxpdl.TC1025Responsibles.class);
    }
    ...
    public ru.runa.xpdl.generated.bpmnxpdl.impl.runtime.UnmarshallingEventHandler createUnmarshaller(ru.runa.xpdl.generated.bpmnxpdl.impl.runtime.UnmarshallingContext context) {
        return new ru.runa.xpdl.generated.bpmnxpdl.impl.TC1025ResponsiblesImpl.Unmarshaller(context);
    }
...
+"~\u0000\u000f\u0001q\u0000~\u00007sq\u0000~\u00001t\u0000\u0011TC1025Responsiblet\u0000 http://www.wfmc.org/20"
+"02/XPDL1.0q\u0000~\u00007sq\u0000~\u0000\nppsq\u0000~\u0000(q\u0000~\u0000\u0010pq\u0000~\u0000*q\u0000~\u00003q\u0000~\u00007sq\u0000~\u00001t\u0000\u0012T"
+"C1025Responsiblesq\u0000~\u0000;sr\u0000\"com.sun.msv.grammar.ExpressionPool"
...
+"\u0000~\u0000\u0012x"));
        ...
        extends ru.runa.xpdl.generated.bpmnxpdl.impl.runtime.AbstractUnmarshallingEventHandlerImpl
    {
        ...
        public java.lang.Object owner() {
            return ru.runa.xpdl.generated.bpmnxpdl.impl.TC1025ResponsiblesImpl.this;
        }
                ...
                switch (state) {
                    case  1 :
                        if (("TC1025Responsible" == ___local)&&("http://www.wfmc.org/2002/XPDL1.0" == ___uri)) {
                            spawnHandlerFromEnterElement((((ru.runa.xpdl.generated.bpmnxpdl.impl.TC1025ResponsiblesTypeImpl) ru.runa.xpdl.generated.bpmnxpdl.impl.TC1025ResponsiblesImpl.this).new Unmarshaller(context)), 2, ___uri, ___local, ___qname, __atts);
                            return ;
                        }
                        spawnHandlerFromEnterElement((((ru.runa.xpdl.generated.bpmnxpdl.impl.TC1025ResponsiblesTypeImpl) ru.runa.xpdl.generated.bpmnxpdl.impl.TC1025ResponsiblesImpl.this).new Unmarshaller(context)), 2, ___uri, ___local, ___qname, __atts);
                        return ;
            ...
            throws org.xml.sax.SAXException
        {
            ...
            while (true) {
                switch (state) {
                    case  1 :
                        spawnHandlerFromLeaveElement((((ru.runa.xpdl.generated.bpmnxpdl.impl.TC1025ResponsiblesTypeImpl) ru.runa.xpdl.generated.bpmnxpdl.impl.TC1025ResponsiblesImpl.this).new Unmarshaller(context)), 2, ___uri, ___local, ___qname);
                        return ;
                    case  2 :
                        if (("TC1025Responsibles" == ___local)&&("http://www.wfmc.org/2002/XPDL1.0" == ___uri)) {
            ...
            throws org.xml.sax.SAXException
        {
            ...
            while (true) {
                switch (state) {
                    case  1 :
                        spawnHandlerFromEnterAttribute((((ru.runa.xpdl.generated.bpmnxpdl.impl.TC1025ResponsiblesTypeImpl) ru.runa.xpdl.generated.bpmnxpdl.impl.TC1025ResponsiblesImpl.this).new Unmarshaller(context)), 2, ___uri, ___local, ___qname);
                        return ;
                    case  3 :
            ...
            throws org.xml.sax.SAXException
        {
            ...
            while (true) {
                switch (state) {
                    case  1 :
                        spawnHandlerFromLeaveAttribute((((ru.runa.xpdl.generated.bpmnxpdl.impl.TC1025ResponsiblesTypeImpl) ru.runa.xpdl.generated.bpmnxpdl.impl.TC1025ResponsiblesImpl.this).new Unmarshaller(context)), 2, ___uri, ___local, ___qname);
                        return ;
                    case  3 :
            ...
            throws org.xml.sax.SAXException
        {
            ...
            while (true) {
                try {
                    switch (state) {
                        case  1 :
                            spawnHandlerFromText((((ru.runa.xpdl.generated.bpmnxpdl.impl.TC1025ResponsiblesTypeImpl) ru.runa.xpdl.generated.bpmnxpdl.impl.TC1025ResponsiblesImpl.this).new Unmarshaller(context)), 2, value);
                            return ;
                        case  3 :
