    ...
    implements ru.runa.xpdl.generated.bpmnxpdl.TC1025SchemaType, com.sun.xml.bind.RIElement, com.sun.xml.bind.JAXBObject, ru.runa.xpdl.generated.bpmnxpdl.impl.runtime.UnmarshallableObject, ru.runa.xpdl.generated.bpmnxpdl.impl.runtime.XMLSerializable, ru.runa.xpdl.generated.bpmnxpdl.impl.runtime.ValidatableObject
{
    ...
    private final static java.lang.Class PRIMARY_INTERFACE_CLASS() {
        return (ru.runa.xpdl.generated.bpmnxpdl.TC1025SchemaType.class);
    }
    ...
    public ru.runa.xpdl.generated.bpmnxpdl.impl.runtime.UnmarshallingEventHandler createUnmarshaller(ru.runa.xpdl.generated.bpmnxpdl.impl.runtime.UnmarshallingContext context) {
        return new ru.runa.xpdl.generated.bpmnxpdl.impl.TC1025SchemaTypeImpl.Unmarshaller(context);
    }
...
+"\u0000\u001et\u0000 http://www.wfmc.org/2002/XPDL1.0sq\u0000~\u0000\u001et\u0000+http://java.su"
+"n.com/jaxb/xjc/dummy-elementssr\u00000com.sun.msv.grammar.Express"
+"ion$EpsilonExpression\u0000\u0000\u0000\u0000\u0000\u0000\u0000\u0001\u0002\u0000\u0000xq\u0000~\u0000\u0004q\u0000~\u0000\u0016q\u0000~\u0000\'sq\u0000~\u0000\nppsq\u0000~"
...
+"URIq\u0000~\u0000\u001fxpq\u0000~\u00005q\u0000~\u00004sr\u0000#com.sun.msv.grammar.SimpleNameClass\u0000"
+"\u0000\u0000\u0000\u0000\u0000\u0000\u0001\u0002\u0000\u0002L\u0000\tlocalNameq\u0000~\u0000\u001fL\u0000\fnamespaceURIq\u0000~\u0000\u001fxq\u0000~\u0000\u0018t\u0000\u0004type"
+"t\u0000)http://www.w3.org/2001/XMLSchema-instanceq\u0000~\u0000\'sq\u0000~\u0000=t\u0000\u0010TC"
+"1025SchemaTypeq\u0000~\u0000#sr\u0000\"com.sun.msv.grammar.ExpressionPool\u0000\u0000\u0000"
...
+"grammar/ExpressionPool;xp\u0000\u0000\u0000\u0004\u0001pq\u0000~\u0000\u000bq\u0000~\u0000\tq\u0000~\u0000\u000eq\u0000~\u0000(x"));
        ...
        extends ru.runa.xpdl.generated.bpmnxpdl.impl.runtime.AbstractUnmarshallingEventHandlerImpl
    {
        ...
        public java.lang.Object owner() {
            return ru.runa.xpdl.generated.bpmnxpdl.impl.TC1025SchemaTypeImpl.this;
        }
                ...
                switch (state) {
                    case  1 :
                        if (!(("" == ___uri)||("http://www.wfmc.org/2002/XPDL1.0" == ___uri))) {
                            spawnHandlerFromEnterElement((((ru.runa.xpdl.generated.bpmnxpdl.impl.TC1025SchemaTypeTypeImpl) ru.runa.xpdl.generated.bpmnxpdl.impl.TC1025SchemaTypeImpl.this).new Unmarshaller(context)), 2, ___uri, ___local, ___qname, __atts);
                            return ;
                        }
                        spawnHandlerFromEnterElement((((ru.runa.xpdl.generated.bpmnxpdl.impl.TC1025SchemaTypeTypeImpl) ru.runa.xpdl.generated.bpmnxpdl.impl.TC1025SchemaTypeImpl.this).new Unmarshaller(context)), 2, ___uri, ___local, ___qname, __atts);
                        return ;
            ...
            throws org.xml.sax.SAXException
        {
            ...
            while (true) {
                switch (state) {
                    case  1 :
                        spawnHandlerFromLeaveElement((((ru.runa.xpdl.generated.bpmnxpdl.impl.TC1025SchemaTypeTypeImpl) ru.runa.xpdl.generated.bpmnxpdl.impl.TC1025SchemaTypeImpl.this).new Unmarshaller(context)), 2, ___uri, ___local, ___qname);
                        return ;
                    case  2 :
                        if (("TC1025SchemaType" == ___local)&&("http://www.wfmc.org/2002/XPDL1.0" == ___uri)) {
            ...
            throws org.xml.sax.SAXException
        {
            ...
            while (true) {
                switch (state) {
                    case  1 :
                        spawnHandlerFromEnterAttribute((((ru.runa.xpdl.generated.bpmnxpdl.impl.TC1025SchemaTypeTypeImpl) ru.runa.xpdl.generated.bpmnxpdl.impl.TC1025SchemaTypeImpl.this).new Unmarshaller(context)), 2, ___uri, ___local, ___qname);
                        return ;
                    case  3 :
            ...
            throws org.xml.sax.SAXException
        {
            ...
            while (true) {
                switch (state) {
                    case  1 :
                        spawnHandlerFromLeaveAttribute((((ru.runa.xpdl.generated.bpmnxpdl.impl.TC1025SchemaTypeTypeImpl) ru.runa.xpdl.generated.bpmnxpdl.impl.TC1025SchemaTypeImpl.this).new Unmarshaller(context)), 2, ___uri, ___local, ___qname);
                        return ;
                    case  3 :
            ...
            throws org.xml.sax.SAXException
        {
            ...
            while (true) {
                try {
                    switch (state) {
                        case  1 :
                            spawnHandlerFromText((((ru.runa.xpdl.generated.bpmnxpdl.impl.TC1025SchemaTypeTypeImpl) ru.runa.xpdl.generated.bpmnxpdl.impl.TC1025SchemaTypeImpl.this).new Unmarshaller(context)), 2, value);
                            return ;
                        case  3 :
