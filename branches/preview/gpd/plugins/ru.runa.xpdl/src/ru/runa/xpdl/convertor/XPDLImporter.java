...
import ru.runa.xpdl.generated.jpdl32.ActionType;
...
import ru.runa.xpdl.generated.jpdl32.impl.ActionImpl;
...
public class XPDLImporter {
    ...
    public void parseXPDLFile(File processFolder, String xpdlFileName, boolean useDefaultSwimlane, String runaGroupName) throws Exception {
        ...
        for (Object p : pack.getPools().getPool()) {
            ...
            for (Object l : lanes) {
                ...
                assignment.setClass2("ru.runa.wf.jbpm.delegation.assignment.AssignmentHandler");
            ...
            if (workflowProcess.getParticipants() != null) {
                for (Object _participant : workflowProcess.getParticipants().getParticipant()) {
                    if (_participant instanceof ru.runa.xpdl.generated.bpmnxpdl.Participant) {
                        ...
                        assignment.setClass2("ru.runa.wf.jbpm.delegation.assignment.AssignmentHandler");
                        assignment.setConfigType("configuration-property");
                        assignment.getContent().add(
                                new String("<![CDATA[ru.runa.af.organizationfunction.ExecutorByNameFunction(" + runaGroupName + ")]]>"));
                        swimlane.setAssignment(assignment);
                    }
                }
        ...
        for (Object _wp : workflowProcesses) {
            ru.runa.xpdl.generated.bpmnxpdl.ProcessType workflowProcess = (ru.runa.xpdl.generated.bpmnxpdl.ProcessType) (_wp);
            makeWorkFlowProcess(workflowProcess, width, height, swimlaneMap, gpdMap, OutWorkFlowProcessMap.get(workflowProcess.getId()), varMaps
                    .get(workflowProcess.getId()), processFormsMap.get(workflowProcess.getId()), ((pack.getAssociations() != null) ? (pack
                    .getAssociations().getAssociationAndAny()) : (null)), artifactMap, useDefaultSwimlane);
        }

        for (Object _wp : workflowProcesses) {
            ru.runa.xpdl.generated.bpmnxpdl.ProcessType workflowProcess = (ru.runa.xpdl.generated.bpmnxpdl.ProcessType) (_wp);
            makeWorkFlowProcessReferences(workflowProcess.getId(), swimlaneMap, OutWorkFlowProcessMap, varMaps, OutWorkFlowProcessMap
                    .get(workflowProcess.getId()));
        }

        for (Object _wp : workflowProcesses) {
            ru.runa.xpdl.generated.bpmnxpdl.ProcessType workflowProcess = (ru.runa.xpdl.generated.bpmnxpdl.ProcessType) (_wp);
            saveData(processFolder, OutWorkFlowProcessMap.get(workflowProcess.getId()), varMaps.get(workflowProcess.getId()), gpdMap
                    .get(workflowProcess.getId()), processFormsMap.get(workflowProcess.getId()));
        }
    }

    private void makeWorkFlowProcessReferences(String processId, Map<String, Swimlane> swimlaneMap,
            Map<String, ProcessDefinition> outWorkFlowProcessMap, Map<String, Map<String, VariableDescription>> varMaps,
        ...
        for (Object genObject : genObjectList) {
            if ((genObject instanceof ru.runa.xpdl.generated.jpdl32.ProcessState)
                    || (genObject instanceof ru.runa.xpdl.generated.jpdl32.MultiinstanceState)) {
                ...
                if (subProcessDefinition != null) {
                    ...
                    for (Object subProcObject : subProcObjectList) {
                        if (subProcObject instanceof ru.runa.xpdl.generated.jpdl32.StartState) {
                            List startStateObjectList = ((ru.runa.xpdl.generated.jpdl32.StartState) (subProcObject))
                                    .getDescriptionOrTaskOrTransition();
                            for (Object startStateObject : startStateObjectList) {
                                if (startStateObject instanceof ru.runa.xpdl.generated.jpdl32.Task) {
                                    subProcessDefaultSwimlane = ((ru.runa.xpdl.generated.jpdl32.Task) (startStateObject))
                                            .getSwimlane();
                                    break;
                                }
                            }
                    ...
                    while (subProcessVariableIter.hasNext()) {
                        ...
                        if (!myVarMap.containsKey(myVariableName)) {
                            myVarMap.put(myVariableName, new VariableDescription(subProcessVar.getValue().format,
                                    subProcessVar.getValue().publicVisibility, subProcessVar.getValue().defaultValue,
    ...
    private void saveData(File dir, ProcessDefinition processDefinition, Map<String, VariableDescription> stringVariableDescriptionMap,
            Element processDiagram, List<FormDescription> processFormList) throws Exception {
    ...
    private void makeWorkFlowProcess(ProcessType workflowProcess, double width, double height, Map<String, Swimlane> swimlaneMap,
            Map<String, Element> gpdMap, ProcessDefinition processDefinition, Map<String, VariableDescription> processVarMap,
            List<FormDescription> processFormsList, List associationList, Map<String, Artifact> artifactMap, boolean useDefaultSwimlane)
            throws Exception {
        ...
        createGPDNode("48", "48", endStateName, String.valueOf(new Double(width / 2).intValue()), String.valueOf(new Double(height - 58).intValue()),
                processDiagram, gpd);
        ...
        for (Object _ac : activityList) {
            ...
            if (subFlowType != null) {
                ...
                processStateNode.getSubProcessOrVariableOrDescription().add(subProcess);
                {
                    ...
                    if (dataMappings != null) {
                        for (Object _datamapping : dataMappings) {
                            ...
                            variable.setAccess(direction.equalsIgnoreCase("IN") ? ("read") : (direction.equalsIgnoreCase("OUT") ? ("write")
                                    : ("read,write")));
                            processStateNode.getSubProcessOrVariableOrDescription().add(variable);
                            if (!processVarMap.containsKey(actualVarName)) {
                                processVarMap.put(actualVarName, new VariableDescription("\"ru.runa.wf.web.forms.format.LongFormat\"", true, "\"0\"",
                                        null));
                            }
                        }
                    }
                ...
                boolean exclusive = ((routeType.getGatewayType().equalsIgnoreCase("Exclusive"))
                        || (routeType.getGatewayType().equalsIgnoreCase("XOR")) || (routeType.getGatewayType().equalsIgnoreCase("Inclusive")) || (routeType
                        .getGatewayType().equalsIgnoreCase("OR")));
            ...
            if ((!useDefaultSwimlane) && (activityType.getPerformers() != null) && (activityType.getPerformers().getPerformer() != null)
                    && (task != null)) {
                    ...
                    if (_performer instanceof ru.runa.xpdl.generated.bpmnxpdl.Performer) {
                        ...
                        if (swimlane != null) {
                            ...
                            if (processSwimlaneMap.get(performer.getValue()) == null) {
                                ...
                                processVarMap.put(swimlane.getName(), new VariableDescription("\"ru.runa.wf.web.forms.format.StringFormat\"", null,
                                        null, true));
                            }
                        }
                    }
                ...
                if ((task != null) && ((defaultSwimlane == null) || (task.getSwimlane() == null))) {
                    ...
                    if (swimlane != null) {
                        ...
                        if (processSwimlaneMap.get(nodeGraphicsInfo.getLaneId()) == null) {
                            ...
                            processDefinition.getDescriptionOrSwimlaneOrStartState().add(swimlane);
                            processVarMap.put(swimlane.getName(), new VariableDescription("\"ru.runa.wf.web.forms.format.StringFormat\"", null, null,
                                    true));
                        }
                    }
                }
                Element gpdNode = createGPDNode(String.valueOf(new Double(nodeGraphicsInfo.getHeight()).intValue()), String.valueOf(new Double(
                        nodeGraphicsInfo.getWidth()).intValue()), taskName, String.valueOf(new Double(nodeGraphicsInfo.getCoordinates()
                        .getXCoordinate()).intValue()), String.valueOf(new Double(nodeGraphicsInfo.getCoordinates().getYCoordinate()).intValue()),
                        processDiagram, gpd);
                gpdNodeMap.put(taskName, gpdNode);
                GeneralNodeType genNode = ((taskNode != null) ? (taskNode) : (decisionNode != null) ? (decisionNode)
                        : (forkNode != null) ? (forkNode) : (joinNode != null) ? (joinNode) : (processStateNode != null) ? (processStateNode)
                                : (null));
            ...
            if (associationList != null) {
                for (Object _acc : associationList) {
                    ...
                    this.generateFormTextAreaDescription(processFormsList, taskName, activityType.getId(), artifact.getName(), processVarMap,
                            artifact.getId());
                }
            }
        }
        ...
        {
            Decision decision = createDescisionNode(nodeMapById, startTransitionDecisionName, processDefinition, startTransitionDecisionName,
                    processVarMap);
            ...
            while (startStateTransitionIter.hasNext()) {
                ...
                for (int i = 0; i < childDodesList.getLength(); i++) {
                    ...
                    if ((node.getNodeName().equals("transition"))
                            && (node.getAttributes().getNamedItem("name").getNodeValue().equals(transition.getName()))) {
                ...
                addTransitionToReverseMap(_transition, reverseTransitionMap, transitionDescriptionMap, decision, transitionDescriptionMap
                        .get(transition.getName()).to);
            ...
            for (GeneralNodeType node : nodeMapById.values()) {
                {
                    ...
                    for (TransitionDescription transitionDescription : transitionToList) {
                        ...
                        transitionNodeMap.put(transitionDescription.transition.getName(), fillTransitionNodeList(transitionDescription,
                                reverseTransitionMap, transitionNodeList));
                    }
                    ...
                    if (transitionToJoinList.size() > 0) // надо объединять переходы в join
                    {
                        ...
                        for (TransitionDescription joinTransitionDescr : transitionToJoinList) {
                            ...
                            while (fromNodeTransitionIter.hasNext()) {
                                ...
                                addTransitionToReverseMap(_transition, reverseTransitionMap, transitionDescriptionMap, joinTransitionDescr.from,
                                        joinNode);
    ...
    private List<GeneralNodeType> fillTransitionNodeList(TransitionDescription transitionDescription,
            Map<String, List<TransitionDescription>> reverseTransitionMap, List<GeneralNodeType> transitionNodeList) {
        // System.out.println("_fillTransitionNodeList:From:"+transitionDescription.from.getName()+",TO:"+transitionDescription.to.getName());
        if (!(transitionDescription.from instanceof DecisionType) && !(transitionDescription.from instanceof ProcessState)
                && !(transitionDescription.from instanceof TaskNode) && !(transitionDescription.from instanceof ForkType)) {
    ...
    private void generateFormTextAreaDescription(List<FormDescription> processFormsList, String nodeName, String id, String dataObjectName,
        ...
        if (!processVarMap.containsKey(varName)) {
            processVarMap.put(varName, new VariableDescription("\"ru.runa.wf.web.forms.format.StringFormat\"", true, "\""
                    + Messages.getString("XPDLConnector.formValidator.EnterDataToTextField") + "\"", null));
        }
    ...
    private Decision createDescisionNode(Map<String, GeneralNodeType> nodeMap, String id, ProcessDefinition processDefinition, String taskName,
        ...
        handler.setClass2("ru.runa.wf.jbpm.delegation.decision.BSFDecisionHandler");
    ...
    private void generateEndTransition(GeneralNodeType node, EndState endState, Element gpdNode, Document gpd,
            Map<String, List<TransitionDescription>> reverseTransitionMap, Map<String, TransitionDescription> transitionDescriptionMap) {
        Transition transition = new TransitionImpl();
