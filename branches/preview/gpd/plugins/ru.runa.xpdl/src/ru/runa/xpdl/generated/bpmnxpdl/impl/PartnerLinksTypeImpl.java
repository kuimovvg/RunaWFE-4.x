...
public class PartnerLinksTypeImpl implements ru.runa.xpdl.generated.bpmnxpdl.PartnerLinksType, com.sun.xml.bind.JAXBObject, ru.runa.xpdl.generated.bpmnxpdl.impl.runtime.UnmarshallableObject, ru.runa.xpdl.generated.bpmnxpdl.impl.runtime.XMLSerializable, ru.runa.xpdl.generated.bpmnxpdl.impl.runtime.ValidatableObject
{

    protected com.sun.xml.bind.util.ListImpl _Any;
    protected com.sun.xml.bind.util.ListImpl _PartnerLink;
    ...
    private final static java.lang.Class PRIMARY_INTERFACE_CLASS() {
        return (ru.runa.xpdl.generated.bpmnxpdl.PartnerLinksType.class);
    }
    ...
    protected com.sun.xml.bind.util.ListImpl _getPartnerLink() {
        if (_PartnerLink == null) {
            _PartnerLink = new com.sun.xml.bind.util.ListImpl(new java.util.ArrayList());
        }
        return _PartnerLink;
    }

    public java.util.List getPartnerLink() {
        return _getPartnerLink();
    }
    ...
    public ru.runa.xpdl.generated.bpmnxpdl.impl.runtime.UnmarshallingEventHandler createUnmarshaller(ru.runa.xpdl.generated.bpmnxpdl.impl.runtime.UnmarshallingContext context) {
        return new ru.runa.xpdl.generated.bpmnxpdl.impl.PartnerLinksTypeImpl.Unmarshaller(context);
    }
        ...
        throws org.xml.sax.SAXException
    {
        ...
        int idx2 = 0;
        final int len2 = ((_PartnerLink == null)? 0 :_PartnerLink.size());
        while (idx2 != len2) {
            if (_PartnerLink.get(idx2) instanceof javax.xml.bind.Element) {
                context.childAsBody(((com.sun.xml.bind.JAXBObject) _PartnerLink.get(idx2 ++)), "PartnerLink");
            } else {
                context.startElement("http://www.wfmc.org/2008/XPDL2.1", "PartnerLink");
                int idx_0 = idx2;
                context.childAsURIs(((com.sun.xml.bind.JAXBObject) _PartnerLink.get(idx_0 ++)), "PartnerLink");
                context.endNamespaceDecls();
                int idx_1 = idx2;
                context.childAsAttributes(((com.sun.xml.bind.JAXBObject) _PartnerLink.get(idx_1 ++)), "PartnerLink");
        ...
        throws org.xml.sax.SAXException
    {
        ...
        while (idx2 != len2) {
            if (_PartnerLink.get(idx2) instanceof javax.xml.bind.Element) {
                context.childAsAttributes(((com.sun.xml.bind.JAXBObject) _PartnerLink.get(idx2 ++)), "PartnerLink");
            } else {
                idx2 += 1;
            }
        }
        ...
        throws org.xml.sax.SAXException
    {
        ...
        while (idx2 != len2) {
            if (_PartnerLink.get(idx2) instanceof javax.xml.bind.Element) {
                context.childAsURIs(((com.sun.xml.bind.JAXBObject) _PartnerLink.get(idx2 ++)), "PartnerLink");
            } else {
                idx2 += 1;
            }
        }
...
+"rated.bpmnxpdl.PartnerLinkt\u0000+http://java.sun.com/jaxb/xjc/du"
+"mmy-elementssq\u0000~\u0000\u000bpp\u0000sq\u0000~\u0000\u0000ppsq\u0000~\u0000\u000bpp\u0000sq\u0000~\u0000\tppsq\u0000~\u0000\u0006q\u0000~\u0000\u0012psq"
+"\u0000~\u0000\u0013q\u0000~\u0000\u0012pq\u0000~\u0000\u0016q\u0000~\u0000\u001aq\u0000~\u0000\u001csq\u0000~\u0000\u001dt\u0000#ru.runa.xpdl.generated.bpmnxpdl.Partner"
+"LinkType2q\u0000~\u0000!sq\u0000~\u0000\tppsq\u0000~\u0000\u0013q\u0000~\u0000\u0012psr\u0000\u001bcom.sun.msv.grammar.Da"
...
+"onPool;xp\u0000\u0000\u0000\u000b\u0001pq\u0000~\u0000\u0010q\u0000~\u0000&q\u0000~\u0000\u0005q\u0000~\u0000\u000fq\u0000~\u0000%q\u0000~\u0000#q\u0000~\u0000Eq\u0000~\u0000Fq\u0000~\u0000*"
+"q\u0000~\u0000\nq\u0000~\u0000\bx"));
        }
        ...
        extends ru.runa.xpdl.generated.bpmnxpdl.impl.runtime.AbstractUnmarshallingEventHandlerImpl
    {
        ...
        public java.lang.Object owner() {
            return ru.runa.xpdl.generated.bpmnxpdl.impl.PartnerLinksTypeImpl.this;
        }
                ...
                switch (state) {
                    case  0 :
                        if (("PartnerLink" == ___local)&&("http://www.wfmc.org/2008/XPDL2.1" == ___uri)) {
                            _getPartnerLink().add(((ru.runa.xpdl.generated.bpmnxpdl.impl.PartnerLinkImpl) spawnChildFromEnterElement((ru.runa.xpdl.generated.bpmnxpdl.impl.PartnerLinkImpl.class), 1, ___uri, ___local, ___qname, __atts)));
                            return ;
                        }
                        if (("PartnerLink" == ___local)&&("http://www.wfmc.org/2008/XPDL2.1" == ___uri)) {
                ...
                switch (state) {
                    ...
                    case  3 :
                        if (("Id" == ___local)&&("" == ___uri)) {
                            _getPartnerLink().add(((ru.runa.xpdl.generated.bpmnxpdl.impl.PartnerLinkType2Impl) spawnChildFromEnterAttribute((ru.runa.xpdl.generated.bpmnxpdl.impl.PartnerLinkType2Impl.class), 4, ___uri, ___local, ___qname)));
                            return ;
                        }
                        break;
                }
