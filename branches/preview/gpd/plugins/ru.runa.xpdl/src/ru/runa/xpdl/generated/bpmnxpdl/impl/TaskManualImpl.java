...
public class TaskManualImpl
    extends ru.runa.xpdl.generated.bpmnxpdl.impl.TaskManualTypeImpl
    implements ru.runa.xpdl.generated.bpmnxpdl.TaskManual, com.sun.xml.bind.RIElement, com.sun.xml.bind.JAXBObject, ru.runa.xpdl.generated.bpmnxpdl.impl.runtime.UnmarshallableObject, ru.runa.xpdl.generated.bpmnxpdl.impl.runtime.XMLSerializable, ru.runa.xpdl.generated.bpmnxpdl.impl.runtime.ValidatableObject
{
    ...
    private final static java.lang.Class PRIMARY_INTERFACE_CLASS() {
        return (ru.runa.xpdl.generated.bpmnxpdl.TaskManual.class);
    }
    ...
    public ru.runa.xpdl.generated.bpmnxpdl.impl.runtime.UnmarshallingEventHandler createUnmarshaller(ru.runa.xpdl.generated.bpmnxpdl.impl.runtime.UnmarshallingContext context) {
        return new ru.runa.xpdl.generated.bpmnxpdl.impl.TaskManualImpl.Unmarshaller(context);
    }
...
+"paceURIq\u0000~\u0000 xq\u0000~\u0000\u001bt\u0000\u001dgenerated.bpmnxpdl.Performerst\u0000+http://"
+"java.sun.com/jaxb/xjc/dummy-elementssq\u0000~\u0000\u0000q\u0000~\u0000\u000fp\u0000sq\u0000~\u0000\u0007ppsq\u0000"
+"~\u0000\u0000pp\u0000sq\u0000~\u0000\u000bppsq\u0000~\u0000\u0012q\u0000~\u0000\u000fpsq\u0000~\u0000\u0015q\u0000~\u0000\u000fpq\u0000~\u0000\u0018q\u0000~\u0000\u001cq\u0000~\u0000\u001esq\u0000~\u0000\u001ft"
+"\u0000!ru.runa.xpdl.generated.bpmnxpdl.PerformersTypeq\u0000~\u0000#sq\u0000~\u0000\u000bppsq\u0000~\u0000\u0015q\u0000~\u0000\u000fp"
...
+"-instanceq\u0000~\u0000\u001esq\u0000~\u0000\u001ft\u0000\nPerformerst\u0000 http://www.wfmc.org/2008"
+"/XPDL2.1q\u0000~\u0000\u001esq\u0000~\u0000\u000bppsq\u0000~\u0000\u0012q\u0000~\u0000\u000fpsq\u0000~\u0000\u0000q\u0000~\u0000\u000fp\u0000sq\u0000~\u0000\u0015ppq\u0000~\u0000\u0018s"
...
+"~\u0000\u001bt\u0000\u0000sq\u0000~\u0000Oq\u0000~\u0000Fsq\u0000~\u0000Oq\u0000~\u0000#q\u0000~\u0000\u001esq\u0000~\u0000\u000bppsq\u0000~\u0000\u0015q\u0000~\u0000\u000fpq\u0000~\u00001q\u0000"
+"~\u0000Aq\u0000~\u0000\u001esq\u0000~\u0000\u001ft\u0000\nTaskManualq\u0000~\u0000Fsr\u0000\"com.sun.msv.grammar.Expr"
...
+"Lcom/sun/msv/grammar/ExpressionPool;xp\u0000\u0000\u0000\r\u0001pq\u0000~\u0000\u0014q\u0000~\u0000(q\u0000~\u0000Hq"
+"\u0000~\u0000\u0011q\u0000~\u0000\'q\u0000~\u0000%q\u0000~\u0000Gq\u0000~\u0000,q\u0000~\u0000Tq\u0000~\u0000\fq\u0000~\u0000\rq\u0000~\u0000\tq\u0000~\u0000\nx"));
        }
        ...
        extends ru.runa.xpdl.generated.bpmnxpdl.impl.runtime.AbstractUnmarshallingEventHandlerImpl
    {
        ...
        public java.lang.Object owner() {
            return ru.runa.xpdl.generated.bpmnxpdl.impl.TaskManualImpl.this;
        }
                ...
                switch (state) {
                    ...
                    case  1 :
                        if (("Performers" == ___local)&&("http://www.wfmc.org/2008/XPDL2.1" == ___uri)) {
                            spawnHandlerFromEnterElement((((ru.runa.xpdl.generated.bpmnxpdl.impl.TaskManualTypeImpl) ru.runa.xpdl.generated.bpmnxpdl.impl.TaskManualImpl.this).new Unmarshaller(context)), 2, ___uri, ___local, ___qname, __atts);
                            return ;
                        }
                        if (("Performers" == ___local)&&("http://www.wfmc.org/2008/XPDL2.1" == ___uri)) {
                            spawnHandlerFromEnterElement((((ru.runa.xpdl.generated.bpmnxpdl.impl.TaskManualTypeImpl) ru.runa.xpdl.generated.bpmnxpdl.impl.TaskManualImpl.this).new Unmarshaller(context)), 2, ___uri, ___local, ___qname, __atts);
            ...
            while (true) {
                switch (state) {
                    case  3 :
                        ...
                        return ;
                    case  1 :
                        spawnHandlerFromLeaveElement((((ru.runa.xpdl.generated.bpmnxpdl.impl.TaskManualTypeImpl) ru.runa.xpdl.generated.bpmnxpdl.impl.TaskManualImpl.this).new Unmarshaller(context)), 2, ___uri, ___local, ___qname);
                        return ;
                    case  2 :
                        if (("TaskManual" == ___local)&&("http://www.wfmc.org/2008/XPDL2.1" == ___uri)) {
            ...
            while (true) {
                switch (state) {
                    case  3 :
                        ...
                        return ;
                    case  1 :
                        spawnHandlerFromEnterAttribute((((ru.runa.xpdl.generated.bpmnxpdl.impl.TaskManualTypeImpl) ru.runa.xpdl.generated.bpmnxpdl.impl.TaskManualImpl.this).new Unmarshaller(context)), 2, ___uri, ___local, ___qname);
                        return ;
                }
            ...
            while (true) {
                switch (state) {
                    case  3 :
                        ...
                        return ;
                    case  1 :
                        spawnHandlerFromLeaveAttribute((((ru.runa.xpdl.generated.bpmnxpdl.impl.TaskManualTypeImpl) ru.runa.xpdl.generated.bpmnxpdl.impl.TaskManualImpl.this).new Unmarshaller(context)), 2, ___uri, ___local, ___qname);
                        return ;
                }
                ...
                try {
                    switch (state) {
                        case  3 :
                            ...
                            return ;
                        case  1 :
                            spawnHandlerFromText((((ru.runa.xpdl.generated.bpmnxpdl.impl.TaskManualTypeImpl) ru.runa.xpdl.generated.bpmnxpdl.impl.TaskManualImpl.this).new Unmarshaller(context)), 2, value);
                            return ;
                    }
