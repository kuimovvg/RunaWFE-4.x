    ...
    public void doGet(HttpServletRequest request, HttpServletResponse response) {
        try {
            ...
            if ("CustomizeCommonDialog".equals(commandStr)) {
                ...
                InputStream stream = FileLocator.openStream(WYSIWYGPlugin.getDefault().getBundle(), new Path(dialogPath.replace("http://localhost:"
                        + WYSIWYGPlugin.SERVER_PORT, "CKEditor")), false);
            ...
            if ("GetTagImage".equals(commandStr)) {
                ...
                if (imageStream == null) {
                    imageStream = WYSIWYGPlugin.loadTagImage(WYSIWYGPlugin.getDefault().getBundle(), "metadata/ftl_icons/" + tagImageName);
                }
                        ...
                        for (OptionalValue option : param.optionalValues) {
                            if (option.container) {
                                for (Variable variable : WYSIWYGHTMLEditor.getCurrent().getVariablesList(true)) {
                                    ...
                                    resultHtml.append("<option value=\"").append(variable.getName()).append("\">").append(variable.getName()).append(
                                            "</option>");
                                }
                            } else {
