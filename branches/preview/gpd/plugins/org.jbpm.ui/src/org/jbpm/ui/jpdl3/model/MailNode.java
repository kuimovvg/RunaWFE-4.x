...
public class MailNode extends Node {
    ...
    static {
        DESCRIPTORS.add(new TextPropertyDescriptor(RECIPIENT_PROP, Messages.getString("MailNode.property.recipient")));
        DESCRIPTORS.add(new TextPropertyDescriptor(SUBJECT_PROP, Messages.getString("MailNode.property.subject")));
        DESCRIPTORS.add(new TextPropertyDescriptor(MAIL_BODY_PROP, Messages.getString("MailNode.property.mailBody")));
    }
