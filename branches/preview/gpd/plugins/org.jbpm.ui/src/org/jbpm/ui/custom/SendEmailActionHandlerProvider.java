...
import ru.runa.bpm.ui.dialog.EmailConfigWizardPage;
...
public class SendEmailActionHandlerProvider extends DelegableProvider {
    ...
    public String showConfigurationDialog(Delegable delegable) {
        ...
        WizardDialog wizardDialog = new WizardDialog(Display.getCurrent().getActiveShell(), wizard) {
            ...
            protected void createButtonsForButtonBar(Composite parent) {
                Button testButton = createButton(parent, 101, Messages.getString("EmailDialog.test.button"), false);
                    ...
                    public void widgetSelected(SelectionEvent e) {
                        ...
                        final IRunnableWithProgress runnable = new IRunnableWithProgress() {
                            ...
                            public void run(IProgressMonitor monitor) throws InvocationTargetException, InterruptedException {
                                try {
                                    monitor.beginTask(Messages.getString("EmailDialog.test.button"), 1);
                        ...
                        try {
                            ...
                            setMessage(Messages.getString("EmailDialog.test.success"));
                        } catch (InvocationTargetException ex) {
                            DesignerLogger.logError(Messages.getString("EmailDialog.test.error"), ex.getTargetException());
    ...
    public boolean validateValue(Delegable delegable) {
        ...
        try {
            ...
            DesignerLogger.logErrorWithoutDialog("invalid Email config " + configuration, e);
            return false;
        }
        return true;
    }
