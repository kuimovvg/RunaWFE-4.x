...
import ru.runa.bpm.ui.dialog.NumberInputDialog;
import ru.runa.bpm.ui.dialog.UserInputDialog;
import ru.runa.bpm.ui.resource.Messages;

public abstract class BSHTypeSupport {
    private static final String DEFAULT_FORMAT_NAME = "ru.runa.bpm.web.formgen.format.DefaultFormat";
    ...
    static {
        ...
        TYPES_MAP.put("ru.runa.bpm.web.formgen.format.DoubleFormat", new NumberType());
