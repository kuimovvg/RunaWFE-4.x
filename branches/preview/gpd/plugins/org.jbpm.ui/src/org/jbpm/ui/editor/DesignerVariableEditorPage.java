...
import ru.runa.bpm.ui.common.command.ProcessDefinitionRemoveVariablesCommand;
...
import ru.runa.bpm.ui.dialog.CreateVariableDialog;
import ru.runa.bpm.ui.dialog.UpdateVariableNameDialog;
...
public class DesignerVariableEditorPage extends EditorPartBase {
    ...
    public void createPartControl(Composite parent) {
        ...
        String[] columnNames = new String[] { Messages.getString("property.name"), Messages.getString("Variable.property.format"),
                Messages.getString("Variable.property.defaultValue") };
