...
import ru.runa.bpm.ui.dialog.EditPropertyDialog;
...
public class ParamDefDynaComposite extends ParamDefComposite {
    ...
    public void createUI() {
        ...
        final Button editButton = createButton(buttonsBar, Messages.getString("button.edit"), new EditSelectionAdapter());
