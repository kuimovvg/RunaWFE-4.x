...
public class ActiveActionsDelegate extends BaseActionDelegate implements IMenuCreator {
    ...
    protected void fillMenu(Menu menu) {
        ...
        for (ru.runa.bpm.ui.common.model.Action action : active.getActions()) {
    ...
    private void setFocus(ru.runa.bpm.ui.common.model.Action action) {
        getActiveDesignerEditor().select(action);
    }

    public class ShowAction extends Action {
        private ru.runa.bpm.ui.common.model.Action action;

        public ShowAction(ru.runa.bpm.ui.common.model.Action action) {
            this.action = action;
        }
