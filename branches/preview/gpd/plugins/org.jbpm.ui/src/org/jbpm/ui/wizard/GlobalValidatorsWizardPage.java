...
import ru.runa.bpm.ui.bsh.BSHTypeSupport;
import ru.runa.bpm.ui.bsh.BSHValidationModel;
import ru.runa.bpm.ui.bsh.Operation;
import ru.runa.bpm.ui.bsh.BSHValidationModel.Expr;
...
import ru.runa.bpm.ui.validation.ValidatorDefinitionRegistry;
import ru.runa.bpm.ui.validation.ValidatorDefinition.Param;
import ru.runa.bpm.ui.wizard.ValidatorWizard.ParametersComposite;
import ru.runa.bpm.ui.wizard.ValidatorWizard.ValidatorInfoControl;
import ru.runa.bpm.web.formgen.format.DefaultFormat;
...
public class GlobalValidatorsWizardPage extends WizardPage {
    ...
    protected GlobalValidatorsWizardPage(String pageName, List<Variable> variables, List<Swimlane> swimlanes) {
        ...
        for (Swimlane swimlane : swimlanes) {
            this.allVariables.add(new Variable(swimlane.getName(), DefaultFormat.class.getName(), swimlane.isPublicVisibility(), null));
        }
        ...
        setTitle(Messages.getString("ValidatorWizardPage.globalpage.title"));
        setDescription(Messages.getString("ValidatorWizardPage.globalpage.description"));
    }
