...
public class ActorsMultiSelectTag extends AjaxFreemarkerTag {
    ...
    protected String renderRequest() throws TemplateModelException {
        try {
            ...
            html.append("<div id=\"actorsMultiSelect").append(variableName).append(
                    "\"><div id=\"actorsMultiSelectCnt").append(variableName).append(
                    "\"></div><div id=\"actorsMultiSelectAddButton\"><a href=\"javascript:{}\" id=\"btnAdd")
    ...
    private List<Executor> getActors(Subject subject, boolean byLogin, String hint) throws TemplateModelException {
        try {
            ...
            if (hint.length() > 0) {
                ...
                Map<Integer, FilterCriteria> filterFieldsMap = batchPresentation.getFilteredFieldsMap();
                StringFilterCriteria filterCriteriaEnd = (StringFilterCriteria) FilterCriteriaFactory
                        .getFilterCriteria(batchPresentation, filterIndex);
