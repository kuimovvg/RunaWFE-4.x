    ...
    public void loadAssociation(Object ref, Collection collection, AlfSerializerDesc desc) throws ApplicationException {
        try {
            ...
            if (desc.getAssoc().child()) {
                ...
                filter = false;
                Association association = new Association(desc.getPropertyNameWithNamespace(), desc.getAssoc().source() ? "target"
                        : "source");
        ...
        try {
            ...
            for (AlfSerializerDesc desc : assocToDelete.keySet()) {
                ...
                for (Object ref : refs) {
                    ...
                    if (desc.getAssoc().child()) {
                        ...
                        CMLRemoveAssociation removeAssociation = new CMLRemoveAssociation(object.getPredicate(), null, where, null, desc
            ...
            for (AlfSerializerDesc desc : assocToCreate.keySet()) {
                ...
                for (Object ref : refs) {
                    ...
                    if (desc.getAssoc().child()) {
                        ParentReference parentReference = new ParentReference(object.getReference().getStore(), object.getReference()
                                .getUuid(), null, desc.getPropertyNameWithNamespace(), target.getObjectName());
                        CMLAddChild addChild = new CMLAddChild(parentReference, null, desc.getPropertyNameWithNamespace(), target
                                .getObjectName(), predicate, null);
