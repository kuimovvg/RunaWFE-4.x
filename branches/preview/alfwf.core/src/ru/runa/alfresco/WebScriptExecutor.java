...
public class WebScriptExecutor {
    ...
    public ByteArrayOutputStream doRequest() throws Exception {
        ...
        httpClient.getCredentialsProvider().setCredentials(
                ...
                new UsernamePasswordCredentials(
                        WSConnectionSettings.getSystemLogin(), 
                        WSConnectionSettings.getSystemPassword()));
    ...
    private HttpPost formHttpPostRequest(String alfBaseUrl) throws Exception{
        ...
        for (String paramName : webScriptFileParameters.keySet()) {
            ...
            ByteArrayBody body = new ByteArrayBody(fileData,
                    webScriptFileParameters.get(paramName).getContentType(), webScriptFileParameters.get(paramName).getName());
