...
public class ExecutorServiceDelegateGetGroupByIdTest extends ServletTestCase {
    ...
    public void testGetGroupByAuthorizedPerformer() throws Exception {
        Group returnedBaseGroup = executorService.getGroup(th.getAuthorizedPerformerSubject(), group.getId());
        ...
        Group returnedSubGroup = executorService.getGroup(th.getAuthorizedPerformerSubject(), subGroup.getId());
    ...
    public void testGetGroupByUnauthorizedPerformer() throws Exception {
        try {
            executorService.getGroup(th.getUnauthorizedPerformerSubject(), group.getId());
            assertTrue("buisnessDelegete allow to getGroup()", false);
        } catch (AuthorizationException e) {
            //That's what we expect
        }
        try {
            executorService.getGroup(th.getUnauthorizedPerformerSubject(), th.getSubGroup().getId());
    ...
    public void testGetUnexistedGroupByAuthorizedPerformer() throws Exception {
        try {
            executorService.getGroup(th.getAuthorizedPerformerSubject(), -1l);
    ...
    public void testGetGroupByNullPerformer() throws Exception {
        try {
            ...
            executorService.getGroup(nullSubject, group.getId());
    ...
    public void testGetActorInsteadOfGroup() throws Exception {
        try {
            executorService.getGroup(th.getAuthorizedPerformerSubject(), th.getBaseGroupActor().getId());
