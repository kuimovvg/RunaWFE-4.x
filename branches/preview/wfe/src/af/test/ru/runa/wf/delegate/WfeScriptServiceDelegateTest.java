...
public class WfeScriptServiceDelegateTest extends ServletTestCase {
    ...
    public static Test suite() {
        return new TestSuite(WfeScriptServiceDelegateTest.class);
    }
    ...
    public void testAddThenSetPermissions() throws Exception {
        ...
        assertTrue("Check if 'read' permission is given to employee on system", helper.isAllowedToExecutor(ASystem.SYSTEM, employee,
                SystemPermission.READ));

        assertTrue("Check if 'update_permissions' permission is given to employee on system", helper.isAllowedToExecutor(ASystem.SYSTEM, employee,
                SystemPermission.UPDATE_PERMISSIONS));

        assertFalse("Check if 'login_to_system' permission is given to employee on system", helper.isAllowedToExecutor(ASystem.SYSTEM, employee,
                SystemPermission.LOGIN_TO_SYSTEM));

        assertTrue("Check if 'create_executor' permission is given to employee on system", helper.isAllowedToExecutor(ASystem.SYSTEM, employee,
                SystemPermission.CREATE_EXECUTOR));

        assertTrue("Check if 'deploy_definition' permission is given to employee on system", helper.isAllowedToExecutor(ASystem.SYSTEM, employee,
    ...
    public void testSetThenAddPermissions() throws Exception {
        ...
        assertTrue("Check if 'login_to_system' permission is given to employee on system", helper.isAllowedToExecutor(ASystem.SYSTEM, employee,
                SystemPermission.LOGIN_TO_SYSTEM));
    ...
    public void testRemove() throws Exception {
        ...
        assertFalse("Check if 'update_permissions' permission is given to employee on system", helper.isAllowedToExecutor(ASystem.SYSTEM, employee,
                SystemPermission.UPDATE_PERMISSIONS));
