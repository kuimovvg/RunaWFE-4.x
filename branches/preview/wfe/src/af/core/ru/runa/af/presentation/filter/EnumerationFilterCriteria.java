 ...
 */
@Entity
@DiscriminatorValue(value = "ru.runa.af.presentation.EnumerationFilterCriteria")
public abstract class EnumerationFilterCriteria extends FilterCriteria {
     ...
     * @param enumerationValues {@link Map} from enumerated value to property display name (struts property).
     */
