...
class DynamicField implements Serializable {
    ...
    @SequenceGenerator(name = "sequence", sequenceName = "SEQ_BP_DYNAMIC_FIELDS")
    ...
    @Column(name = "FIELD_IDX", nullable = false)
    ...
    public DynamicField clone() {
        return new DynamicField(fieldIdx, dynamicValue);
    }
}
