 ...
 */
class EhCacheSupport<K extends Serializable, V extends Serializable> implements ru.runa.commons.cache.Cache<K, V> {
     ...
     * @param ehcacheName Ehcache {@linkplain Cache} name, used to store cached values.
