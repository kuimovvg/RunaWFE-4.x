...
/**
 * Represents State element on process graph.
 */
public class StateGraphElementPresentation extends BaseGraphElementPresentation {
     ...
     */
    public StateGraphElementPresentation(String name, int[] graphConstraints) {
