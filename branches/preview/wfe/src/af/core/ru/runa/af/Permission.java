...
public class Permission implements Serializable {
    ...
    /**
     * Permission mask. Every specific permission (Read, Update) has it's own bit position in this mask.
     * If permission is granted, then permission bit is set to 1; otherwise permission bit is set to 0. 
     */
     ...
     * @param maskPower Bit position, where permission is stored in {@link #mask}.
    ...
    /**
     * Return permission mask. Every specific permission (Read, Update) has it's own bit position in this mask.
     * If permission is granted, then permission bit is set to 1; otherwise permission bit is set to 0. 
     ...
     * @param mask Permission bit mask.
     * @return Permission with specified mask.
     * @throws PermissionNotFoundException Permission with specified mask not found.
     */
     ...
     * @throws PermissionNotFoundException Permission with specified name was not found.
     */
    ...
    public String toString() {
        return this.getClass() + ":" + name + ":" + mask;
    }

    /**
     * Merge two permission arrays together into single permission array.
     * @param p1 First permission array.
     * @param p2 Second permission array.
     ...
     * @param p1 Source permission array, from which permissions removed.  
     * @param p2 Permission array with permissions to remove.
     * @return Permission array
     */
