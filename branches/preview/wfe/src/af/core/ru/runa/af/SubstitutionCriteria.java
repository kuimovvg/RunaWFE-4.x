 ...
 */
@Entity
@Table(name = "SUBSTITUTION_CRITERIAS", uniqueConstraints = @UniqueConstraint(columnNames = { "TYPE", "CONF" }))
@DiscriminatorColumn(name = "TYPE", discriminatorType = DiscriminatorType.STRING)
@Cache(usage = CacheConcurrencyStrategy.READ_WRITE)
public class SubstitutionCriteria implements Cloneable, Serializable {
    ...
    @SequenceGenerator(name = "sequence", sequenceName = "SEQ_SUBSTITUTION_CRITERIAS")
