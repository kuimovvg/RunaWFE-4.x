...
public class BotStationConfigurePermission extends Permission {

    public static final String BOT_STATION_CONFIGURE_PERMISSION_NAME = "permission.bot_station_configure";
    public static final Permission BOT_STATION_CONFIGURE = new BotStationConfigurePermission((byte) 4, BOT_STATION_CONFIGURE_PERMISSION_NAME);
    ...
    protected BotStationConfigurePermission(byte maskPower, String name) {
        super(maskPower, name);
    }

    public BotStationConfigurePermission() {
        super();
    }
