...
public class JpdlArchiveParser implements ProcessArchiveParser {
    ...
    @Override
    public void readFromArchive(ProcessArchive processArchive, ExecutableProcessDefinition processDefinition) {
        byte[] definitionXml = processArchive.getFileDataNotNull(FileDataProvider.PROCESSDEFINITION_XML_FILE_NAME);
