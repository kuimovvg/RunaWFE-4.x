 ...
 */
@Entity
@Table(name = "EXECUTOR_GROUP_RELATIONS", uniqueConstraints = @UniqueConstraint(columnNames = { "EXECUTOR_ID", "GROUP_ID" }))
...
public class ExecutorGroupRelation {
    ...
    @SequenceGenerator(name = "sequence", sequenceName = "SEQ_EXECUTOR_GROUP_RELATIONS")
