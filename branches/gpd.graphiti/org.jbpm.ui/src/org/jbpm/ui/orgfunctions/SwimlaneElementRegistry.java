...
public class SwimlaneElementRegistry {
    ...
    private static SwimlaneElement parseElement(IConfigurationElement configElement) throws Exception {
        try {
            ...
            DesignerLogger.logError("Error processing extension 'org.jbpm.ui.swimlaneelements'", e);
            return null;
        }
    }
    ...
    public static List<SwimlaneElement> getSwimlaneElements() {
        ...
        try {
            IExtension[] extensions = Platform.getExtensionRegistry().getExtensionPoint("org.jbpm.ui.swimlaneelements").getExtensions();
