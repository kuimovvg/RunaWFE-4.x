...
public class OrgFunctionsRegistry {
    ...
    private static void init() {
        ...
        IExtension[] extensions = Platform.getExtensionRegistry().getExtensionPoint("org.jbpm.ui.orgfunctions").getExtensions();
        for (IExtension extension : extensions) {
            ...
            for (IConfigurationElement configElement : configElements) {
                try {
                    ...
                    DesignerLogger.logError("Error processing org.jbpm.ui.orgfunctions element", e);
                }
            }
        }
    }
