...
public class HibernateCompilerQueryBuilder {
    ...
    /**
     * Removes from SQL select clause all column names and 'as' statements. So it's converts SQL like 'select TABLE.ID as T_ID, TABLE.NAME as T_N' to 'select TABLE.*'. Actually
     * only 'as' statements removing is required, but removing all columns is much simple and resulting request is much clever.
     * 
     * @param sqlRequest
