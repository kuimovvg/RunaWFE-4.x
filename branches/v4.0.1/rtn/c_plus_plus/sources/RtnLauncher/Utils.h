...
typedef DWORD (WINAPI GETMODULEABASENAME) (HANDLE hProcess, HMODULE hModule, LPSTR lpBaseName, DWORD nSize);
...
public:
	...
	DWORD First();
	DWORD FindProcess(LPCSTR lpModname, BOOL bAddExe=TRUE);
	DWORD Next()
	{
...
public:
	...
	static HWND FindWindowByProcessID(DWORD pid);
};
