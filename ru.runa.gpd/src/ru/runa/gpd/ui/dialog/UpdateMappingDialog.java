...
public class UpdateMappingDialog extends Dialog {
    ...
    protected Control createDialogArea(Composite parent) {
        ...
        labelTitle.setText(Localization.getString(updateMode ? "Mapping.update.message" : "Mapping.add.message"));
        ...
        labelType.setText(Localization.getString("Mapping.Type") + ":");
    ...
    protected void configureShell(Shell newShell) {
        ...
        newShell.setText(Localization.getString(updateMode ? "Mapping.update.title" : "Mapping.add.title"));
    }
