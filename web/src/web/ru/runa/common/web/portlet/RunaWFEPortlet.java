...
public class RunaWFEPortlet extends StrutsPortlet {
    ...
    public void init(PortletConfig config) throws PortletException {
        ...
        if (authenticatorClassName != null) {
            authenticator = (PortletAuthenticator) Loader.loadObject(authenticatorClassName, new Object[0], true);
        }
        if (authenticator == null) {
            authenticator = new AuthenticateIfPossible();
        }
        if (errorHandlerClassName != null) {
            exceptionHandler = (PortletExceptionHandler) Loader.loadObject(errorHandlerClassName, new Object[0], true);
        }
