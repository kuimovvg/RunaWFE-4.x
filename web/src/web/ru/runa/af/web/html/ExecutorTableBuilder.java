...
public class ExecutorTableBuilder extends BaseDetailTableBuilder {
     ...
     * Use for update
     * 
     * @param executor executor for update
     */
    ...
    public Table buildTable() {
        ...
        if (isActor) {
            ...
            table.addElement(createTRWith2TD(Messages.getMessage(Messages.LABEL_ACTOR_EMAIL, pageContext),
                    UpdateExecutorDetailsForm.EMAIL_INPUT_NAME, isEmpty || ((Actor) executor).getEmail() == null ? "" : String
                            .valueOf(((Actor) executor).getEmail()), areInputsDisabled));
            ...
            table.addElement(createTRWith2TD(Messages.getMessage(Messages.LABEL_GROUP_AD, pageContext), UpdateExecutorDetailsForm.EMAIL_INPUT_NAME,
                    isEmpty ? "" : ((Group) executor).getActiveDirectoryGroup() != null ? String
                            .valueOf(((Group) executor).getActiveDirectoryGroup()) : "", areInputsDisabled));
        }
        return table;
    }
}
