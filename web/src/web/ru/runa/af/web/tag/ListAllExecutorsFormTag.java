...
public class ListAllExecutorsFormTag extends BatchReturningTitledFormTag {
     ...
     * @param subject Current actor subject.
     * @param executors Executors, shown on form. 
     */
    private void setupFormButton(Subject subject, List<Executor> executors) throws AuthenticationException, BatchPresentationNotFoundException {
        BatchPresentation batchPresentation = getBatchPresentation();
