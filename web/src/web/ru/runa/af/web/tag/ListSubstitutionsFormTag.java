    ...
    class SubstitutionRowBuilder implements RowBuilder {
        ...
        private TD buildEnabledTD(Substitution substitution) {
            ...
            if (index == substitutions.size()) {
                ...
                downParams.put(IdsForm.IDS_INPUT_NAME, new String[] { String.valueOf(substitution.getId()),
                        String.valueOf(substitutions.get(position).getId()) });
                downParams.put(IdsForm.ID_INPUT_NAME, String.valueOf(substitution.getActorId()));

                A moveDownHref = new A(Commons.getActionUrl(SwitchSubstitutionsPositionsAction.ACTION_PATH, downParams, pageContext,
                        PortletUrl.Action));
                IMG moveDownIMG = new IMG(Commons.getUrl(Resources.SORT_DESC_IMAGE, pageContext, PortletUrl.Resource), 0);
        ...
        private TD buildFunctionTD(Substitution substitution) {
            ...
            if (disabled) {
                ...
                params.put(IdForm.ID_INPUT_NAME, String.valueOf(substitution.getId()));
                A editHref = new A(Commons.getActionUrl(UpdateSubstitutionAction.EDIT_ACTION, params, pageContext, PortletUrl.Action));
