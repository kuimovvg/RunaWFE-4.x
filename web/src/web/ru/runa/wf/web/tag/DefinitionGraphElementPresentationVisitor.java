...
public class DefinitionGraphElementPresentationVisitor extends SubprocessesGraphElementAdapter {
    ...
    public void onSubprocess(SubprocessGraphElementPresentation element) {
        ...
        params.put(IdForm.ID_INPUT_NAME, String.valueOf(element.getSubprocessId()));
        String url = Commons.getActionUrl(Resources.ACTION_MAPPING_MANAGE_DEFINITION, params, pageContext, PortletUrl.Render);
    ...
    public void onMultiinstance(MultiinstanceGraphElementPresentation element) {
        ...
        Map<String, String> params = new HashMap<String, String>();
        params.put(IdForm.ID_INPUT_NAME, String.valueOf(element.getIds().get(0)));
        String url = Commons.getActionUrl(Resources.ACTION_MAPPING_MANAGE_DEFINITION, params, pageContext, PortletUrl.Render);
        Area area = new Area("RECT", element.getGraphConstraints());
        area.setHref(url);
        area.setAlt(element.getName());
