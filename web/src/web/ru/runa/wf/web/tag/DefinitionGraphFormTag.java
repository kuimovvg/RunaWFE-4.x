...
public class DefinitionGraphFormTag extends ProcessDefinitionBaseFormTag {
    ...
    protected void fillFormData(final TD tdFormElement) throws JspException {
        ...
        String href = Commons.getActionUrl(ProcessDefinitionGraphImageAction.ACTION_PATH, IdForm.ID_INPUT_NAME, String.valueOf(getIdentifiableId()),
                pageContext, PortletUrl.Resource);
        ...
        try {
            ...
            if (!operation.getResultMap().isEmpty()) {
                ...
                processGraphImage.setUseMap("#processInstanceMap");
            }
        } catch (Exception e) {
            handleException(e);
        }
