...
class ProcessStartState extends BaseState {
    ...
    static {
        ...
        stateTransitions.put(TaskEndLog.class, StartNodeTaskEndState.class);
    ...
    public ProcessStartState(BaseState parent) {
        super(parent);
    }
    ...
    protected List<Element> acceptLog(ProcessLog currentLog, LogIterator logs) {
        ...
        result.add(new TR(new StringElement(currentLog.getDate() + ": "
                + replacePlaceholders(Messages.HISTORY_PROCESS_START, null, currentLog.getActorId(), null, null, null))));
