...
public class PropertiesProcessTDBuilder extends BaseTDBuilder {
    public PropertiesProcessTDBuilder() {
        super(ProcessDefinitionPermission.READ);
    }
    ...
    public TD build(Object object, Env env) throws JspException {
        ...
        if (isEnabled(object, env)) {
            String url = Commons.getActionUrl(Resources.ACTION_MAPPING_MANAGE_DEFINITION, IdForm.ID_INPUT_NAME, String.valueOf(pd.getNativeId()), env
                    .getPageContext(), PortletUrl.Render);
