...
public class ProcessDefinitionGraphImageAction extends Action {
    ...
    public ActionForward execute(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) throws Exception {
        ...
        try {
            ...
            byte[] bytes = definitionService.getFile(subject, idForm.getId(), FileDataProvider.GRAPH_IMAGE_NEW_FILE_NAME);
            if (bytes == null) {
                bytes = definitionService.getFile(subject, idForm.getId(), FileDataProvider.GRAPH_IMAGE_OLD_FILE_NAME);
            }
            if (bytes == null) {
