 ...
 * @author urmancheev
 */
public class FilterRadioButtonGroup extends EditableFieldImpl implements ComponentWithSingleField {
  private static final long serialVersionUID = 239649692668206993L;
