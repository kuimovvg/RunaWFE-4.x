 ...
 * @author urmancheev
 */
public class LinkFlexiGrid extends Component implements GridComponent {
  private static final long serialVersionUID = -8421954969113733566L;

  private static final int TABLE = 0;
  private static final int MAIN_TABLE_REFERENCE = 1;
  private static final int SECONDARY_TABLE_REFERENCE = 2;
  ...
  private TableReference secondaryTableReference;
  ...
  protected void initLazyFields() {
    ...
    secondaryTableReference = parseTableReference(getSecondaryTableReferenceStr());
  ...
  public String getSecondaryTableReferenceStr() {
    return getParameter(SECONDARY_TABLE_REFERENCE);
  }
  ...
  @Valid
  @NotNull
  public TableReference getSecondaryTableReference() {
    ensureFullyInitialized();
