...
var EndYear = 35; // The offset last year of pickable date. If current year is 2011, the last year that still picker will be 2016 (2011+5)
...
var imageFilesPath = "images/datetime"; //Path of date time picker image files relative to HTML page.
...
//                    "&#1057;&#1091;&#1073;&#1073;&#1086;&#1090;&#1072;",
//                    "&#1042;&#1086;&#1089;&#1082;&#1088;&#1077;&#1089;&#1077;&#1085;&#1100;&#1077;"];
WeekDayName2 = ["&#1055;&#1085;", "&#1042;&#1090;", "&#1057;&#1088;", "&#1063;&#1090;", "&#1055;&#1090;", "&#1057;&#1073;", "&#1042;&#1089;"];
...
function RenderCssCal(bNewCal) {
    ...
    //SphinxViewTables for Month & Year Selector

    vCalHeader += "<tr><td colspan='7'><table border='0' width='200px' cellpadding='0' cellspacing='0'><tr>";
    //******************Month and Year selector in dropdown list************************

    if (Cal.Scroller === "DROPDOWN") {
        vCalHeader += "<td align='center'><select class='MonthSelector' name='MonthSelector' onChange='javascript:Cal.SwitchMth(this.selectedIndex);RenderCssCal();'>";
        for (i = 0; i < 12; i += 1) {
            if (i === Cal.Month) {
                SelectStr = "Selected";
            }
        ...
        vCalHeader += "<td align='center'><select class='YearSelector' name='YearSelector' size='1' onChange='javascript:Cal.SwitchYear(this.value);RenderCssCal();'>";
    ...
    for (i = 0; i < 7; i += 1) {
        var weekDayName = "";
        if(WeekChar <= 0)
          weekDayName = WeekDayName[i];
        else
          weekDayName = WeekDayName[i].substr(0, WeekChar);
        vCalHeader += "<td style='background-color:" + WeekHeadColor + ";width:" + CellWidth + "px;color:#FFFFFF' class='calTD'>" + weekDayName + "</td>";
    }
    ...
    if (Cal.ShowTime === true) {
        ...
        vCalTime += "<tr><td colspan='7' style=\"text-align:center;\"><input style='width:60px;font-size:11px;margin-right:3px;' class='btn btn-primary btn-small' onClick='javascript:removeDate(\"" + Cal.Ctrl + "\");'  type=\"button\" value=\"Очистить\"><input style='width:60px;font-size:11px;' class='btn btn-primary btn-small' onClick='javascript:closewin(\"" + Cal.Ctrl + "\");'  type=\"button\" value=\"Выбрать\">&nbsp;<input style='width:60px;font-size:11px;' class='btn btn-primary btn-small' onClick='javascript: winCal.style.visibility = \"hidden\"' type=\"button\" value=\"Отмена\"></td></tr>";
    }
    ...
    vCalTime += "</tbody></table></td></tr>";
    calHeight += 31;
    vCalTime += "</tbody></table>\n</span>";

    //end time picker
    funcCalback = "function callback(id, datum) {\n";
    funcCalback += " var CalId = document.getElementById(id); if (datum=== 'undefined') { var d = new Date(); datum = d.getDate() + '/' +(d.getMonth()+1) + '/' + d.getFullYear(); } window.calDatum=datum;\n $(CalId).val(datum);\n $(CalId).change();\n";
...
function NewCssCal(imgFilesPath, pCtrl, pFormat, pScroller, pShowTime, pTimeMode, pShowSeconds) {
    // get current date and time
    imageFilesPath = imgFilesPath;
