...
public class ExecutionServiceDelegateAssignTaskTest extends ServletTestCase {
    ...
    private void moveAssignAssigned() throws Exception {
        ...
        testHelper.getExecutionService().assignTask(actor1User, tasks1[0].getId(), tasks1[0].getOwner(), actor);
        {
            tasks1 = checkTaskList(actor1User, 1);
            checkTaskList(actor2User, 0);
        }
        ...
        testHelper.getExecutionService().completeTask(actor1User, tasks1[0].getId(), new HashMap<String, Object>(), null);
    }
