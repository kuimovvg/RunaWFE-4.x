 ...
 * 
 */
@WebServiceClient(name = "ProfileWebService", targetNamespace = "http://impl.service.wfe.runa.ru/", wsdlLocation = "http://localhost:8888/runawfe-wfe-service-4.0.0/ProfileServiceBean?wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("http://localhost:8888/runawfe-wfe-service-4.0.0/ProfileServiceBean?wsdl");
