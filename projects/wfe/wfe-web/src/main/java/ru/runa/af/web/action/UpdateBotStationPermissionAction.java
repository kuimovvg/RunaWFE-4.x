 ...
 * 
 * @struts:action path="/updateBotStationPermission" name="updatePermissionsOnIdentifiableForm" validate="false"
 * @struts.action-forward name="success" path="/bot_station_permission.do" redirect = "true"
 * @struts.action-forward name="failure" path="/bot_station_permission.do" redirect = "true"
 */
public class UpdateBotStationPermissionAction extends UpdatePermissionOnIdentifiableAction {
