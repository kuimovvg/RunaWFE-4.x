...
/**
 * @jsp.tag name = "managePermissionOnGroupsOfRelationsLink" body-content = "empty"
 */
public class ManagePermissionOnGroupsOfRelationsLinkTag extends LinkTag {

    private static final long serialVersionUID = 1L;

    private static final String HREF = "/group_of_relations_permission.do";
