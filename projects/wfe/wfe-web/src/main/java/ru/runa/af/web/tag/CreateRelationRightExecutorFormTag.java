...
/**
 * @jsp.tag name = "createRelationRightExecutorForm" body-content = "empty"
 */
public class CreateRelationRightExecutorFormTag extends FormTag {
    ...
    protected void fillFormElement(TD tdFormElement) throws JspException {
        ...
        tdFormElement.addElement(new Input(Input.HIDDEN, "failure", "/create_relation_right_executor.do"));
    }
