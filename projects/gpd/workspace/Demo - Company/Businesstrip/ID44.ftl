...
<P class="legend"><STRONG>Take a business trip financial report from the employee</STRONG></P>
...
<DIV><LABEL>Official order number </LABEL>${DisplayVariable("official_order_number", "false")}</DIV>
<DIV><LABEL>Official order date </LABEL>${DisplayVariable("official_order_date", "false")}</DIV>
</FIELDSET></DIV>