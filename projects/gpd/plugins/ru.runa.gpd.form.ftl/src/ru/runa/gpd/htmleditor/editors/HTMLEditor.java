 ...
 * 
 * @see ru.runa.gpd.htmleditor.editors.MultiPageHTMLEditor
 * @see ru.runa.gpd.htmleditor.editors.SplitPageHTMLEditor
 */
public class HTMLEditor extends EditorPart {
	...
	protected HTMLConfiguration getSourceViewerConfiguration(){
	    return new HTMLConfiguration(EditorsPlugin.getDefault().getColorProvider());
	}
