 ...
 * complete. All methods from interface is called under {@link CachingLogic}
 * class synchronization. Components, receiving events must implement one or
 * more sub interface of {@link ChangeListener} and register self in
 * {@link CachingLogic}.
 */
