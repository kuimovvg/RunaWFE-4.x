...
import ru.runa.wfe.commons.cache.VersionedCache;
...
public interface ExecutorCache extends VersionedCache {
     ...
     * 
     * @param cacheVersion Version of cache, which must accept executors list. If cache version is differs, then executors list will not be saved. 
     * @param clazz Type of executors. Must be {@link Executor} or it subclass.
     * @param batch Presentation for executors.
     * @param executors Executor list for specified class and presentation. Will be returned on next {@link #getAllExecutor(Class, BatchPresentation)} 
     *              call with specified class and presentation.
     */
